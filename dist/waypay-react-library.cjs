"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const m=require("react"),n=require("styled-components"),q=require("framer-motion");var te={exports:{}},K={};var ue;function Ye(){if(ue)return K;ue=1;var e=Symbol.for("react.transitional.element"),o=Symbol.for("react.fragment");function i(r,s,c){var u=null;if(c!==void 0&&(u=""+c),s.key!==void 0&&(u=""+s.key),"key"in s){c={};for(var g in s)g!=="key"&&(c[g]=s[g])}else c=s;return s=c.ref,{$$typeof:e,type:r,key:u,ref:s!==void 0?s:null,props:c}}return K.Fragment=o,K.jsx=i,K.jsxs=i,K}var Q={};var he;function He(){return he||(he=1,process.env.NODE_ENV!=="production"&&(function(){function e(a){if(a==null)return null;if(typeof a=="function")return a.$$typeof===F?null:a.displayName||a.name||null;if(typeof a=="string")return a;switch(a){case I:return"Fragment";case P:return"Profiler";case k:return"StrictMode";case R:return"Suspense";case H:return"SuspenseList";case W:return"Activity"}if(typeof a=="object")switch(typeof a.tag=="number"&&console.error("Received an unexpected object in getComponentNameFromType(). This is likely a bug in React. Please file an issue."),a.$$typeof){case l:return"Portal";case O:return a.displayName||"Context";case E:return(a._context.displayName||"Context")+".Consumer";case A:var $=a.render;return a=a.displayName,a||(a=$.displayName||$.name||"",a=a!==""?"ForwardRef("+a+")":"ForwardRef"),a;case z:return $=a.displayName||null,$!==null?$:e(a.type)||"Memo";case _:$=a._payload,a=a._init;try{return e(a($))}catch{}}return null}function o(a){return""+a}function i(a){try{o(a);var $=!1}catch{$=!0}if($){$=console;var S=$.error,f=typeof Symbol=="function"&&Symbol.toStringTag&&a[Symbol.toStringTag]||a.constructor.name||"Object";return S.call($,"The provided key is an unsupported type %s. This value must be coerced to a string before using it here.",f),o(a)}}function r(a){if(a===I)return"<>";if(typeof a=="object"&&a!==null&&a.$$typeof===_)return"<...>";try{var $=e(a);return $?"<"+$+">":"<...>"}catch{return"<...>"}}function s(){var a=v.A;return a===null?null:a.getOwner()}function c(){return Error("react-stack-top-frame")}function u(a){if(d.call(a,"key")){var $=Object.getOwnPropertyDescriptor(a,"key").get;if($&&$.isReactWarning)return!1}return a.key!==void 0}function g(a,$){function S(){N||(N=!0,console.error("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://react.dev/link/special-props)",$))}S.isReactWarning=!0,Object.defineProperty(a,"key",{get:S,configurable:!0})}function j(){var a=e(this.type);return V[a]||(V[a]=!0,console.error("Accessing element.ref was removed in React 19. ref is now a regular prop. It will be removed from the JSX Element type in a future release.")),a=this.props.ref,a!==void 0?a:null}function b(a,$,S,f,D,B){var Y=S.ref;return a={$$typeof:p,type:a,key:$,props:S,_owner:f},(Y!==void 0?Y:null)!==null?Object.defineProperty(a,"ref",{enumerable:!1,get:j}):Object.defineProperty(a,"ref",{enumerable:!1,value:null}),a._store={},Object.defineProperty(a._store,"validated",{configurable:!1,enumerable:!1,writable:!0,value:0}),Object.defineProperty(a,"_debugInfo",{configurable:!1,enumerable:!1,writable:!0,value:null}),Object.defineProperty(a,"_debugStack",{configurable:!1,enumerable:!1,writable:!0,value:D}),Object.defineProperty(a,"_debugTask",{configurable:!1,enumerable:!1,writable:!0,value:B}),Object.freeze&&(Object.freeze(a.props),Object.freeze(a)),a}function w(a,$,S,f,D,B){var Y=$.children;if(Y!==void 0)if(f)if(M(Y)){for(f=0;f<Y.length;f++)x(Y[f]);Object.freeze&&Object.freeze(Y)}else console.error("React.jsx: Static children should always be an array. You are likely explicitly calling React.jsxs or React.jsxDEV. Use the Babel transform instead.");else x(Y);if(d.call($,"key")){Y=e(a);var U=Object.keys($).filter(function(J){return J!=="key"});f=0<U.length?"{key: someKey, "+U.join(": ..., ")+": ...}":"{key: someKey}",L[Y+f]||(U=0<U.length?"{"+U.join(": ..., ")+": ...}":"{}",console.error(`A props object containing a "key" prop is being spread into JSX:
  let props = %s;
  <%s {...props} />
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`,f,Y,U,Y),L[Y+f]=!0)}if(Y=null,S!==void 0&&(i(S),Y=""+S),u($)&&(i($.key),Y=""+$.key),"key"in $){S={};for(var G in $)G!=="key"&&(S[G]=$[G])}else S=$;return Y&&g(S,typeof a=="function"?a.displayName||a.name||"Unknown":a),b(a,Y,S,s(),D,B)}function x(a){y(a)?a._store&&(a._store.validated=1):typeof a=="object"&&a!==null&&a.$$typeof===_&&(a._payload.status==="fulfilled"?y(a._payload.value)&&a._payload.value._store&&(a._payload.value._store.validated=1):a._store&&(a._store.validated=1))}function y(a){return typeof a=="object"&&a!==null&&a.$$typeof===p}var h=m,p=Symbol.for("react.transitional.element"),l=Symbol.for("react.portal"),I=Symbol.for("react.fragment"),k=Symbol.for("react.strict_mode"),P=Symbol.for("react.profiler"),E=Symbol.for("react.consumer"),O=Symbol.for("react.context"),A=Symbol.for("react.forward_ref"),R=Symbol.for("react.suspense"),H=Symbol.for("react.suspense_list"),z=Symbol.for("react.memo"),_=Symbol.for("react.lazy"),W=Symbol.for("react.activity"),F=Symbol.for("react.client.reference"),v=h.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,d=Object.prototype.hasOwnProperty,M=Array.isArray,T=console.createTask?console.createTask:function(){return null};h={react_stack_bottom_frame:function(a){return a()}};var N,V={},Z=h.react_stack_bottom_frame.bind(h,c)(),C=T(r(c)),L={};Q.Fragment=I,Q.jsx=function(a,$,S){var f=1e4>v.recentlyCreatedOwnerStacks++;return w(a,$,S,!1,f?Error("react-stack-top-frame"):Z,f?T(r(a)):C)},Q.jsxs=function(a,$,S){var f=1e4>v.recentlyCreatedOwnerStacks++;return w(a,$,S,!0,f?Error("react-stack-top-frame"):Z,f?T(r(a)):C)}})()),Q}var xe;function Ve(){return xe||(xe=1,process.env.NODE_ENV==="production"?te.exports=Ye():te.exports=He()),te.exports}var t=Ve();const ae=({x:e,y:o,items:i,onClose:r,...s})=>{const c=m.useRef(null),[u,g]=m.useState(null);m.useEffect(()=>{const h=p=>{c.current&&!c.current.contains(p.target)&&r()};return document.addEventListener("mousedown",h),()=>{document.removeEventListener("mousedown",h)}},[r]);const b=(()=>{if(!c.current)return{x:e,y:o};const h=c.current.offsetWidth,p=c.current.offsetHeight,l=window.innerWidth,I=window.innerHeight;let k=e,P=o;return k+h>l&&(k=e-h),P+p>I&&(P=o-p),{x:k,y:P}})(),w=(h,p)=>{h.submenu?g(u===p?null:p):h.action&&(h.action(),r())},x=h=>{i[h].submenu&&g(h)},y=h=>{const p=h.relatedTarget;c.current?.contains(p)||g(null)};return t.jsx(Ze,{ref:c,initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.8},transition:{duration:.15},style:{position:"absolute",top:b.y,left:b.x},onClick:h=>h.stopPropagation(),onMouseLeave:y,...s,children:i.map((h,p)=>t.jsxs(Ue,{$hasSubmenu:!!h.submenu,$disabled:h.disabled,children:[t.jsx(qe,{onClick:l=>{l.stopPropagation(),h.disabled||w(h,p)},onMouseEnter:()=>!h.disabled&&x(p),whileHover:h.disabled?{}:{backgroundColor:"#f3f4f6"},initial:{backgroundColor:"#ffffff"},$color:h.color,$disabled:h.disabled,children:t.jsxs(Xe,{children:[h.label,h.submenu&&t.jsx(Ge,{children:t.jsx("svg",{width:"8",height:"12",viewBox:"0 0 8 12",fill:"none",children:t.jsx("path",{d:"M1.5 1.5L6 6L1.5 10.5",stroke:"currentColor",strokeWidth:"2"})})})]})}),h.submenu&&u===p&&t.jsx(Je,{initial:{opacity:0,x:10},animate:{opacity:1,x:0},exit:{opacity:0,x:10},transition:{duration:.15},children:t.jsx(ae,{x:0,y:-p*40,items:h.submenu,onClose:()=>g(null)})})]},p))})},Ze=n(q.motion.div)`
  position: absolute;
  background: white;
  border-radius: 8px;
...
`,Je=n(q.motion.div)`
  ...
  z-index: 1001;
  margin-left: 2px;
`,Ke=({columns:e,data:o,onRowDoubleClick:i,contextMenuActions:r=[],onSort:s,sortConfig:c,onRowClick:u,selectedRow:g,fixedHeight:j,hasTotalsRow:b,debtChecker:w,rowStyles:x={},isLoading:y})=>{const[h,p]=m.useState(null),[l,I]=m.useState(null),k=m.useRef(null),P=m.useRef(null),E=500,O=g!==void 0?g:h,A=C=>{!e[C].isSortable||!s||s(C)},H=w||(C=>{const L=C[8];return typeof L=="string"?parseFloat(L.replace(/[^\d.]/g,""))>0:!1}),z=C=>{g===void 0&&p(C===O?null:C),u&&u(o[C],C)},_=(C,L)=>{i&&i(C,L)},W=(C,L)=>{if(r.length===0)return;C.preventDefault();const a="touches"in C?C.touches[0].clientX:C.clientX,$="touches"in C?C.touches[0].clientY:C.clientY;I({x:a,y:$,rowIndex:L})},F=(C,L)=>{C.preventDefault(),W(C,L)},v=(C,L)=>{r.length!==0&&(P.current&&clearTimeout(P.current),P.current=window.setTimeout(()=>{W(C,L)},E))},d=()=>{P.current&&(clearTimeout(P.current),P.current=null)},M=()=>{P.current&&window.clearTimeout(P.current)},T=()=>{I(null)};m.useEffect(()=>{const C=()=>{l&&T()};return document.addEventListener("click",C),()=>{document.removeEventListener("click",C),P.current&&clearTimeout(P.current)}},[l]);const N=(C,L,a)=>{if(L)return{backgroundColor:"#FFFFFF",color:"#000000",fontWeight:"bold"};const $=x[C]||{};return C===O?{backgroundColor:$.backgroundColor||"#007D88",color:$.color||"#FFFFFF",fontWeight:$.fontWeight||"normal"}:a?{backgroundColor:$.backgroundColor||"#E8D8D8",color:$.color||"inherit",fontWeight:$.fontWeight||"normal"}:o[C][o[C].length-1]===!1?{backgroundColor:$.backgroundColor||"#E8F5E8",color:"#1B5E20",fontWeight:$.fontWeight||"normal"}:{backgroundColor:$.backgroundColor||"#FFFFFF",color:$.color||"inherit",fontWeight:$.fontWeight||"normal"}},V=(C,L,a)=>{if(L)return"#FFFFFF";const $=N(C,L,a);return $.hoverBackgroundColor?$.hoverBackgroundColor:C===O?"#007D88":a?"#E8D8D8CC":o[C][o[C].length-1]===!1?"#51D5B4CC":"#F3F4F6"},Z=()=>{if(!l||r.length===0)return null;const C=(typeof r=="function"?r(o[l.rowIndex]):r).filter(L=>typeof L=="object"&&(typeof L.shouldShow!="function"||L.shouldShow(o[l.rowIndex])));return C.length===0?null:t.jsx(ot,{initial:{opacity:0,scale:.95},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.95},transition:{duration:.15},style:{position:"fixed",left:l.x,top:l.y,zIndex:1e3},onClick:L=>L.stopPropagation(),children:t.jsx(ae,{items:C.map(L=>{const a={label:L.label,color:L.color,disabled:L.disabled};return L.getSubmenu?a.submenu=L.getSubmenu(o[l.rowIndex]):L.action&&(a.action=()=>{L.action(o[l.rowIndex],l.rowIndex),T()}),a}),onClose:T,x:0,y:0})})};return t.jsx(tt,{ref:k,children:y?t.jsx(Qe,{children:t.jsx(et,{})}):t.jsxs(t.Fragment,{children:[t.jsxs(nt,{children:[t.jsx(rt,{children:t.jsx(fe,{children:e.map((C,L)=>!C.isHidden&&t.jsx(st,{$isSortable:C.isSortable,$isActive:c?.key===L,onClick:()=>A(L),$align:C.align||"center",$isFirst:L===0,$isLast:L===e.length-1,children:t.jsxs(at,{$align:C.align||"center",children:[C.name,C.isSortable&&t.jsx(lt,{$direction:c?.key===L?c.direction:"asc",animate:{rotate:c?.key===L&&c.direction==="desc"?180:0,color:c?.key===L?"#007D88":"#6B7280"},transition:{duration:.2},children:t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:t.jsx("path",{d:"M5.77734 2.92383L5.25 3.45117L3.26953 1.47656L3.26367 12H2.51367L2.51953 1.45898L0.527344 3.45117L0 2.92383L2.88867 0.0351562L5.77734 2.92383ZM10.5059 8.54883L11.0391 9.07617L8.15039 11.9648L5.25586 9.07617L5.78906 8.54883L7.76953 10.5293L7.76367 0H8.51367L8.51953 10.5352L10.5059 8.54883Z",fill:"currentColor"})})})]})},L))})}),t.jsx(it,{$fixedHeight:j,children:t.jsx(q.AnimatePresence,{children:o.map((C,L)=>{const a=!!(b&&L===o.length-1),$=!!(!a&&H(C)),S=N(L,a,$),f=V(L,a,$);return t.jsx(fe,{initial:{opacity:0,y:-10},animate:{opacity:1,y:0,backgroundColor:S.backgroundColor||"#FFFFFF",color:S.color||"inherit",fontWeight:S.fontWeight||"normal"},exit:{opacity:0,y:10},transition:{duration:.2,ease:"easeOut"},$isLast:L===o.length-1,$isSelected:L===O,$isTotalsRow:a,onClick:()=>!a&&z(L),onDoubleClick:()=>!a&&_(C,L),onContextMenu:D=>!a&&F(D,L),onTouchStart:D=>!a&&v(D,L),onTouchEnd:d,onTouchMove:M,whileHover:a?{}:{backgroundColor:f,transition:{duration:.15}},style:{backgroundColor:S.backgroundColor||"#FFFFFF",color:S.color||"inherit",fontWeight:S.fontWeight||"normal"},children:C.map((D,B)=>!e[B]?.isHidden&&t.jsx(ct,{$align:e[B]?.align||"center",$isFirst:B===0,$isLast:B===C.length-1,$isTotalsCell:a,$isBeforeTotals:a&&B<C.findIndex(Y=>Y==="Итого:"),children:D},B))},`row-${L}`)})})})]}),t.jsx(q.AnimatePresence,{children:Z()})]})})},Qe=n.div`
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
...
`,$n=n.span`
  ...
  margin-top: 4px;
  display: block;
`,Ie=({title:e,onClose:o,onCancel:i,onSave:r,children:s,isSaveDisabled:c=!1,isSubmitting:u=!1,mode:g="create",hideSaveButton:j=!1,hideCanselButton:b=!1,width:w="560px",saveButtonText:x="Сохранить",customLayout:y})=>{const h=g==="view",p=m.useRef(null);m.useEffect(()=>{const k=E=>{E.key==="Escape"&&o()};document.addEventListener("keydown",k);const P=document.body.style.overflow;return document.body.style.overflow="hidden",setTimeout(()=>p.current?.focus(),0),()=>{document.removeEventListener("keydown",k),document.body.style.overflow=P}},[o]);const l=k=>{k.target===k.currentTarget&&o()},I=k=>{k.preventDefault(),i()};return t.jsx(Sn,{onMouseDown:l,role:"presentation",children:t.jsxs(Mn,{ref:p,$width:w,role:"dialog","aria-modal":"true","aria-label":e||"Диалог",tabIndex:-1,children:[t.jsxs(Pe,{children:[t.jsx(Re,{children:e}),t.jsx(Ln,{type:"button",onClick:o,"aria-label":"Закрыть",children:t.jsx("span",{"aria-hidden":!0,children:"×"})})]}),y?t.jsx(Tn,{children:y}):null,t.jsxs(Dn,{onSubmit:r,children:[t.jsx(En,{children:s}),t.jsxs(In,{children:[t.jsx(Pn,{children:b?null:t.jsx(Bn,{isPrimary:!1,onClick:I,children:"Отменить"})}),t.jsx(Rn,{children:!h&&!j?t.jsx(zn,{type:"submit",disabled:c||u,children:u?"Сохранение...":x}):null})]})]})]})})},Sn=n.div`
  position: fixed;
  inset: 0;
...
`,zn=n(ne)`
  ...
  border-radius: 10px;
  font-size: 16px;
`,An=[{id:"Last7Days",label:"За последние 7 дней",value:"Last7Days"},{id:"ThisMonth",label:"За этот месяц",value:"ThisMonth"},{id:"Last31Days",label:"За последние 31 день",value:"Last31Days"},{id:"PreviousMonth",label:"За прошлый месяц",value:"PreviousMonth"},{id:"ThisYear",label:"За этот год",value:"ThisYear"},{id:"PreviousYear",label:"За прошлый год",value:"PreviousYear"}],Fn=({value:e="",placeholder:o="Выберите период",options:i=An,showCustomPeriodButton:r=!0,onChange:s,onCustomPeriodClick:c})=>{const[u,g]=m.useState(!1),[j,b]=m.useState(!1),[w,x]=m.useState(""),[y,h]=m.useState(""),[p,l]=m.useState(""),I=m.useRef(null),k=m.useRef(null);m.useEffect(()=>{if(e==="Custom"&&y&&p){const z=R(y),_=R(p);x(`С ${z} по ${_}`)}else{const z=i.find(_=>_.value===e);x(z?z.label:"")}},[e,i,y,p]),m.useEffect(()=>{const z=_=>{I.current&&!I.current.contains(_.target)&&g(!1),j&&k.current&&!k.current.contains(_.target)&&([...document.querySelectorAll(".calendar-container, .arrow-button")].some(v=>v.contains(_.target))||b(!1))};return document.addEventListener("mousedown",z),()=>{document.removeEventListener("mousedown",z)}},[j]);const P=z=>{s?.(z.value),g(!1)},E=()=>{g(!1),c?c():b(!0)},O=()=>{s?.(""),x(""),h(""),l("")},A=()=>{if(y&&p){const z=R(y),_=R(p),W=`С ${z} по ${_}`;s?.("Custom",y,p),x(W),b(!1)}},R=z=>{const _=new Date(z),W=String(_.getDate()).padStart(2,"0"),F=String(_.getMonth()+1).padStart(2,"0"),v=_.getFullYear();return`${W}.${F}.${v}`},H=()=>t.jsxs(Gn,{children:[t.jsx(Pe,{style:{margin:0},children:t.jsx(Re,{style:{margin:0},children:"Выбор периода"})}),t.jsx(Jn,{onClick:O,children:"Очистить период"})]});return t.jsxs(t.Fragment,{children:[t.jsxs(_n,{ref:I,children:[t.jsxs(On,{onClick:()=>g(!u),children:[t.jsx(Nn,{children:w||o}),t.jsx(Wn,{$isOpen:u,children:"▼"})]}),u&&t.jsxs(Yn,{children:[i.map(z=>t.jsxs(Hn,{onClick:()=>P(z),$isSelected:e===z.value,children:[t.jsx(Vn,{$isSelected:e===z.value,children:e===z.value&&t.jsx(Zn,{})}),t.jsx(Un,{children:z.label})]},z.id)),r&&t.jsx(qn,{onClick:E,children:"Другой период"})]})]}),j&&t.jsx("div",{ref:k,children:t.jsx(Ie,{title:"",onClose:()=>b(!1),onCancel:()=>b(!1),onSave:z=>{z.preventDefault(),A()},saveButtonText:"Выбрать",customLayout:t.jsx(H,{}),children:t.jsxs(Xn,{children:[t.jsx(Ce,{children:t.jsx(ie,{value:y,onChange:z=>h(z)})}),t.jsx(Ce,{children:t.jsx(ie,{value:p,onChange:z=>l(z)})})]})})})]})},_n=n.div`
  position: relative;
  width: 245px;
`,On=n.div`
  display: flex;
...
`,Ao=["zoomControl","fullscreenControl"];let re=null;const Fo=e=>typeof window>"u"?Promise.reject(new Error("Window is not available")):window.ymaps?Promise.resolve(window.ymaps):(re||(re=new Promise((o,i)=>{const r=document.createElement("script"),s=e?`&apikey=${e}`:"";r.src=`https://api-maps.yandex.ru/2.1/?lang=ru_RU${s}`,r.async=!0,r.onload=()=>{window.ymaps?window.ymaps.ready(()=>o(window.ymaps)):i(new Error("Yandex Maps failed to load"))},r.onerror=()=>i(new Error("Failed to load Yandex Maps script")),document.head.appendChild(r)})),re),_o=({onLocationSelect:e,initialAddress:o="",initialLat:i=55.751244,initialLon:r=37.618423,apiKey:s,zoom:c=12,height:u=400,width:g="100%",inputPlaceholder:j="Введите адрес или название места",searchButtonLabel:b="Найти",draggablePlacemark:w=!0,controls:x=Ao,showSearch:y=!0,className:h,style:p,onError:l})=>{const[I,k]=m.useState(null),[P,E]=m.useState(o),[O,A]=m.useState(o),[R,H]=m.useState(!1),z=m.useRef(null);m.useEffect(()=>{let F=!1,v;return(async()=>{try{const M=await Fo(s);if(F||!z.current)return;v=new M.Map(z.current,{center:[i,r],zoom:c,controls:x});const T=new M.Placemark([i,r],{},{draggable:w});v.geoObjects.add(T),v.events.add("click",N=>{const V=N.get("coords");_(V,T,v)}),T.events.add("dragend",()=>{const N=T.geometry.getCoordinates();_(N,T,v)}),k(v),H(!0)}catch(M){l&&M instanceof Error&&l(M)}})(),()=>{F=!0,v&&v.destroy()}},[s,i,r,c,x,w,l]);const _=async(F,v,d)=>{if(window.ymaps)try{const N=(await window.ymaps.geocode(F)).geoObjects.get(0).getAddressLine();v.geometry.setCoordinates(F),d.panTo(F,{flying:!0}),A(N),E(N),e(N,F[0],F[1])}catch(M){l&&M instanceof Error&&l(M)}},W=async()=>{if(!(!P.trim()||!window.ymaps||!I))try{const v=(await window.ymaps.geocode(P)).geoObjects.get(0);if(v){const d=v.geometry.getCoordinates(),M=v.properties.get("boundedBy");I.setBounds(M,{checkZoomRange:!0});const T=new window.ymaps.Placemark(d,{},{draggable:w});I.geoObjects.removeAll(),I.geoObjects.add(T);const N=v.getAddressLine();A(N),e(N,d[0],d[1]),T.events.add("dragend",()=>{const V=T.geometry.getCoordinates();_(V,T,I)})}}catch(F){l&&F instanceof Error&&l(F)}};return t.jsxs(Oo,{className:h,style:p,children:[y&&t.jsxs(No,{children:[t.jsx(ce,{type:"text",value:P,onChange:F=>E(F.target.value),placeholder:j,onKeyPress:F=>F.key==="Enter"&&W(),disabled:!R}),t.jsx(Wo,{onClick:W,disabled:!R,children:b})]}),t.jsxs(Ho,{children:["Выбранный адрес: ",t.jsx("strong",{children:O||"Не выбран"})]}),t.jsx(Yo,{ref:z,$height:u,$width:g}),t.jsx(Vo,{children:"📍 Кликните на карте или найдите адрес через поиск"})]})},Oo=n.div`
  display: flex;
  flex-direction: column;
  gap: 12px;
`,No=n.div`
...
`,fr=({title:e,data:o,xAxisLabel:i,yAxisLabel:r,maxX:s,maxY:c,minY:u,xStep:g,yStep:j,height:b=300,showLegend:w=!0,xAxisCustomLabels:x,showTooltip:y=!0,titleFontSize:h="30px"})=>{const[p,l]=m.useState(null),[I,k]=m.useState({x:0,y:0}),P=m.useRef(null),E=m.useRef(null),O=Math.max(...o.map(v=>v.x),s),A=[];for(let v=0;v<=O;v+=g)A.push(v);const R=[];for(let v=u;v<=c;v+=j)R.push(v);const H=x||A.map(v=>v.toString()),z=w?Array.from(new Set(o.filter(v=>v.label).map(v=>v.label))).map(v=>{const d=o.find(M=>M.label===v);return{name:v,color:d.color}}):[],_={};o.forEach(v=>{const d=v.label||"default";_[d]||(_[d]=[]),_[d].push(v)});const W=v=>v/O*100,F=v=>{const d=c-u;return 100-(v-u)/d*100};return m.useEffect(()=>{if(p&&E.current){const v=E.current.getBoundingClientRect(),d=W(p.x)/100*v.width,M=F(p.y)/100*v.height;k({x:d+v.left,y:M+v.top})}},[p,s,c,u]),t.jsxs(gr,{children:[t.jsxs(de,{style:{marginTop:"0"},children:[t.jsx(pe,{style:{fontSize:h},children:e}),w&&z.length>0&&t.jsx(br,{children:z.map((v,d)=>t.jsxs(mr,{children:[t.jsx(wr,{color:v.color}),t.jsx(vr,{children:v.name})]},d))})]}),t.jsxs(yr,{height:b,children:[t.jsxs(kr,{children:[R.map((v,d)=>t.jsx(jr,{children:v.toLocaleString()},d)),t.jsx($e,{children:r})]}),t.jsxs(Cr,{ref:E,children:[R.map((v,d)=>t.jsx($r,{position:F(v)},`hline-${d}`)),Object.values(_).map((v,d)=>v.map((M,T)=>{if(T===0)return null;const N=v[T-1],V=W(N.x),Z=F(N.y),C=W(M.x),L=F(M.y);return t.jsx("svg",{style:{position:"absolute",top:0,left:0,width:"100%",height:"100%",pointerEvents:"none",zIndex:1},children:t.jsx("line",{x1:`${V}%`,y1:`${Z}%`,x2:`${C}%`,y2:`${L}%`,stroke:M.color,strokeWidth:"1"})},`line-${d}-${T}`)})),o.map((v,d)=>t.jsx(Sr,{x:W(v.x),y:F(v.y),color:v.color,onMouseEnter:()=>l(v),onMouseLeave:()=>l(null),isHovered:p?.label===v.label},d))]})]}),y&&p&&t.jsxs(Tr,{ref:P,style:{left:I.x,top:I.y},children:[t.jsxs(Dr,{children:[p.name&&t.jsx(Er,{children:p.name}),t.jsx(Ir,{children:p.y.toLocaleString()})]}),t.jsx(Pr,{})]}),t.jsxs(Mr,{children:[H.map((v,d)=>{const T=A[d]/O*100;return t.jsx(Lr,{style:{left:`${T}%`,transform:"translateX(-50%)"},children:v},d)}),i&&t.jsx($e,{children:i})]})]})},gr=n.div`
  background-color: white;
  border-radius: 10px;
  border: 1px solid rgba(209, 213, 219, 1);
  padding: 20px;
...
`,Be=({isOpen:e,callPhone:o,error:i,onClose:r})=>{const[s,c]=m.useState(!1);if(!e)return null;const u=/iPhone|iPad|iPod|Android/i.test(navigator.userAgent),g=()=>{u?window.location.href=`tel:${o}`:(navigator.clipboard.writeText(o),c(!0),setTimeout(()=>c(!1),2e3))};return t.jsx(Hr,{onClick:r,children:t.jsxs(Vr,{onClick:j=>j.stopPropagation(),children:[t.jsx(Zr,{children:"Подтверждение авторизации"}),t.jsx(Me,{children:"Для завершения авторизации позвоните на номер:"}),t.jsxs(Ur,{onClick:g,title:u?"Позвонить":"Копировать номер",$clickable:!0,children:[o,!u&&s&&t.jsx(qr,{children:"Скопировано!"})]}),t.jsx(Me,{children:"После звонка система автоматически подтвердит вашу авторизацию."}),i&&t.jsx(Xr,{children:i})]})})},Hr=n.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,Ti=n.div`
  ...
  margin-top: 8px;
  text-align: left;
`,Di=({onLoginSuccess:e,userType:o="delivery_operator",title:i="Авторизация",submitLabel:r="Войти",placeholder:s="8 (xxx) xxx-xx-xx",supportPhone:c="8 989 924 24 24",supportLinkUrl:u="https://waypay.one",supportLinkText:g="waypay.one",className:j,style:b,pollingIntervalMs:w=3e3,enableRegistration:x=!1})=>{const[y,h]=m.useState(!1),[p,l]=m.useState(""),[I,k]=m.useState(!1),[P,E]=m.useState(""),[O,A]=m.useState(""),[R,H]=m.useState(!1),[z,_]=m.useState(!1),[W,F]=m.useState(""),[v,d]=m.useState(""),[M,T]=m.useState(null),N=m.useRef(void 0);m.useEffect(()=>()=>{N.current&&clearInterval(N.current)},[]);const V=S=>{const f=S.replace(/\D/g,"");return f?f.startsWith("8")?`+7${f.slice(1)}`:f.startsWith("7")?`+${f}`:`+${f}`:""},Z=()=>{k(!1),_(!1),F(""),d(""),T(null),N.current&&window.clearInterval(N.current)},C=async S=>{if(S.preventDefault(),!p){A("Введите номер телефона");return}h(!0),A("");const f=V(p);try{const D=await Fe(f,o);T({phone:f,checkId:D.check_id,callPhone:D.call_phone}),x&&"name_required"in D&&D.name_required?(_(!0),E(D.call_phone)):!x&&"name_required"in D&&D.name_required?(A("Этот номер не зарегистрирован в системе. Обратитесь в поддержку для регистрации."),T(null)):(E(D.call_phone),k(!0),a(f,D.check_id))}catch(D){console.error("Auth error:",D),A("Не удалось инициировать авторизацию. Проверьте номер.")}finally{h(!1)}},L=async S=>{if(!S.trim()){d("Введите ФИО");return}if(M){h(!0),d("");try{F(S),_(!1),k(!0),a(M.phone,M.checkId,S)}catch(f){console.error("Registration error:",f),d("Не удалось завершить регистрацию")}finally{h(!1)}}},a=(S,f,D)=>{N.current&&window.clearInterval(N.current),N.current=window.setInterval(()=>{$(S,f,D)},w)},$=async(S,f,D)=>{if(!R){H(!0);try{const B=await _e(S,f,o,D||W);(B.access_token&&B.refresh_token||B.accessToken&&B.refreshToken)&&(N.current&&window.clearInterval(N.current),k(!1),_(!1),F(""),T(null),e(B.access_token??B.accessToken))}catch(B){console.error("Verification error:",B)}finally{H(!1)}}};return t.jsxs(Ei,{className:j,style:b,children:[t.jsxs(Ii,{children:[t.jsxs(Pi,{onSubmit:C,children:[t.jsx(Ri,{children:i}),t.jsx(Bi,{children:t.jsx(zi,{children:t.jsx(Ae,{value:p,onChange:S=>l(S),placeholder:s})})}),O&&t.jsx(Ni,{children:t.jsx("span",{children:O})}),t.jsx(Ai,{type:"submit",disabled:y,children:y?"Загрузка...":r})]}),t.jsxs(Fi,{children:["Хотите получить доступ к нашим продуктам?",t.jsx("br",{}),"Обратитесь по номеру"," ",t.jsx(_i,{href:`tel:${c}`,children:c}),t.jsx("br",{}),"или оставьте заявку на"," ",t.jsx(Oi,{href:u,target:"_blank",rel:"noreferrer",children:g})]})]}),t.jsx(ki,{isOpen:z,onClose:Z,onSubmit:L,error:v,isLoading:y}),t.jsx(Be,{isOpen:I,onClose:Z,callPhone:P,error:O})]})},Ei=n.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
