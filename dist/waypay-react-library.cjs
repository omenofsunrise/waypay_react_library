...
`,St=({placeholder:e="",customPlaceholder:n,value:s,onChange:i,hasError:r=!1,errorMessage:d,options:p,name:m,disabled:j=!1,required:f=!1,...g})=>{const[x,b]=y.useState(!1),[h,u]=y.useState(!1),l=y.useRef(null),L=!!(n&&!s&&!x),k=P=>{i&&!j&&i({target:{value:P,name:m}}),u(!1),b(!1)},E=P=>{l.current&&!l.current.contains(P.target)&&(u(!1),b(!1))},T=()=>{j||(u(!h),b(!h))};y.useEffect(()=>(document.addEventListener("mousedown",E),()=>{document.removeEventListener("mousedown",E)}),[]);const B=p.find(P=>P.value===s),A=B?B.label:"";return t.jsxs(Mt,{ref:l,...g,children:[t.jsxs(Tt,{children:[t.jsxs(Dt,{hasError:r,isOpen:h,disabled:j,onClick:T,onFocus:()=>!j&&b(!0),onBlur:()=>b(!1),tabIndex:j?-1:0,children:[t.jsx(Lt,{children:A||e&&t.jsx(Et,{children:e})}),t.jsx(Pt,{isOpen:h,disabled:j,children:t.jsx("svg",{width:"17",height:"9",viewBox:"0 0 17 9",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:t.jsx("path",{d:"M1.5 1L8.5 8L15.5 1",stroke:j?"#CCCCCC":"#50555C",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})})})]}),h&&t.jsx(Rt,{children:p.map(P=>t.jsxs(It,{$isSelected:P.value===s,onClick:()=>k(P.value),children:[t.jsx(Bt,{$isSelected:P.value===s,children:P.value===s&&t.jsx(At,{})}),t.jsx(zt,{children:P.label})]},P.value))})]}),n&&t.jsx(Ft,{isVisible:L,children:n}),r&&d&&t.jsx(_t,{children:d}),t.jsx(Ot,{name:m,value:s||"",onChange:()=>{},tabIndex:-1,required:f,children:p.map(P=>t.jsx("option",{value:P.value,children:P.label},P.value))})]})},Mt=o.div`
  position: relative;
...
`,Ot=o.select`
  ...
  width: 0;
  pointer-events: none;
`,Yt=({checked:e=!1,onChange:n,className:s,label:i,disabled:r=!1})=>{const[d,p]=y.useState(!1),m=()=>{r||!n||n(!e)},j=f=>{r||(f.key==="Enter"||f.key===" ")&&(f.preventDefault(),m())};return t.jsxs(Wt,{className:s,onClick:m,onKeyPress:j,tabIndex:r?-1:0,disabled:r,children:[t.jsx(Nt,{checked:e,isFocused:d,disabled:r,onMouseEnter:()=>!r&&p(!0),onMouseLeave:()=>!r&&p(!1),onFocus:()=>!r&&p(!0),onBlur:()=>!r&&p(!1),children:e&&t.jsx(Vt,{viewBox:"0 0 8 8",fill:"none",xmlns:"http://www.w3.org/2000/svg",disabled:r,children:t.jsx("path",{d:"M7.375 1.1875L2.65 6.8125L0.625 4.5625",stroke:r?"rgba(173, 179, 188, 1)":"white",strokeLinecap:"round",strokeLinejoin:"round"})})}),i&&t.jsx(Ht,{disabled:r,children:i})]})},Wt=o.div`
  display: flex;
  align-items: center;
...
`,Le=({placeholder:e="",customPlaceholder:n,value:s,inputType:i="text",onChange:r,hasError:d=!1,errorMessage:p,...m})=>{const[j,f]=y.useState(!1),g=!!(n&&!s&&!j),x=u=>{if(!r)return;let l=u.target.value;switch(i){case"number":/^\d*$/.test(l)&&r?.(u);break;case"rubles":{const k=u.target.selectionStart,E=u.target.value;let T=E.replace(/[^\d]/g,"");if(T===""){u.target.value="",r(u);break}const B=parseInt(T,10);if(!isNaN(B)){let A=B.toLocaleString("ru-RU");A+=" ₽";const P=b(E,k||0),z=h(A,P);u.target.value=A,r(u),setTimeout(()=>{u.target.setSelectionRange(z,z)},0)}break}case"percents":{l=l.replace(/[^\d.]/g,"");const k=l.split(".");k.length>2&&(l=k[0]+"."+k.slice(1).join("")),k.length===2&&k[1].length>2&&(l=k[0]+"."+k[1].slice(0,2));const E=parseFloat(l);if(isNaN(E)||(E>100?l="100":E<0&&(l="0")),l&&l!==""){l+=" %";const T=u.target.selectionStart||0,B=l.replace(" %","");u.target.value=l,r(u),setTimeout(()=>{T<B.length&&u.target.setSelectionRange(T,T)},0)}else u.target.value=l,r(u);break}case"fullname":l=l.replace(/[^a-zA-Zа-яА-ЯёЁ'\-\s]/g,""),l=l.replace(/\s{2,}/g," "),l=l.replace(/- /g,"-"),l=l.replace(/ -/g," ");let L=l.split(" ").filter(k=>k.length>0);L=L.slice(0,3),l=L.map(k=>{if(k.startsWith("-")&&(k=k.substring(1)),(k.match(/-/g)||[]).length>1){const T=k.split("-");k=T[0]+"-"+T.slice(1).join("")}return k.includes("-")?k.split("-").map((T,B)=>T.length===0?"":(B>0,T[0].toUpperCase()+T.slice(1).toLowerCase())).join("-"):k.length>0?k[0].toUpperCase()+k.slice(1).toLowerCase():""}).join(" "),l.length>0&&l[l.length-1]!==" "&&u.target.value.length>0&&u.target.value[u.target.value.length-1]===" "&&(l+=" "),l.length>100&&(l=l.slice(0,100)),u.target.value=l,r(u);break;case"doc":l=l.replace(/\D/g,""),l.length>4&&(l=`${l.slice(0,4)} ${l.slice(4,10)}`),l.length>11&&(l=l.slice(0,11)),u.target.value=l,r(u);break;case"date":{l=l.replace(/\D/g,""),l.length>4?l=`${l.slice(0,2)}.${l.slice(2,4)}.${l.slice(4,8)}`:l.length>2&&(l=`${l.slice(0,2)}.${l.slice(2,4)}`),l.length>10&&(l=l.slice(0,10)),s?.length>l.length&&[3,6].includes(l.length)&&(l=l.slice(0,l.length-1)),u.target.value=l,r(u);break}default:r(u);break}},b=(u,l)=>{let L=0;for(let k=0;k<Math.min(l,u.length);k++)/\d/.test(u[k])&&L++;return L},h=(u,l)=>{let L=0;for(let k=0;k<u.length;k++){if(L>=l)return k;/\d/.test(u[k])&&L++}return u.length};return t.jsxs(po,{children:[t.jsx(uo,{...m,value:s,placeholder:g?"":e,onFocus:()=>f(!0),onBlur:u=>{f(!1),m.onBlur?.(u)},onChange:x,inputMode:i==="number"||i==="doc"||i==="date"||i==="rubles"||i==="percents"?"numeric":"text",maxLength:i==="doc"?11:i==="date"?10:void 0,hasError:d}),n&&t.jsx(ho,{isVisible:g,children:n}),d&&p&&t.jsx(xo,{children:p})]})},po=o.div`
  position: relative;
  display: inline-block;
  width: 100%;
  margin-right: auto;
...
`,bo=({placeholder:e="",customPlaceholder:n,value:s,onChange:i,hasError:r=!1,errorMessage:d,rows:p=3,...m})=>{const[j,f]=y.useState(!1),g=!!(n&&!s&&!j);return t.jsxs(mo,{children:[t.jsx(wo,{...m,value:s,placeholder:g?"":e,onFocus:()=>f(!0),onBlur:x=>{f(!1),m.onBlur?.(x)},onChange:i,hasError:r,rows:p}),n&&t.jsx(vo,{isVisible:g,children:n}),r&&d&&t.jsx(yo,{children:d})]})},mo=o.div`
  position: relative;
  display: inline-block;
  width: 100%;
  margin-right: auto;
...
`,yo=o.span`
  ...
  margin-top: 4px;
  display: block;
`,Ee=({title:e,onClose:n,onCancel:s,onSave:i,children:r,isSaveDisabled:d=!1,isSubmitting:p=!1,mode:m="create",hideSaveButton:j=!1,hideCanselButton:f=!1,width:g="560px",saveButtonText:x="Сохранить",customLayout:b})=>{const h=m==="view",u=y.useRef(null);y.useEffect(()=>{const k=T=>{T.key==="Escape"&&n()};document.addEventListener("keydown",k);const E=document.body.style.overflow;return document.body.style.overflow="hidden",setTimeout(()=>u.current?.focus(),0),()=>{document.removeEventListener("keydown",k),document.body.style.overflow=E}},[n]);const l=k=>{k.target===k.currentTarget&&n()},L=k=>{k.preventDefault(),s()};return t.jsx(ko,{onMouseDown:l,role:"presentation",children:t.jsxs(jo,{ref:u,$width:g,role:"dialog","aria-modal":"true","aria-label":e||"Диалог",tabIndex:-1,children:[t.jsxs(Pe,{children:[t.jsx(Re,{children:e}),t.jsx(Co,{type:"button",onClick:n,"aria-label":"Закрыть",children:t.jsx("span",{"aria-hidden":!0,children:"×"})})]}),b?t.jsx($o,{children:b}):null,t.jsxs(So,{onSubmit:i,children:[t.jsx(Mo,{children:r}),t.jsxs(To,{children:[t.jsx(Do,{children:f?null:t.jsx(Eo,{isPrimary:!1,onClick:L,children:"Отменить"})}),t.jsx(Lo,{children:!h&&!j?t.jsx(Po,{type:"submit",disabled:d||p,children:p?"Сохранение...":x}):null})]})]})]})})},ko=o.div`
  position: fixed;
  inset: 0;
...
`,Xo=({name:e,value:n,onChange:s,onBlur:i,onKeyPress:r,placeholder:d="8 (999) 500-50-50",customPlaceholder:p,tabIndex:m,disabled:j=!1,hasError:f=!1,errorMessage:g})=>{const[x,b]=y.useState(!1),h=y.useRef(null),u=!!(p&&!n&&!x),l=T=>{const A=T.replace(/\D/g,"").slice(0,11);let P="";return A.length>0&&(P+="8"),A.length>1&&(P+=` (${A.slice(1,4)}`),A.length>4&&(P+=`) ${A.slice(4,7)}`),A.length>7&&(P+=`-${A.slice(7,9)}`),A.length>9&&(P+=`-${A.slice(9,11)}`),P},L=T=>{const B=l(T.target.value),A={...T,target:{...T.target,name:e,value:B}};s(A)},k=T=>{b(!1),i?.(T)},E=T=>{r?.(T)};return t.jsxs(qo,{children:[t.jsx(Go,{ref:h,name:e,type:"tel",value:n,onChange:L,onKeyPress:E,placeholder:u?"":d,maxLength:18,tabIndex:m,disabled:j,hasError:f,onFocus:()=>b(!0),onBlur:k,inputMode:"tel"}),p&&t.jsx(Ko,{isVisible:u,children:p}),f&&g&&t.jsx(Jo,{children:g})]})},qo=o.div`
  position: relative;
  display: inline-block;
  width: 100%;
  margin-right: auto;
...
`,Jo=o.span`
  ...
  margin-top: 4px;
  display: block;
`,Qo=({tabs:e,activeTab:n,onChange:s,addButton:i,fontSize:r=14})=>{const d=e.find(p=>p.id===n)?.content;return t.jsxs(t.Fragment,{children:[t.jsx(en,{children:t.jsxs(tn,{children:[e.map(p=>t.jsxs(on,{$isActive:n===p.id,onClick:()=>s(p.id),$fontSize:r,children:[p.label,n===p.id&&t.jsx(nn,{})]},p.id)),i&&t.jsx(rn,{children:i})]})}),d&&t.jsx(sn,{children:d})]})},en=o.div`
  width: auto;
...
`,Tn=({percentage:e,onChange:n,draggable:s=!1,colors:i={primary:"rgba(0, 125, 136, 1)",secondary:"rgba(37, 203, 161, 1)"}})=>{const r=y.useRef(null),[d,p]=y.useState(!1),m=x=>{!s||!n||(x.preventDefault(),p(!0),g(x))},j=x=>{!d||!n||g(x)},f=()=>{p(!1)},g=x=>{if(!r.current||!n)return;const b=r.current.getBoundingClientRect();let u=(x.clientX-b.left)/b.width*100;u=Math.max(0,Math.min(100,u)),n(Math.round(u))};return y.useEffect(()=>{if(d)return document.addEventListener("mousemove",j),document.addEventListener("mouseup",f),()=>{document.removeEventListener("mousemove",j),document.removeEventListener("mouseup",f)}},[d]),t.jsxs(Dn,{ref:r,$draggable:s,onMouseDown:m,children:[t.jsx(Ln,{$secondaryColor:i.secondary}),t.jsx(En,{$percentage:e,$primaryColor:i.primary}),s&&t.jsx(Pn,{$percentage:e,$primaryColor:i.primary})]})},Dn=o.div`
  width: 100%;
  height: 10px;
  position: relative;
  border-radius: 5px;
...
`,Rn=["zoomControl","fullscreenControl"];let oe=null;const In=e=>typeof window>"u"?Promise.reject(new Error("Window is not available")):window.ymaps?Promise.resolve(window.ymaps):(oe||(oe=new Promise((n,s)=>{const i=document.createElement("script"),r=e?`&apikey=${e}`:"";i.src=`https://api-maps.yandex.ru/2.1/?lang=ru_RU${r}`,i.async=!0,i.onload=()=>{window.ymaps?window.ymaps.ready(()=>n(window.ymaps)):s(new Error("Yandex Maps failed to load"))},i.onerror=()=>s(new Error("Failed to load Yandex Maps script")),document.head.appendChild(i)})),oe),Bn=({onLocationSelect:e,initialAddress:n="",initialLat:s=55.751244,initialLon:i=37.618423,apiKey:r,zoom:d=12,height:p=400,width:m="100%",inputPlaceholder:j="Введите адрес или название места",searchButtonLabel:f="Найти",draggablePlacemark:g=!0,controls:x=Rn,showSearch:b=!0,className:h,style:u,onError:l})=>{const[L,k]=y.useState(null),[E,T]=y.useState(n),[B,A]=y.useState(n),[P,z]=y.useState(!1),I=y.useRef(null);y.useEffect(()=>{let _=!1,v;return(async()=>{try{const C=await In(r);if(_||!I.current)return;v=new C.Map(I.current,{center:[s,i],zoom:d,controls:x});const M=new C.Placemark([s,i],{},{draggable:g});v.geoObjects.add(M),v.events.add("click",W=>{const R=W.get("coords");F(R,M,v)}),M.events.add("dragend",()=>{const W=M.geometry.getCoordinates();F(W,M,v)}),k(v),z(!0)}catch(C){l&&C instanceof Error&&l(C)}})(),()=>{_=!0,v&&v.destroy()}},[r,s,i,d,x,g,l]);const F=async(_,v,c)=>{if(window.ymaps)try{const W=(await window.ymaps.geocode(_)).geoObjects.get(0).getAddressLine();v.geometry.setCoordinates(_),c.panTo(_,{flying:!0}),A(W),T(W),e(W,_[0],_[1])}catch(C){l&&C instanceof Error&&l(C)}},Y=async()=>{if(!(!E.trim()||!window.ymaps||!L))try{const v=(await window.ymaps.geocode(E)).geoObjects.get(0);if(v){const c=v.geometry.getCoordinates(),C=v.properties.get("boundedBy");L.setBounds(C,{checkZoomRange:!0});const M=new window.ymaps.Placemark(c,{},{draggable:g});L.geoObjects.removeAll(),L.geoObjects.add(M);const W=v.getAddressLine();A(W),e(W,c[0],c[1]),M.events.add("dragend",()=>{const R=M.geometry.getCoordinates();F(R,M,L)})}}catch(_){l&&_ instanceof Error&&l(_)}};return t.jsxs(An,{className:h,style:u,children:[b&&t.jsxs(zn,{children:[t.jsx(Le,{type:"text",value:E,onChange:_=>T(_.target.value),placeholder:j,onKeyPress:_=>_.key==="Enter"&&Y(),disabled:!P}),t.jsx(Fn,{onClick:Y,disabled:!P,children:f})]}),t.jsxs(On,{children:["Выбранный адрес: ",t.jsx("strong",{children:B||"Не выбран"})]}),t.jsx(_n,{ref:I,$height:p,$width:m}),t.jsx(Yn,{children:"📍 Кликните на карте или найдите адрес через поиск"})]})},An=o.div`
  display: flex;
  flex-direction: column;
  gap: 12px;
`,zn=o.div`
...
`,ce=o.h1`
  ...
  color: black;
  font-weight: 600;
`;function ie(e,n="₽"){if(!e||e.trim()==="")return`0${n}`;const s=e.replace(/[^\d-]/g,"");if(!s||s==="-"||s==="")return`0${n}`;const i=parseInt(s,10);if(isNaN(i))return`0${n}`;const r=new Intl.NumberFormat("ru-RU",{style:"decimal",minimumFractionDigits:0,maximumFractionDigits:0}).format(i);return!0?`${r}${n}`:r}function Wn(e){if(!e)return 0;const n=e.replace(/\D/g,"");return parseInt(n,10)}const Nn=({title:e,data:n,maxValue:s,step:i,height:r=300,titleFontSize:d})=>{const[p,m]=y.useState(null),j=[];for(let g=0;g<=s;g+=i)j.push(g);const f=n.length>0?n[0].bars.map(g=>({name:g.name,color:g.color})):[];return t.jsxs(Hn,{children:[t.jsxs(le,{style:{marginTop:"0"},children:[t.jsx(ce,{style:{fontSize:d},children:e}),t.jsx(Vn,{children:f.map((g,x)=>t.jsxs(Zn,{children:[t.jsx(Un,{color:g.color}),t.jsx(Xn,{children:g.name})]},x))})]}),t.jsxs(qn,{height:r,children:[t.jsx(Gn,{children:j.map((g,x)=>t.jsx(Kn,{children:g.toLocaleString()},x))}),t.jsxs(Jn,{children:[t.jsxs(Qn,{children:[j.map((g,x)=>{const b=g/s*100;return t.jsx(er,{position:100-b},`line-${x}`)}),n.map((g,x)=>t.jsxs(tr,{onMouseEnter:()=>m(x),onMouseLeave:()=>m(null),children:[g.bars.map((b,h)=>{const u=g.bars.slice(h+1).reduce((l,L)=>l+L.value,0);return t.jsx(or,{height:b.value/s*100,offset:u/s*100,color:b.color,isHovered:p!==null&&p!==x},h)}),p===x&&t.jsxs(ir,{children:[t.jsxs(sr,{children:[t.jsxs(ar,{children:["Всего: ",ie(g.total.toString())]}),g.bars.map((b,h)=>t.jsxs(lr,{children:[b.name,": ",ie(b.value.toString())]},h))]}),t.jsx(cr,{})]})]},x))]}),t.jsx(nr,{children:n.map((g,x)=>t.jsx(rr,{style:{flex:1,textAlign:"center"},children:g.label},x))})]})]})]})},Hn=o.div`
  background-color: white;
  border-radius: 10px;
  border: 1px solid rgba(209, 213, 219, 1);
  padding: 20px;
...
`,pr=({title:e,data:n,xAxisLabel:s,yAxisLabel:i,maxX:r,maxY:d,minY:p,xStep:m,yStep:j,height:f=300,showLegend:g=!0,xAxisCustomLabels:x,showTooltip:b=!0,titleFontSize:h="30px"})=>{const[u,l]=y.useState(null),[L,k]=y.useState({x:0,y:0}),E=y.useRef(null),T=y.useRef(null),B=Math.max(...n.map(v=>v.x),r),A=[];for(let v=0;v<=B;v+=m)A.push(v);const P=[];for(let v=p;v<=d;v+=j)P.push(v);const z=x||A.map(v=>v.toString()),I=g?Array.from(new Set(n.filter(v=>v.label).map(v=>v.label))).map(v=>{const c=n.find(C=>C.label===v);return{name:v,color:c.color}}):[],F={};n.forEach(v=>{const c=v.label||"default";F[c]||(F[c]=[]),F[c].push(v)});const Y=v=>v/B*100,_=v=>{const c=d-p;return 100-(v-p)/c*100};return y.useEffect(()=>{if(u&&T.current){const v=T.current.getBoundingClientRect(),c=Y(u.x)/100*v.width,C=_(u.y)/100*v.height;k({x:c+v.left,y:C+v.top})}},[u,r,d,p]),t.jsxs(ur,{children:[t.jsxs(le,{style:{marginTop:"0"},children:[t.jsx(ce,{style:{fontSize:h},children:e}),g&&I.length>0&&t.jsx(hr,{children:I.map((v,c)=>t.jsxs(xr,{children:[t.jsx(fr,{color:v.color}),t.jsx(gr,{children:v.name})]},c))})]}),t.jsxs(br,{height:f,children:[t.jsxs(mr,{children:[P.map((v,c)=>t.jsx(wr,{children:v.toLocaleString()},c)),t.jsx($e,{children:i})]}),t.jsxs(vr,{ref:T,children:[P.map((v,c)=>t.jsx(yr,{position:_(v)},`hline-${c}`)),Object.values(F).map((v,c)=>v.map((C,M)=>{if(M===0)return null;const W=v[M-1],R=Y(W.x),V=_(W.y),w=Y(C.x),$=_(C.y);return t.jsx("svg",{style:{position:"absolute",top:0,left:0,width:"100%",height:"100%",pointerEvents:"none",zIndex:1},children:t.jsx("line",{x1:`${R}%`,y1:`${V}%`,x2:`${w}%`,y2:`${$}%`,stroke:C.color,strokeWidth:"1"})},`line-${c}-${M}`)})),n.map((v,c)=>t.jsx(kr,{x:Y(v.x),y:_(v.y),color:v.color,onMouseEnter:()=>l(v),onMouseLeave:()=>l(null),isHovered:u?.label===v.label},c))]})]}),b&&u&&t.jsxs($r,{ref:E,style:{left:L.x,top:L.y},children:[t.jsxs(Sr,{children:[u.name&&t.jsx(Mr,{children:u.name}),t.jsx(Tr,{children:u.y.toLocaleString()})]}),t.jsx(Dr,{})]}),t.jsxs(jr,{children:[z.map((v,c)=>{const M=A[c]/B*100;return t.jsx(Cr,{style:{left:`${M}%`,transform:"translateX(-50%)"},children:v},c)}),s&&t.jsx($e,{children:s})]})]})},ur=o.div`
  background-color: white;
  border-radius: 10px;
  border: 1px solid rgba(209, 213, 219, 1);
  padding: 20px;
...
`,Lr=({images:e,initialIndex:n,onClose:s})=>{const[i,r]=y.useState(n),[d,p]=y.useState(0),m=()=>{r(x=>x>0?x-1:e.length-1),p(0)},j=()=>{r(x=>x<e.length-1?x+1:0),p(0)},f=()=>{p(x=>(x+90)%360)},g=x=>{x.key==="Escape"?s():x.key==="ArrowLeft"?m():x.key==="ArrowRight"?j():(x.key==="r"||x.key==="к")&&f()};return t.jsx(Er,{onClick:s,onKeyDown:g,tabIndex:0,children:t.jsxs(Pr,{onClick:x=>x.stopPropagation(),children:[t.jsx(Rr,{onClick:s,children:t.jsxs("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[t.jsx("path",{d:"M18 6L6 18",stroke:"white",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"}),t.jsx("path",{d:"M6 6L18 18",stroke:"white",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})]})}),t.jsx(Ir,{children:t.jsx(Br,{onClick:f,title:"Повернуть (R)",children:t.jsx("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:t.jsx("path",{d:"M4.077 3C6.88767 5.202 8.48267 7.15733 8.862 8.866C9.24133 10.5753 9.29867 12.202 9.034 13.746H4L12.214 21L20 13.747H15.216C15.192 10.889 14.12 8.46 12 6.46C9.88 4.46 7.239 3.30667 4.077 3Z",stroke:"#50555C",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})})})}),t.jsxs(Ar,{children:[t.jsx(Se,{$position:"left",onClick:m,children:t.jsx("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:t.jsx("path",{d:"M15 18L9 12L15 6",stroke:"white",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})})}),t.jsx(zr,{src:e[i],alt:`Photo ${i+1}`,$rotation:d}),t.jsx(Se,{$position:"right",onClick:j,children:t.jsx("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:t.jsx("path",{d:"M9 18L15 12L9 6",stroke:"white",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})})})]}),t.jsx(Fr,{children:e.map((x,b)=>t.jsx(_r,{$active:b===i,onClick:()=>{r(b),p(0)}},b))})]})})},Er=o.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,Ie=({isOpen:e,callPhone:n,error:s,onClose:i})=>{const[r,d]=y.useState(!1);if(!e)return null;const p=/iPhone|iPad|iPod|Android/i.test(navigator.userAgent),m=()=>{p?window.location.href=`tel:${n}`:(navigator.clipboard.writeText(n),d(!0),setTimeout(()=>d(!1),2e3))};return t.jsx(Or,{onClick:i,children:t.jsxs(Yr,{onClick:j=>j.stopPropagation(),children:[t.jsx(Wr,{children:"Подтверждение авторизации"}),t.jsx(Me,{children:"Для завершения авторизации позвоните на номер:"}),t.jsxs(Nr,{onClick:m,title:p?"Позвонить":"Копировать номер",$clickable:!0,children:[n,!p&&r&&t.jsx(Hr,{children:"Скопировано!"})]}),t.jsx(Me,{children:"После звонка система автоматически подтвердит вашу авторизацию."}),s&&t.jsx(Vr,{children:s})]})})},Or=o.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,Vr=o.div`
  color: #e74c3c;
  margin: 10px 0;
`,Be=y.createContext({collapsed:!1,toggleCollapsed:()=>{},selectedSideMenuItem:null,setSelectedSideMenuItem:()=>{},selectedTopMenuItem:null,setSelectedTopMenuItem:()=>{}}),Zr=({items:e,bottomItems:n=[],logo:s,arrowIcon:i,collapsed:r,onToggle:d,selectedKey:p,onSelect:m,autoCollapseOnSelect:j=!1,width:f="315px",collapsedWidth:g="70px",className:x,style:b})=>{const h=y.useContext(Be),[u,l]=y.useState(r??h.collapsed??!1),[L,k]=y.useState(null),[E,T]=y.useState(p??h.selectedSideMenuItem??null),[B,A]=y.useState({visible:!1,x:0,y:0,items:[]}),P=y.useRef(null),z=r??h.collapsed??u,I=R=>{l(R),h.toggleCollapsed(),d?.(R)},F=p??h.selectedSideMenuItem??E,Y=R=>{T(R),h.setSelectedSideMenuItem(R)};y.useEffect(()=>{r!==void 0&&(l(r),r&&k(null))},[r]),y.useEffect(()=>{p!==void 0&&Y(p)},[p]),y.useEffect(()=>{const R=()=>A(V=>({...V,visible:!1}));return document.addEventListener("click",R),()=>document.removeEventListener("click",R)},[]);const _=()=>{const R=!z;I(R),R&&k(null)},v=R=>{R.disabled||R.hidden||(Y(R.key),m?.(R),R.onClick?.(R),j&&(I(!0),k(null)))},c=R=>{k(V=>V===R?null:R)},C=(R,V)=>{const w=(R.children?.length||0)>0;if(z&&w){V.stopPropagation();const $=V.currentTarget.getBoundingClientRect();A({visible:!0,x:$.right+6,y:$.top,items:R.children||[]});return}w?c(R.key):v(R)},M=(R,V=!1)=>R.filter(w=>!w.hidden).map(w=>{const $=(w.children?.length||0)>0,a=L===w.key,S=F===w.key||!!w.children&&w.children.some(D=>D.key===F);return t.jsxs(y.Fragment,{children:[t.jsxs(Qr,{$collapsed:z,$selected:S,onClick:D=>C(w,D),$disabled:w.disabled,title:w.label,children:[w.icon&&t.jsx(ti,{$collapsed:z,children:w.icon}),!z&&t.jsx(ei,{children:w.label}),!z&&$&&t.jsx(ni,{$expanded:a,children:"▾"})]}),!z&&$&&a&&t.jsx(oi,{children:M(w.children||[],!0)})]},w.key)}),W=y.useMemo(()=>B.visible?t.jsx(ii,{style:{left:B.x,top:B.y},children:B.items.map(R=>t.jsx(si,{onClick:()=>{v(R),A({visible:!1,x:0,y:0,items:[]})},$selected:F===R.key,children:R.label},R.key))}):null,[B,F]);return t.jsxs(Ur,{ref:P,$collapsed:z,$width:f,$collapsedWidth:g,className:x,style:b,children:[t.jsxs(Xr,{children:[t.jsx(qr,{onClick:_,"aria-label":"Переключить меню",children:i??t.jsx(Gr,{$collapsed:z,children:"❮"})}),!z&&s&&t.jsx(Kr,{children:s})]}),t.jsxs(Jr,{children:[t.jsx(Te,{children:M(e)}),n.length>0&&t.jsxs(t.Fragment,{children:[t.jsx(ri,{}),t.jsx(Te,{children:M(n)})]})]}),W,t.jsx(ai,{$collapsed:z})]})},Ur=o.div`
...
`,de="http://95.163.226.24:8080/api",ne="access_token",di="refresh_token",Q={setTokens(e){localStorage.setItem(ne,e)},getAccessToken(){return localStorage.getItem(ne)},clear(){localStorage.removeItem(ne),localStorage.removeItem(di)}};async function pe(e,n={}){const{method:s="GET",body:i,headers:r={},token:d}=n,p=async j=>{const f={"Content-Type":"application/json",...r};j&&(f.Authorization=`Bearer ${j}`);const g=e.startsWith("http")?e:`${de}${e}`;return await fetch(g,{method:s,headers:f,body:i?JSON.stringify(i):void 0})},m=async(j,f=!0)=>{const g=await p(j);if(g.ok){if(g.status===204)return null;const b=await g.text();if(!b)return null;try{return JSON.parse(b)}catch{return b}}if(g.status===401&&f){const b=await pi();if(b)return m(b,!1)}let x=`Request failed with status ${g.status}`;try{const b=await g.json();b&&typeof b.error=="string"?x=b.error:typeof b=="string"&&(x=b)}catch{const b=await g.text();b&&(x=b)}throw new Error(x)};return m(d)}async function pi(){const e=await fetch(`${de}/auth/refresh`,{method:"POST",headers:{"Content-Type":"application/json"}});if(!e.ok)return Q.clear(),null;const n=await e.json();return n.access_token?(Q.setTokens(n.access_token),n.access_token):(Q.clear(),null)}const ze=(e,n)=>pe("/auth/call/initiate",{method:"POST",body:{phone:e,user_type:n}}),Fe=(e,n,s)=>pe("/auth/call/confirm",{method:"POST",body:{phone:e,check_id:n,user_type:s}}),ui=({onLoginSuccess:e,userType:n="delivery_operator",title:s="Авторизация",submitLabel:i="Войти",placeholder:r="8 (xxx) xxx-xx-xx",supportPhone:d="8 989 924 24 24",supportLinkUrl:p="https://waypay.one",supportLinkText:m="waypay.one",className:j,style:f,pollingIntervalMs:g=3e3})=>{const[x,b]=y.useState(!1),[h,u]=y.useState(""),[l,L]=y.useState(!1),[k,E]=y.useState(""),[T,B]=y.useState(""),[A,P]=y.useState(!1),z=y.useRef(void 0);y.useEffect(()=>()=>{z.current&&clearInterval(z.current)},[]);const I=c=>{const C=c.replace(/\D/g,"");return C?C.startsWith("8")?`+7${C.slice(1)}`:C.startsWith("7")?`+${C}`:`+${C}`:""},F=()=>{L(!1),z.current&&window.clearInterval(z.current)},Y=async c=>{if(c.preventDefault(),!h){B("Введите номер телефона");return}b(!0),B("");const C=I(h);try{const M=await ze(C,n);E(M.call_phone),L(!0),_(C,M.check_id)}catch(M){console.error("Auth error:",M),B("Не удалось инициировать авторизацию. Проверьте номер.")}finally{b(!1)}},_=(c,C)=>{z.current&&window.clearInterval(z.current),z.current=window.setInterval(()=>{v(c,C)},g)},v=async(c,C)=>{if(!A){P(!0);try{const M=await Fe(c,C,n);M.access_token&&M.refresh_token&&(Q.setTokens(M.access_token),z.current&&window.clearInterval(z.current),L(!1),e(M.access_token))}catch(M){console.error("Verification error:",M),B("Ошибка проверки авторизации")}finally{P(!1)}}};return t.jsxs(hi,{className:j,style:f,children:[t.jsxs(xi,{children:[t.jsxs(fi,{onSubmit:Y,children:[t.jsx(gi,{children:s}),t.jsx(bi,{children:t.jsx(mi,{children:t.jsx(Ae,{value:h,onChange:c=>u(c),placeholder:r})})}),T&&t.jsx(ji,{children:t.jsx("span",{children:T})}),t.jsx(wi,{type:"submit",disabled:x,children:i})]}),t.jsxs(vi,{children:["Хотите получить доступ к нашим продуктам?",t.jsx("br",{}),"Обратитесь по номеру"," ",t.jsx(yi,{href:`tel:${d}`,children:d}),t.jsx("br",{}),"или оставьте заявку на"," ",t.jsx(ki,{href:p,target:"_blank",rel:"noreferrer",children:m})]})]}),t.jsx(Ie,{isOpen:l,onClose:F,callPhone:k,error:T})]})},hi=o.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,_e=e=>{let n=0;for(let i=0;i<e.length;i++)n=e.charCodeAt(i)+((n<<5)-n);return`hsl(${Math.abs(n%360)}, 60%, 60%)`},Ci=e=>!e||!e.trim()?"?":e.split(" ").filter(i=>i.length>0).map(i=>i[0].toUpperCase()).join("").slice(0,2)||"?",$i=(e,n=100)=>{const s=document.createElement("canvas");s.width=n,s.height=n;const i=s.getContext("2d");if(!i)return"";const r=_e(e);i.fillStyle=r,i.beginPath(),i.arc(n/2,n/2,n/2,0,Math.PI*2),i.fill(),i.fillStyle="#ffffff";const d=n/2;i.font=`bold ${d}px "Manrope", Arial, sans-serif`,i.textAlign="center",i.textBaseline="middle";const p=d*.1;return i.fillText(e,n/2,n/2+p),s.toDataURL("image/png")},Si=e=>{if(!e)return"";const n=typeof e=="string"?new Date(e):e;if(isNaN(n.getTime()))return"";const s=n.getDate().toString().padStart(2,"0"),i=(n.getMonth()+1).toString().padStart(2,"0"),r=n.getFullYear();return`${s}-${i}-${r}`};function Mi(e){return new Date(e)}const Oe=e=>{let n;try{if(e instanceof Date)n=e;else if(typeof e=="string"||typeof e=="number")n=new Date(e);else throw new Error("Неподдерживаемый тип данных");if(isNaN(n.getTime()))return"неверная дата";const s=new Date;if(n>s){const g=Math.floor((n.getTime()-s.getTime())/1e3),x=Math.floor(g/60),b=Math.floor(x/60),h=Math.floor(b/24);return g<10?"скоро":g<60?`через ${g} секунд`:x===1?"через минуту":x<60?`через ${x} минут`:b===1?"через час":b<24?`через ${b} часов`:h===1?"завтра":h<7?`через ${h} дней`:"в будущем"}const i=Math.floor((s.getTime()-n.getTime())/1e3),r=Math.floor(i/60),d=Math.floor(r/60),p=Math.floor(d/24),m=Math.floor(p/7),j=Math.floor(p/30),f=Math.floor(p/365);if(i<10)return"только что";if(i<60){const g=Math.max(1,i);return g===1?"секунду назад":g<5?`${g} секунды назад`:`${g} секунд назад`}return r<60?r===1?"минуту назад":r<5?`${r} минуты назад`:`${r} минут назад`:d<24?d===1?"час назад":d<5?`${d} часа назад`:`${d} часов назад`:p<7?p===1?"вчера":p===2?"позавчера":`${p} дня назад`:m<4?m===1?"неделю назад":m<5?`${m} недели назад`:`${m} недель назад`:j<12?j===1?"месяц назад":j<5?`${j} месяца назад`:`${j} месяцев назад`:f===1?"год назад":f<5?`${f} года назад`:`${f} лет назад`}catch(s){return console.error("Ошибка форматирования относительного времени:",s),"ошибка даты"}},Ye=e=>{try{return e.toLocaleDateString("ru-RU",{day:"2-digit",month:"2-digit",year:"2-digit",hour:"2-digit",minute:"2-digit"})}catch{return"неверная дата"}},Ti=(e,n={})=>{const{useExactAfterMonths:s=6,includeTime:i=!0}=n,r=new Date(e);return isNaN(r.getTime()),Math.floor((new Date().getTime()-r.getTime())/(1e3*60*60*24*30))>=s?i?Ye(r):r.toLocaleDateString("ru-RU",{day:"2-digit",month:"2-digit",year:"2-digit"}):Oe(r)};exports.API_BASE_URL=de;exports.AddButton=dt;exports.AuthCallModal=Ie;exports.AuthPage=ui;exports.BackButton=xt;exports.BaseModal=Ee;exports.Checkbox=Yt;exports.ColumnChart=Nn;exports.ContextMenu=se;exports.CountInfoTitle=bn;exports.CustomCalendar=re;exports.CustomInput=Le;exports.CustomPhoneInput=Ae;exports.CustomSelect=St;exports.CustomTable=Je;exports.CustomTextArea=bo;exports.CustomTitle=ce;exports.DefaultButton=ae;exports.DeleteButton=bt;exports.EditButton=wt;exports.EntitySelectContainer=an;exports.ExportButton=kt;exports.InputTitle=wn;exports.ModalInfoTitle=vn;exports.Pagination=fo;exports.PeriodField=Io;exports.PhoneModalInput=Xo;exports.PhotoViewerModal=Lr;exports.ProgressBar=Tn;exports.RadioButton=$n;exports.ScatterPlot=pr;exports.SideMenu=Zr;exports.SideMenuContext=Be;exports.Tabs=Qo;exports.TitleField=le;exports.ToggleSwitch=Cn;exports.YandexMapSelector=Bn;exports.apiRequest=pe;exports.confirmCallAuth=Fe;exports.formatDate=Si;exports.formatExactDate=Ye;exports.formatMoney=ie;exports.formatRelativeTime=Oe;exports.formatRelativeTimeExtended=Ti;exports.generateAvatar=$i;exports.getInitials=Ci;exports.initiateCallAuth=ze;exports.parseDateInput=Mi;exports.parseMoney=Wn;exports.stringToColor=_e;
