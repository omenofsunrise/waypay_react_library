...
`,Vo=({name:e,value:n,onChange:s,onBlur:i,onKeyPress:r,placeholder:c="8 (999) 500-50-50",customPlaceholder:d,tabIndex:b,disabled:k=!1,hasError:f=!1,errorMessage:g})=>{const[x,w]=y.useState(!1),h=y.useRef(null),u=!!(d&&!n&&!x),l=E=>{const A=E.replace(/\D/g,"").slice(0,11);let P="";return A.length>0&&(P+="8"),A.length>1&&(P+=` (${A.slice(1,4)}`),A.length>4&&(P+=`) ${A.slice(4,7)}`),A.length>7&&(P+=`-${A.slice(7,9)}`),A.length>9&&(P+=`-${A.slice(9,11)}`),P},D=E=>{const z=l(E.target.value),A={...E,target:{...E.target,name:e,value:z}};s(A)},j=E=>{w(!1),i?.(E)},I=E=>{r?.(E)};return t.jsxs(Zo,{children:[t.jsx(Uo,{ref:h,name:e,type:"tel",value:n,onChange:D,onKeyPress:I,placeholder:u?"":c,maxLength:18,tabIndex:b,disabled:k,hasError:f,onFocus:()=>w(!0),onBlur:j,inputMode:"tel"}),d&&t.jsx(Xo,{isVisible:u,children:d}),f&&g&&t.jsx(qo,{children:g})]})},Zo=o.div`
  position: relative;
  display: inline-block;
  width: 100%;
  margin-right: auto;
