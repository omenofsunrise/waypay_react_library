...
`,qe=o(U.motion.div)`
  ...
  z-index: 1001;
  margin-left: 2px;
`,Ge=({columns:e,data:n,onRowDoubleClick:s,contextMenuActions:i=[],onSort:r,sortConfig:c,onRowClick:u,selectedRow:g,fixedHeight:k,hasTotalsRow:f,debtChecker:m,rowStyles:x={},isLoading:y})=>{const[d,h]=w.useState(null),[l,P]=w.useState(null),j=w.useRef(null),I=w.useRef(null),L=500,F=g!==void 0?g:d,A=b=>{!e[b].isSortable||!r||r(b)},Y=m||(b=>{const C=b[8];return typeof C=="string"?parseFloat(C.replace(/[^\d.]/g,""))>0:!1}),B=b=>{g===void 0&&h(b===F?null:b),u&&u(n[b],b)},z=(b,C)=>{s&&s(b,C)},W=(b,C)=>{if(i.length===0)return;b.preventDefault();const a="touches"in b?b.touches[0].clientX:b.clientX,$="touches"in b?b.touches[0].clientY:b.clientY;P({x:a,y:$,rowIndex:C})},_=(b,C)=>{b.preventDefault(),W(b,C)},v=(b,C)=>{i.length!==0&&(I.current&&clearTimeout(I.current),I.current=window.setTimeout(()=>{W(b,C)},L))},p=()=>{I.current&&(clearTimeout(I.current),I.current=null)},M=()=>{I.current&&window.clearTimeout(I.current)},T=()=>{P(null)};w.useEffect(()=>{const b=()=>{l&&T()};return document.addEventListener("click",b),()=>{document.removeEventListener("click",b),I.current&&clearTimeout(I.current)}},[l]);const N=(b,C,a)=>{if(C)return{backgroundColor:"#FFFFFF",color:"#000000",fontWeight:"bold"};const $=x[b]||{};return b===F?{backgroundColor:$.backgroundColor||"#007D88",color:$.color||"#FFFFFF",fontWeight:$.fontWeight||"normal"}:a?{backgroundColor:$.backgroundColor||"#E8D8D8",color:$.color||"inherit",fontWeight:$.fontWeight||"normal"}:n[b][n[b].length-1]===!1?{backgroundColor:$.backgroundColor||"#E8F5E8",color:"#1B5E20",fontWeight:$.fontWeight||"normal"}:{backgroundColor:$.backgroundColor||"#FFFFFF",color:$.color||"inherit",fontWeight:$.fontWeight||"normal"}},E=(b,C,a)=>{if(C)return"#FFFFFF";const $=N(b,C,a);return $.hoverBackgroundColor?$.hoverBackgroundColor:b===F?"#007D88":a?"#E8D8D8CC":n[b][n[b].length-1]===!1?"#51D5B4CC":"#F3F4F6"},V=()=>{if(!l||i.length===0)return null;const b=(typeof i=="function"?i(n[l.rowIndex]):i).filter(C=>typeof C=="object"&&(typeof C.shouldShow!="function"||C.shouldShow(n[l.rowIndex])));return b.length===0?null:t.jsx(tt,{initial:{opacity:0,scale:.95},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.95},transition:{duration:.15},style:{position:"fixed",left:l.x,top:l.y,zIndex:1e3},onClick:C=>C.stopPropagation(),children:t.jsx(se,{items:b.map(C=>{const a={label:C.label,color:C.color,disabled:C.disabled};return C.getSubmenu?a.submenu=C.getSubmenu(n[l.rowIndex]):C.action&&(a.action=()=>{C.action(n[l.rowIndex],l.rowIndex),T()}),a}),onClose:T,x:0,y:0})})};return t.jsx(Qe,{ref:j,children:y?t.jsx(Je,{children:t.jsx(Ke,{})}):t.jsxs(t.Fragment,{children:[t.jsxs(et,{children:[t.jsx(ot,{children:t.jsx(xe,{children:e.map((b,C)=>!b.isHidden&&t.jsx(rt,{$isSortable:b.isSortable,$isActive:c?.key===C,onClick:()=>A(C),$align:b.align||"center",$isFirst:C===0,$isLast:C===e.length-1,children:t.jsxs(it,{$align:b.align||"center",children:[b.name,b.isSortable&&t.jsx(st,{$direction:c?.key===C?c.direction:"asc",animate:{rotate:c?.key===C&&c.direction==="desc"?180:0,color:c?.key===C?"#007D88":"#6B7280"},transition:{duration:.2},children:t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:t.jsx("path",{d:"M5.77734 2.92383L5.25 3.45117L3.26953 1.47656L3.26367 12H2.51367L2.51953 1.45898L0.527344 3.45117L0 2.92383L2.88867 0.0351562L5.77734 2.92383ZM10.5059 8.54883L11.0391 9.07617L8.15039 11.9648L5.25586 9.07617L5.78906 8.54883L7.76953 10.5293L7.76367 0H8.51367L8.51953 10.5352L10.5059 8.54883Z",fill:"currentColor"})})})]})},C))})}),t.jsx(nt,{$fixedHeight:k,children:t.jsx(U.AnimatePresence,{children:n.map((b,C)=>{const a=!!(f&&C===n.length-1),$=!!(!a&&Y(b)),S=N(C,a,$),D=E(C,a,$);return t.jsx(xe,{initial:{opacity:0,y:-10},animate:{opacity:1,y:0,backgroundColor:S.backgroundColor||"#FFFFFF",color:S.color||"inherit",fontWeight:S.fontWeight||"normal"},exit:{opacity:0,y:10},transition:{duration:.2,ease:"easeOut"},$isLast:C===n.length-1,$isSelected:C===F,$isTotalsRow:a,onClick:()=>!a&&B(C),onDoubleClick:()=>!a&&z(b,C),onContextMenu:O=>!a&&_(O,C),onTouchStart:O=>!a&&v(O,C),onTouchEnd:p,onTouchMove:M,whileHover:a?{}:{backgroundColor:D,transition:{duration:.15}},style:{backgroundColor:S.backgroundColor||"#FFFFFF",color:S.color||"inherit",fontWeight:S.fontWeight||"normal"},children:b.map((O,Z)=>!e[Z]?.isHidden&&t.jsx(at,{$align:e[Z]?.align||"center",$isFirst:Z===0,$isLast:Z===b.length-1,$isTotalsCell:a,$isBeforeTotals:a&&Z<b.findIndex(H=>H==="Итого:"),children:O},Z))},`row-${C}`)})})})]}),t.jsx(U.AnimatePresence,{children:V()})]})})},Je=o.div`
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
...
`,St=({placeholder:e="",customPlaceholder:n,value:s,onChange:i,hasError:r=!1,errorMessage:c,options:u,name:g,disabled:k=!1,required:f=!1,...m})=>{const[x,y]=w.useState(!1),[d,h]=w.useState(!1),l=w.useRef(null),P=!!(n&&!s&&!x),j=R=>{i&&!k&&i({target:{value:R,name:g}}),h(!1),y(!1)},I=R=>{l.current&&!l.current.contains(R.target)&&(h(!1),y(!1))},L=()=>{k||(h(!d),y(!d))};w.useEffect(()=>(document.addEventListener("mousedown",I),()=>{document.removeEventListener("mousedown",I)}),[]);const F=u.find(R=>R.value===s),A=F?F.label:"";return t.jsxs(Mt,{ref:l,...m,children:[t.jsxs(Dt,{children:[t.jsxs(Tt,{hasError:r,isOpen:d,disabled:k,onClick:L,onFocus:()=>!k&&y(!0),onBlur:()=>y(!1),tabIndex:k?-1:0,children:[t.jsx(Lt,{children:A||e&&t.jsx(Et,{children:e})}),t.jsx(Pt,{isOpen:d,disabled:k,children:t.jsx("svg",{width:"17",height:"9",viewBox:"0 0 17 9",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:t.jsx("path",{d:"M1.5 1L8.5 8L15.5 1",stroke:k?"#CCCCCC":"#50555C",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})})})]}),d&&t.jsx(It,{children:u.map(R=>t.jsxs(Rt,{$isSelected:R.value===s,onClick:()=>j(R.value),children:[t.jsx(Bt,{$isSelected:R.value===s,children:R.value===s&&t.jsx(At,{})}),t.jsx(zt,{children:R.label})]},R.value))})]}),n&&t.jsx(Ft,{isVisible:P,children:n}),r&&c&&t.jsx(_t,{children:c}),t.jsx(Ot,{name:g,value:s||"",onChange:()=>{},tabIndex:-1,required:f,children:u.map(R=>t.jsx("option",{value:R.value,children:R.label},R.value))})]})},Mt=o.div`
  position: relative;
...
`,Ot=o.select`
  ...
  width: 0;
  pointer-events: none;
`,Nt=({checked:e=!1,onChange:n,className:s,label:i,disabled:r=!1})=>{const[c,u]=w.useState(!1),g=()=>{r||!n||n(!e)},k=f=>{r||(f.key==="Enter"||f.key===" ")&&(f.preventDefault(),g())};return t.jsxs(Yt,{className:s,onClick:g,onKeyPress:k,tabIndex:r?-1:0,disabled:r,children:[t.jsx(Wt,{checked:e,isFocused:c,disabled:r,onMouseEnter:()=>!r&&u(!0),onMouseLeave:()=>!r&&u(!1),onFocus:()=>!r&&u(!0),onBlur:()=>!r&&u(!1),children:e&&t.jsx(Vt,{viewBox:"0 0 8 8",fill:"none",xmlns:"http://www.w3.org/2000/svg",disabled:r,children:t.jsx("path",{d:"M7.375 1.1875L2.65 6.8125L0.625 4.5625",stroke:r?"rgba(173, 179, 188, 1)":"white",strokeLinecap:"round",strokeLinejoin:"round"})})}),i&&t.jsx(Ht,{disabled:r,children:i})]})},Yt=o.div`
  display: flex;
  align-items: center;
...
`,le=({placeholder:e="",customPlaceholder:n,value:s,inputType:i="text",onChange:r,hasError:c=!1,errorMessage:u,...g})=>{const[k,f]=w.useState(!1),m=!!(n&&!s&&!k),x=h=>{if(!r)return;let l=h.target.value;switch(i){case"number":/^\d*$/.test(l)&&r?.(h);break;case"rubles":{const j=h.target.selectionStart,I=h.target.value;let L=I.replace(/[^\d]/g,"");if(L===""){h.target.value="",r(h);break}const F=parseInt(L,10);if(!isNaN(F)){let A=F.toLocaleString("ru-RU");A+=" ₽";const R=y(I,j||0),Y=d(A,R);h.target.value=A,r(h),setTimeout(()=>{h.target.setSelectionRange(Y,Y)},0)}break}case"percents":{l=l.replace(/[^\d.]/g,"");const j=l.split(".");j.length>2&&(l=j[0]+"."+j.slice(1).join("")),j.length===2&&j[1].length>2&&(l=j[0]+"."+j[1].slice(0,2));const I=parseFloat(l);if(isNaN(I)||(I>100?l="100":I<0&&(l="0")),l&&l!==""){l+=" %";const L=h.target.selectionStart||0,F=l.replace(" %","");h.target.value=l,r(h),setTimeout(()=>{L<F.length&&h.target.setSelectionRange(L,L)},0)}else h.target.value=l,r(h);break}case"fullname":l=l.replace(/[^a-zA-Zа-яА-ЯёЁ'\-\s]/g,""),l=l.replace(/\s{2,}/g," "),l=l.replace(/- /g,"-"),l=l.replace(/ -/g," ");let P=l.split(" ").filter(j=>j.length>0);P=P.slice(0,3),l=P.map(j=>{if(j.startsWith("-")&&(j=j.substring(1)),(j.match(/-/g)||[]).length>1){const L=j.split("-");j=L[0]+"-"+L.slice(1).join("")}return j.includes("-")?j.split("-").map((L,F)=>L.length===0?"":(F>0,L[0].toUpperCase()+L.slice(1).toLowerCase())).join("-"):j.length>0?j[0].toUpperCase()+j.slice(1).toLowerCase():""}).join(" "),l.length>0&&l[l.length-1]!==" "&&h.target.value.length>0&&h.target.value[h.target.value.length-1]===" "&&(l+=" "),l.length>100&&(l=l.slice(0,100)),h.target.value=l,r(h);break;case"doc":l=l.replace(/\D/g,""),l.length>4&&(l=`${l.slice(0,4)} ${l.slice(4,10)}`),l.length>11&&(l=l.slice(0,11)),h.target.value=l,r(h);break;case"date":{l=l.replace(/\D/g,""),l.length>4?l=`${l.slice(0,2)}.${l.slice(2,4)}.${l.slice(4,8)}`:l.length>2&&(l=`${l.slice(0,2)}.${l.slice(2,4)}`),l.length>10&&(l=l.slice(0,10)),s?.length>l.length&&[3,6].includes(l.length)&&(l=l.slice(0,l.length-1)),h.target.value=l,r(h);break}default:r(h);break}},y=(h,l)=>{let P=0;for(let j=0;j<Math.min(l,h.length);j++)/\d/.test(h[j])&&P++;return P},d=(h,l)=>{let P=0;for(let j=0;j<h.length;j++){if(P>=l)return j;/\d/.test(h[j])&&P++}return h.length};return t.jsxs(po,{children:[t.jsx(uo,{...g,value:s,placeholder:m?"":e,onFocus:()=>f(!0),onBlur:h=>{f(!1),g.onBlur?.(h)},onChange:x,inputMode:i==="number"||i==="doc"||i==="date"||i==="rubles"||i==="percents"?"numeric":"text",maxLength:i==="doc"?11:i==="date"?10:void 0,hasError:c}),n&&t.jsx(ho,{isVisible:m,children:n}),c&&u&&t.jsx(xo,{children:u})]})},po=o.div`
  position: relative;
  display: inline-block;
  width: 100%;
  margin-right: auto;
...
`,xo=o.span`
  ...
  margin-top: 4px;
  display: block;
`,fo=({total:e,current:n=1,onChange:s,itemsPerPage:i=10})=>{const r=Math.ceil(e/i),[c,u]=w.useState(n),g=f=>{f<1||f>r||f===c||(u(f),s?.(f))},k=()=>{const f=[];let x=1,y=r;if(r>5){const d=Math.floor(2.5);x=Math.max(c-d,1),y=Math.min(c+d,r),c<=d+1?y=5:c>=r-d&&(x=r-5+1)}for(let d=x;d<=y;d++)f.push(t.jsx(K,{active:d===c,onClick:()=>g(d),children:d},d));return x>1&&(x>2&&f.unshift(t.jsx(K,{children:"..."},"start-ellipsis")),f.unshift(t.jsx(K,{active:c===1,onClick:()=>g(1),children:"1"},1))),y<r&&(y<r-1&&f.push(t.jsx(K,{children:"..."},"end-ellipsis")),f.push(t.jsx(K,{active:r===c,onClick:()=>g(r),children:r},r))),f};return t.jsxs(go,{children:[t.jsx(ke,{disabled:c===1,onClick:()=>g(c-1),children:t.jsx("svg",{width:"7",height:"11",viewBox:"0 0 7 11",fill:"none",children:t.jsx("path",{d:"M6 0.5L1 5.5L6 10.5",stroke:c===1?"#ccc":"black",strokeLinecap:"round",strokeLinejoin:"round"})})}),k(),t.jsx(ke,{disabled:c===r,onClick:()=>g(c+1),style:{transform:"rotate(180deg)"},children:t.jsx("svg",{width:"7",height:"11",viewBox:"0 0 7 11",fill:"none",children:t.jsx("path",{d:"M6 0.5L1 5.5L6 10.5",stroke:c===r?"#ccc":"black",strokeLinecap:"round",strokeLinejoin:"round"})})})]})},go=o.div`
  display: flex;
...
`,bo=({placeholder:e="",customPlaceholder:n,value:s,onChange:i,hasError:r=!1,errorMessage:c,rows:u=3,...g})=>{const[k,f]=w.useState(!1),m=!!(n&&!s&&!k);return t.jsxs(mo,{children:[t.jsx(wo,{...g,value:s,placeholder:m?"":e,onFocus:()=>f(!0),onBlur:x=>{f(!1),g.onBlur?.(x)},onChange:i,hasError:r,rows:u}),n&&t.jsx(vo,{isVisible:m,children:n}),r&&c&&t.jsx(yo,{children:c})]})},mo=o.div`
  position: relative;
  display: inline-block;
  width: 100%;
  margin-right: auto;
...
`,yo=o.span`
  ...
  margin-top: 4px;
  display: block;
`,Te=({title:e,onClose:n,onCancel:s,onSave:i,children:r,isSaveDisabled:c=!1,isSubmitting:u=!1,mode:g="create",hideSaveButton:k=!1,hideCanselButton:f=!1,width:m="560px",saveButtonText:x="Сохранить",customLayout:y})=>{const d=g==="view",h=w.useRef(null);w.useEffect(()=>{const j=L=>{L.key==="Escape"&&n()};document.addEventListener("keydown",j);const I=document.body.style.overflow;return document.body.style.overflow="hidden",setTimeout(()=>h.current?.focus(),0),()=>{document.removeEventListener("keydown",j),document.body.style.overflow=I}},[n]);const l=j=>{j.target===j.currentTarget&&n()},P=j=>{j.preventDefault(),s()};return t.jsx(ko,{onMouseDown:l,role:"presentation",children:t.jsxs(jo,{ref:h,$width:m,role:"dialog","aria-modal":"true","aria-label":e||"Диалог",tabIndex:-1,children:[t.jsxs(Le,{children:[t.jsx(Ee,{children:e}),t.jsx(Co,{type:"button",onClick:n,"aria-label":"Закрыть",children:t.jsx("span",{"aria-hidden":!0,children:"×"})})]}),y?t.jsx($o,{children:y}):null,t.jsxs(So,{onSubmit:i,children:[t.jsx(Mo,{children:r}),t.jsxs(Do,{children:[t.jsx(To,{children:f?null:t.jsx(Eo,{isPrimary:!1,onClick:P,children:"Отменить"})}),t.jsx(Lo,{children:!d&&!k?t.jsx(Po,{type:"submit",disabled:c||u,children:u?"Сохранение...":x}):null})]})]})]})})},ko=o.div`
  position: fixed;
  inset: 0;
...
`,Po=o(ee)`
  ...
  border-radius: 10px;
  font-size: 16px;
`,Io=[{id:"Last7Days",label:"За последние 7 дней",value:"Last7Days"},{id:"ThisMonth",label:"За этот месяц",value:"ThisMonth"},{id:"Last31Days",label:"За последние 31 день",value:"Last31Days"},{id:"PreviousMonth",label:"За прошлый месяц",value:"PreviousMonth"},{id:"ThisYear",label:"За этот год",value:"ThisYear"},{id:"PreviousYear",label:"За прошлый год",value:"PreviousYear"}],Ro=({value:e="",placeholder:n="Выберите период",options:s=Io,showCustomPeriodButton:i=!0,onChange:r,onCustomPeriodClick:c})=>{const[u,g]=w.useState(!1),[k,f]=w.useState(!1),[m,x]=w.useState(""),[y,d]=w.useState(""),[h,l]=w.useState(""),P=w.useRef(null),j=w.useRef(null);w.useEffect(()=>{if(e==="Custom"&&y&&h){const B=R(y),z=R(h);x(`С ${B} по ${z}`)}else{const B=s.find(z=>z.value===e);x(B?B.label:"")}},[e,s,y,h]),w.useEffect(()=>{const B=z=>{P.current&&!P.current.contains(z.target)&&g(!1),k&&j.current&&!j.current.contains(z.target)&&([...document.querySelectorAll(".calendar-container, .arrow-button")].some(v=>v.contains(z.target))||f(!1))};return document.addEventListener("mousedown",B),()=>{document.removeEventListener("mousedown",B)}},[k]);const I=B=>{r?.(B.value),g(!1)},L=()=>{g(!1),c?c():f(!0)},F=()=>{r?.(""),x(""),d(""),l("")},A=()=>{if(y&&h){const B=R(y),z=R(h),W=`С ${B} по ${z}`;r?.("Custom",y,h),x(W),f(!1)}},R=B=>{const z=new Date(B),W=String(z.getDate()).padStart(2,"0"),_=String(z.getMonth()+1).padStart(2,"0"),v=z.getFullYear();return`${W}.${_}.${v}`},Y=()=>t.jsxs(Zo,{children:[t.jsx(Le,{style:{margin:0},children:t.jsx(Ee,{style:{margin:0},children:"Выбор периода"})}),t.jsx(Uo,{onClick:F,children:"Очистить период"})]});return t.jsxs(t.Fragment,{children:[t.jsxs(Bo,{ref:P,children:[t.jsxs(Ao,{onClick:()=>g(!u),children:[t.jsx(zo,{children:m||n}),t.jsx(Fo,{$isOpen:u,children:"▼"})]}),u&&t.jsxs(_o,{children:[s.map(B=>t.jsxs(Oo,{onClick:()=>I(B),$isSelected:e===B.value,children:[t.jsx(No,{$isSelected:e===B.value,children:e===B.value&&t.jsx(Yo,{})}),t.jsx(Wo,{children:B.label})]},B.id)),i&&t.jsx(Ho,{onClick:L,children:"Другой период"})]})]}),k&&t.jsx("div",{ref:j,children:t.jsx(Te,{title:"",onClose:()=>f(!1),onCancel:()=>f(!1),onSave:B=>{B.preventDefault(),A()},saveButtonText:"Выбрать",customLayout:t.jsx(Y,{}),children:t.jsxs(Vo,{children:[t.jsx(je,{children:t.jsx(re,{value:y,onChange:B=>d(B)})}),t.jsx(je,{children:t.jsx(re,{value:h,onChange:B=>l(B)})})]})})})]})},Bo=o.div`
  position: relative;
  width: 245px;
`,Ao=o.div`
  display: flex;
...
`,Xo=({name:e,value:n,onChange:s,onBlur:i,onKeyPress:r,placeholder:c="8 (999) 500-50-50",customPlaceholder:u,tabIndex:g,disabled:k=!1,hasError:f=!1,errorMessage:m})=>{const[x,y]=w.useState(!1),d=w.useRef(null),h=!!(u&&!n&&!x),l=L=>{const A=L.replace(/\D/g,"").slice(0,11);let R="";return A.length>0&&(R+="8"),A.length>1&&(R+=` (${A.slice(1,4)}`),A.length>4&&(R+=`) ${A.slice(4,7)}`),A.length>7&&(R+=`-${A.slice(7,9)}`),A.length>9&&(R+=`-${A.slice(9,11)}`),R},P=L=>{const F=l(L.target.value),A={...L,target:{...L.target,name:e,value:F}};s(A)},j=L=>{y(!1),i?.(L)},I=L=>{r?.(L)};return t.jsxs(qo,{children:[t.jsx(Go,{ref:d,name:e,type:"tel",value:n,onChange:P,onKeyPress:I,placeholder:h?"":c,maxLength:18,tabIndex:g,disabled:k,hasError:f,onFocus:()=>y(!0),onBlur:j,inputMode:"tel"}),u&&t.jsx(Jo,{isVisible:h,children:u}),f&&m&&t.jsx(Ko,{children:m})]})},qo=o.div`
  position: relative;
  display: inline-block;
  width: 100%;
  margin-right: auto;
...
`,Dn=({percentage:e,onChange:n,draggable:s=!1,colors:i={primary:"rgba(0, 125, 136, 1)",secondary:"rgba(37, 203, 161, 1)"}})=>{const r=w.useRef(null),[c,u]=w.useState(!1),g=x=>{!s||!n||(x.preventDefault(),u(!0),m(x))},k=x=>{!c||!n||m(x)},f=()=>{u(!1)},m=x=>{if(!r.current||!n)return;const y=r.current.getBoundingClientRect();let h=(x.clientX-y.left)/y.width*100;h=Math.max(0,Math.min(100,h)),n(Math.round(h))};return w.useEffect(()=>{if(c)return document.addEventListener("mousemove",k),document.addEventListener("mouseup",f),()=>{document.removeEventListener("mousemove",k),document.removeEventListener("mouseup",f)}},[c]),t.jsxs(Tn,{ref:r,$draggable:s,onMouseDown:g,children:[t.jsx(Ln,{$secondaryColor:i.secondary}),t.jsx(En,{$percentage:e,$primaryColor:i.primary}),s&&t.jsx(Pn,{$percentage:e,$primaryColor:i.primary})]})},Tn=o.div`
  width: 100%;
  height: 10px;
  position: relative;
  border-radius: 5px;
...
`,In=["zoomControl","fullscreenControl"];let ne=null;const Rn=e=>typeof window>"u"?Promise.reject(new Error("Window is not available")):window.ymaps?Promise.resolve(window.ymaps):(ne||(ne=new Promise((n,s)=>{const i=document.createElement("script"),r=e?`&apikey=${e}`:"";i.src=`https://api-maps.yandex.ru/2.1/?lang=ru_RU${r}`,i.async=!0,i.onload=()=>{window.ymaps?window.ymaps.ready(()=>n(window.ymaps)):s(new Error("Yandex Maps failed to load"))},i.onerror=()=>s(new Error("Failed to load Yandex Maps script")),document.head.appendChild(i)})),ne),Bn=({onLocationSelect:e,initialAddress:n="",initialLat:s=55.751244,initialLon:i=37.618423,apiKey:r,zoom:c=12,height:u=400,width:g="100%",inputPlaceholder:k="Введите адрес или название места",searchButtonLabel:f="Найти",draggablePlacemark:m=!0,controls:x=In,showSearch:y=!0,className:d,style:h,onError:l})=>{const[P,j]=w.useState(null),[I,L]=w.useState(n),[F,A]=w.useState(n),[R,Y]=w.useState(!1),B=w.useRef(null);w.useEffect(()=>{let _=!1,v;return(async()=>{try{const M=await Rn(r);if(_||!B.current)return;v=new M.Map(B.current,{center:[s,i],zoom:c,controls:x});const T=new M.Placemark([s,i],{},{draggable:m});v.geoObjects.add(T),v.events.add("click",N=>{const E=N.get("coords");z(E,T,v)}),T.events.add("dragend",()=>{const N=T.geometry.getCoordinates();z(N,T,v)}),j(v),Y(!0)}catch(M){l&&M instanceof Error&&l(M)}})(),()=>{_=!0,v&&v.destroy()}},[r,s,i,c,x,m,l]);const z=async(_,v,p)=>{if(window.ymaps)try{const N=(await window.ymaps.geocode(_)).geoObjects.get(0).getAddressLine();v.geometry.setCoordinates(_),p.panTo(_,{flying:!0}),A(N),L(N),e(N,_[0],_[1])}catch(M){l&&M instanceof Error&&l(M)}},W=async()=>{if(!(!I.trim()||!window.ymaps||!P))try{const v=(await window.ymaps.geocode(I)).geoObjects.get(0);if(v){const p=v.geometry.getCoordinates(),M=v.properties.get("boundedBy");P.setBounds(M,{checkZoomRange:!0});const T=new window.ymaps.Placemark(p,{},{draggable:m});P.geoObjects.removeAll(),P.geoObjects.add(T);const N=v.getAddressLine();A(N),e(N,p[0],p[1]),T.events.add("dragend",()=>{const E=T.geometry.getCoordinates();z(E,T,P)})}}catch(_){l&&_ instanceof Error&&l(_)}};return t.jsxs(An,{className:d,style:h,children:[y&&t.jsxs(zn,{children:[t.jsx(le,{type:"text",value:I,onChange:_=>L(_.target.value),placeholder:k,onKeyPress:_=>_.key==="Enter"&&W(),disabled:!R}),t.jsx(Fn,{onClick:W,disabled:!R,children:f})]}),t.jsxs(On,{children:["Выбранный адрес: ",t.jsx("strong",{children:F||"Не выбран"})]}),t.jsx(_n,{ref:B,$height:u,$width:g}),t.jsx(Nn,{children:"📍 Кликните на карте или найдите адрес через поиск"})]})},An=o.div`
  display: flex;
  flex-direction: column;
  gap: 12px;
`,zn=o.div`
...
`,de=o.h1`
  ...
  color: black;
  font-weight: 600;
`;function ie(e,n="₽"){if(!e||e.trim()==="")return`0${n}`;const s=e.replace(/[^\d-]/g,"");if(!s||s==="-"||s==="")return`0${n}`;const i=parseInt(s,10);if(isNaN(i))return`0${n}`;const r=new Intl.NumberFormat("ru-RU",{style:"decimal",minimumFractionDigits:0,maximumFractionDigits:0}).format(i);return!0?`${r}${n}`:r}function Yn(e){if(!e)return 0;const n=e.replace(/\D/g,"");return parseInt(n,10)}const Wn=({title:e,data:n,maxValue:s,step:i,height:r=300,titleFontSize:c})=>{const[u,g]=w.useState(null),k=[];for(let m=0;m<=s;m+=i)k.push(m);const f=n.length>0?n[0].bars.map(m=>({name:m.name,color:m.color})):[];return t.jsxs(Hn,{children:[t.jsxs(ce,{style:{marginTop:"0"},children:[t.jsx(de,{style:{fontSize:c},children:e}),t.jsx(Vn,{children:f.map((m,x)=>t.jsxs(Zn,{children:[t.jsx(Un,{color:m.color}),t.jsx(Xn,{children:m.name})]},x))})]}),t.jsxs(qn,{height:r,children:[t.jsx(Gn,{children:k.map((m,x)=>t.jsx(Jn,{children:m.toLocaleString()},x))}),t.jsxs(Kn,{children:[t.jsxs(Qn,{children:[k.map((m,x)=>{const y=m/s*100;return t.jsx(er,{position:100-y},`line-${x}`)}),n.map((m,x)=>t.jsxs(tr,{onMouseEnter:()=>g(x),onMouseLeave:()=>g(null),children:[m.bars.map((y,d)=>{const h=m.bars.slice(d+1).reduce((l,P)=>l+P.value,0);return t.jsx(or,{height:y.value/s*100,offset:h/s*100,color:y.color,isHovered:u!==null&&u!==x},d)}),u===x&&t.jsxs(ir,{children:[t.jsxs(sr,{children:[t.jsxs(ar,{children:["Всего: ",ie(m.total.toString())]}),m.bars.map((y,d)=>t.jsxs(lr,{children:[y.name,": ",ie(y.value.toString())]},d))]}),t.jsx(cr,{})]})]},x))]}),t.jsx(nr,{children:n.map((m,x)=>t.jsx(rr,{style:{flex:1,textAlign:"center"},children:m.label},x))})]})]})]})},Hn=o.div`
  background-color: white;
  border-radius: 10px;
  border: 1px solid rgba(209, 213, 219, 1);
  padding: 20px;
...
`,pr=({title:e,data:n,xAxisLabel:s,yAxisLabel:i,maxX:r,maxY:c,minY:u,xStep:g,yStep:k,height:f=300,showLegend:m=!0,xAxisCustomLabels:x,showTooltip:y=!0,titleFontSize:d="30px"})=>{const[h,l]=w.useState(null),[P,j]=w.useState({x:0,y:0}),I=w.useRef(null),L=w.useRef(null),F=Math.max(...n.map(v=>v.x),r),A=[];for(let v=0;v<=F;v+=g)A.push(v);const R=[];for(let v=u;v<=c;v+=k)R.push(v);const Y=x||A.map(v=>v.toString()),B=m?Array.from(new Set(n.filter(v=>v.label).map(v=>v.label))).map(v=>{const p=n.find(M=>M.label===v);return{name:v,color:p.color}}):[],z={};n.forEach(v=>{const p=v.label||"default";z[p]||(z[p]=[]),z[p].push(v)});const W=v=>v/F*100,_=v=>{const p=c-u;return 100-(v-u)/p*100};return w.useEffect(()=>{if(h&&L.current){const v=L.current.getBoundingClientRect(),p=W(h.x)/100*v.width,M=_(h.y)/100*v.height;j({x:p+v.left,y:M+v.top})}},[h,r,c,u]),t.jsxs(ur,{children:[t.jsxs(ce,{style:{marginTop:"0"},children:[t.jsx(de,{style:{fontSize:d},children:e}),m&&B.length>0&&t.jsx(hr,{children:B.map((v,p)=>t.jsxs(xr,{children:[t.jsx(fr,{color:v.color}),t.jsx(gr,{children:v.name})]},p))})]}),t.jsxs(br,{height:f,children:[t.jsxs(mr,{children:[R.map((v,p)=>t.jsx(wr,{children:v.toLocaleString()},p)),t.jsx(Ce,{children:i})]}),t.jsxs(vr,{ref:L,children:[R.map((v,p)=>t.jsx(yr,{position:_(v)},`hline-${p}`)),Object.values(z).map((v,p)=>v.map((M,T)=>{if(T===0)return null;const N=v[T-1],E=W(N.x),V=_(N.y),b=W(M.x),C=_(M.y);return t.jsx("svg",{style:{position:"absolute",top:0,left:0,width:"100%",height:"100%",pointerEvents:"none",zIndex:1},children:t.jsx("line",{x1:`${E}%`,y1:`${V}%`,x2:`${b}%`,y2:`${C}%`,stroke:M.color,strokeWidth:"1"})},`line-${p}-${T}`)})),n.map((v,p)=>t.jsx(kr,{x:W(v.x),y:_(v.y),color:v.color,onMouseEnter:()=>l(v),onMouseLeave:()=>l(null),isHovered:h?.label===v.label},p))]})]}),y&&h&&t.jsxs($r,{ref:I,style:{left:P.x,top:P.y},children:[t.jsxs(Sr,{children:[h.name&&t.jsx(Mr,{children:h.name}),t.jsx(Dr,{children:h.y.toLocaleString()})]}),t.jsx(Tr,{})]}),t.jsxs(jr,{children:[Y.map((v,p)=>{const T=A[p]/F*100;return t.jsx(Cr,{style:{left:`${T}%`,transform:"translateX(-50%)"},children:v},p)}),s&&t.jsx(Ce,{children:s})]})]})},ur=o.div`
  background-color: white;
  border-radius: 10px;
  border: 1px solid rgba(209, 213, 219, 1);
  padding: 20px;
...
`,Pe=({isOpen:e,callPhone:n,error:s,onClose:i})=>{const[r,c]=w.useState(!1);if(!e)return null;const u=/iPhone|iPad|iPod|Android/i.test(navigator.userAgent),g=()=>{u?window.location.href=`tel:${n}`:(navigator.clipboard.writeText(n),c(!0),setTimeout(()=>c(!1),2e3))};return t.jsx(Or,{onClick:i,children:t.jsxs(Nr,{onClick:k=>k.stopPropagation(),children:[t.jsx(Yr,{children:"Подтверждение авторизации"}),t.jsx(Se,{children:"Для завершения авторизации позвоните на номер:"}),t.jsxs(Wr,{onClick:g,title:u?"Позвонить":"Копировать номер",$clickable:!0,children:[n,!u&&r&&t.jsx(Hr,{children:"Скопировано!"})]}),t.jsx(Se,{children:"После звонка система автоматически подтвердит вашу авторизацию."}),s&&t.jsx(Vr,{children:s})]})})},Or=o.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,Vr=o.div`
  color: #e74c3c;
  margin: 10px 0;
`,Ie=w.createContext({collapsed:!1,toggleCollapsed:()=>{},selectedSideMenuItem:null,setSelectedSideMenuItem:()=>{},selectedTopMenuItem:null,setSelectedTopMenuItem:()=>{}}),Zr=({items:e,bottomItems:n=[],logo:s,arrowIcon:i,collapsed:r,onToggle:c,selectedKey:u,onSelect:g,autoCollapseOnSelect:k=!1,width:f="315px",collapsedWidth:m="70px",className:x,style:y})=>{const d=w.useContext(Ie),[h,l]=w.useState(r??d.collapsed??!1),[P,j]=w.useState(null),[I,L]=w.useState(u??d.selectedSideMenuItem??null),[F,A]=w.useState({visible:!1,x:0,y:0,items:[]}),R=w.useRef(null),Y=r??d.collapsed??h,B=E=>{l(E),d.toggleCollapsed(),c?.(E)},z=u??d.selectedSideMenuItem??I,W=E=>{L(E),d.setSelectedSideMenuItem(E)};w.useEffect(()=>{r!==void 0&&(l(r),r&&j(null))},[r]),w.useEffect(()=>{u!==void 0&&W(u)},[u]),w.useEffect(()=>{const E=()=>A(V=>({...V,visible:!1}));return document.addEventListener("click",E),()=>document.removeEventListener("click",E)},[]);const _=()=>{const E=!Y;B(E),E&&j(null)},v=E=>{E.disabled||E.hidden||(W(E.key),g?.(E),E.onClick?.(E),k&&(B(!0),j(null)))},p=E=>{j(V=>V===E?null:E)},M=(E,V)=>{const b=(E.children?.length||0)>0;if(Y&&b){V.stopPropagation();const C=V.currentTarget.getBoundingClientRect();A({visible:!0,x:C.right+6,y:C.top,items:E.children||[]});return}b?p(E.key):v(E)},T=(E,V=!1)=>E.filter(b=>!b.hidden).map(b=>{const C=(b.children?.length||0)>0,a=P===b.key,$=z===b.key||!!b.children&&b.children.some(S=>S.key===z);return t.jsxs(w.Fragment,{children:[t.jsxs(Qr,{$collapsed:Y,$selected:$,onClick:S=>M(b,S),$disabled:b.disabled,title:b.label,children:[b.icon&&t.jsx(ti,{$collapsed:Y,children:b.icon}),!Y&&t.jsx(ei,{children:b.label}),!Y&&C&&t.jsx(ni,{$expanded:a,children:"▾"})]}),!Y&&C&&a&&t.jsx(oi,{children:T(b.children||[],!0)})]},b.key)}),N=w.useMemo(()=>F.visible?t.jsx(ii,{style:{left:F.x,top:F.y},children:F.items.map(E=>t.jsx(si,{onClick:()=>{v(E),A({visible:!1,x:0,y:0,items:[]})},$selected:z===E.key,children:E.label},E.key))}):null,[F,z]);return t.jsxs(Ur,{ref:R,$collapsed:Y,$width:f,$collapsedWidth:m,className:x,style:y,children:[t.jsxs(Xr,{children:[t.jsx(qr,{onClick:_,"aria-label":"Переключить меню",children:i??t.jsx(Gr,{$collapsed:Y,children:"❮"})}),!Y&&s&&t.jsx(Jr,{children:s})]}),t.jsxs(Kr,{children:[t.jsx(Me,{children:T(e)}),n.length>0&&t.jsxs(t.Fragment,{children:[t.jsx(ri,{}),t.jsx(Me,{children:T(n)})]})]}),N,t.jsx(ai,{$collapsed:Y})]})},Ur=o.div`
