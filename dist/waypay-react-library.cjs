"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const x=require("react"),n=require("styled-components"),X=require("framer-motion");var te={exports:{}},K={};var xe;function Ue(){if(xe)return K;xe=1;var e=Symbol.for("react.transitional.element"),o=Symbol.for("react.fragment");function r(i,a,c){var d=null;if(c!==void 0&&(d=""+c),a.key!==void 0&&(d=""+a.key),"key"in a){c={};for(var g in a)g!=="key"&&(c[g]=a[g])}else c=a;return a=c.ref,{$$typeof:e,type:i,key:d,ref:a!==void 0?a:null,props:c}}return K.Fragment=o,K.jsx=r,K.jsxs=r,K}var Q={};var he;function Ze(){return he||(he=1,process.env.NODE_ENV!=="production"&&(function(){function e(u){if(u==null)return null;if(typeof u=="function")return u.$$typeof===O?null:u.displayName||u.name||null;if(typeof u=="string")return u;switch(u){case S:return"Fragment";case P:return"Profiler";case C:return"StrictMode";case R:return"Suspense";case Y:return"SuspenseList";case N:return"Activity"}if(typeof u=="object")switch(typeof u.tag=="number"&&console.error("Received an unexpected object in getComponentNameFromType(). This is likely a bug in React. Please file an issue."),u.$$typeof){case l:return"Portal";case E:return u.displayName||"Context";case I:return(u._context.displayName||"Context")+".Consumer";case T:var D=u.render;return u=u.displayName,u||(u=D.displayName||D.name||"",u=u!==""?"ForwardRef("+u+")":"ForwardRef"),u;case A:return D=u.displayName||null,D!==null?D:e(u.type)||"Memo";case _:D=u._payload,u=u._init;try{return e(u(D))}catch{}}return null}function o(u){return""+u}function r(u){try{o(u);var D=!1}catch{D=!0}if(D){D=console;var F=D.error,j=typeof Symbol=="function"&&Symbol.toStringTag&&u[Symbol.toStringTag]||u.constructor.name||"Object";return F.call(D,"The provided key is an unsupported type %s. This value must be coerced to a string before using it here.",j),o(u)}}function i(u){if(u===S)return"<>";if(typeof u=="object"&&u!==null&&u.$$typeof===_)return"<...>";try{var D=e(u);return D?"<"+D+">":"<...>"}catch{return"<...>"}}function a(){var u=v.A;return u===null?null:u.getOwner()}function c(){return Error("react-stack-top-frame")}function d(u){if(s.call(u,"key")){var D=Object.getOwnPropertyDescriptor(u,"key").get;if(D&&D.isReactWarning)return!1}return u.key!==void 0}function g(u,D){function F(){H||(H=!0,console.error("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://react.dev/link/special-props)",D))}F.isReactWarning=!0,Object.defineProperty(u,"key",{get:F,configurable:!0})}function y(){var u=e(this.type);return V[u]||(V[u]=!0,console.error("Accessing element.ref was removed in React 19. ref is now a regular prop. It will be removed from the JSX Element type in a future release.")),u=this.props.ref,u!==void 0?u:null}function w(u,D,F,j,B,z){var W=F.ref;return u={$$typeof:p,type:u,key:D,props:F,_owner:j},(W!==void 0?W:null)!==null?Object.defineProperty(u,"ref",{enumerable:!1,get:y}):Object.defineProperty(u,"ref",{enumerable:!1,value:null}),u._store={},Object.defineProperty(u._store,"validated",{configurable:!1,enumerable:!1,writable:!0,value:0}),Object.defineProperty(u,"_debugInfo",{configurable:!1,enumerable:!1,writable:!0,value:null}),Object.defineProperty(u,"_debugStack",{configurable:!1,enumerable:!1,writable:!0,value:B}),Object.defineProperty(u,"_debugTask",{configurable:!1,enumerable:!1,writable:!0,value:z}),Object.freeze&&(Object.freeze(u.props),Object.freeze(u)),u}function b(u,D,F,j,B,z){var W=D.children;if(W!==void 0)if(j)if($(W)){for(j=0;j<W.length;j++)f(W[j]);Object.freeze&&Object.freeze(W)}else console.error("React.jsx: Static children should always be an array. You are likely explicitly calling React.jsxs or React.jsxDEV. Use the Babel transform instead.");else f(W);if(s.call(D,"key")){W=e(u);var Z=Object.keys(D).filter(function(J){return J!=="key"});j=0<Z.length?"{key: someKey, "+Z.join(": ..., ")+": ...}":"{key: someKey}",L[W+j]||(Z=0<Z.length?"{"+Z.join(": ..., ")+": ...}":"{}",console.error(`A props object containing a "key" prop is being spread into JSX:
  let props = %s;
  <%s {...props} />
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`,j,W,Z,W),L[W+j]=!0)}if(W=null,F!==void 0&&(r(F),W=""+F),d(D)&&(r(D.key),W=""+D.key),"key"in D){F={};for(var G in D)G!=="key"&&(F[G]=D[G])}else F=D;return W&&g(F,typeof u=="function"?u.displayName||u.name||"Unknown":u),w(u,W,F,a(),B,z)}function f(u){k(u)?u._store&&(u._store.validated=1):typeof u=="object"&&u!==null&&u.$$typeof===_&&(u._payload.status==="fulfilled"?k(u._payload.value)&&u._payload.value._store&&(u._payload.value._store.validated=1):u._store&&(u._store.validated=1))}function k(u){return typeof u=="object"&&u!==null&&u.$$typeof===p}var h=x,p=Symbol.for("react.transitional.element"),l=Symbol.for("react.portal"),S=Symbol.for("react.fragment"),C=Symbol.for("react.strict_mode"),P=Symbol.for("react.profiler"),I=Symbol.for("react.consumer"),E=Symbol.for("react.context"),T=Symbol.for("react.forward_ref"),R=Symbol.for("react.suspense"),Y=Symbol.for("react.suspense_list"),A=Symbol.for("react.memo"),_=Symbol.for("react.lazy"),N=Symbol.for("react.activity"),O=Symbol.for("react.client.reference"),v=h.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,s=Object.prototype.hasOwnProperty,$=Array.isArray,m=console.createTask?console.createTask:function(){return null};h={react_stack_bottom_frame:function(u){return u()}};var H,V={},U=h.react_stack_bottom_frame.bind(h,c)(),M=m(i(c)),L={};Q.Fragment=S,Q.jsx=function(u,D,F){var j=1e4>v.recentlyCreatedOwnerStacks++;return b(u,D,F,!1,j?Error("react-stack-top-frame"):U,j?m(i(u)):M)},Q.jsxs=function(u,D,F){var j=1e4>v.recentlyCreatedOwnerStacks++;return b(u,D,F,!0,j?Error("react-stack-top-frame"):U,j?m(i(u)):M)}})()),Q}var fe;function qe(){return fe||(fe=1,process.env.NODE_ENV==="production"?te.exports=Ue():te.exports=Ze()),te.exports}var t=qe();const le=({x:e,y:o,items:r,onClose:i,...a})=>{const c=x.useRef(null),[d,g]=x.useState(null);x.useEffect(()=>{const h=p=>{c.current&&!c.current.contains(p.target)&&i()};return document.addEventListener("mousedown",h),()=>{document.removeEventListener("mousedown",h)}},[i]);const w=(()=>{if(!c.current)return{x:e,y:o};const h=c.current.offsetWidth,p=c.current.offsetHeight,l=window.innerWidth,S=window.innerHeight;let C=e,P=o;return C+h>l&&(C=e-h),P+p>S&&(P=o-p),{x:C,y:P}})(),b=(h,p)=>{h.submenu?g(d===p?null:p):h.action&&(h.action(),i())},f=h=>{r[h].submenu&&g(h)},k=h=>{const p=h.relatedTarget;c.current?.contains(p)||g(null)};return t.jsx(Xe,{ref:c,initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.8},transition:{duration:.15},style:{position:"absolute",top:w.y,left:w.x},onClick:h=>h.stopPropagation(),onMouseLeave:k,...a,children:r.map((h,p)=>t.jsxs(Ge,{$hasSubmenu:!!h.submenu,$disabled:h.disabled,children:[t.jsx(Je,{onClick:l=>{l.stopPropagation(),h.disabled||b(h,p)},onMouseEnter:()=>!h.disabled&&f(p),whileHover:h.disabled?{}:{backgroundColor:"#f3f4f6"},initial:{backgroundColor:"#ffffff"},$color:h.color,$disabled:h.disabled,children:t.jsxs(Ke,{children:[h.label,h.submenu&&t.jsx(Qe,{children:t.jsx("svg",{width:"8",height:"12",viewBox:"0 0 8 12",fill:"none",children:t.jsx("path",{d:"M1.5 1.5L6 6L1.5 10.5",stroke:"currentColor",strokeWidth:"2"})})})]})}),h.submenu&&d===p&&t.jsx(et,{initial:{opacity:0,x:10},animate:{opacity:1,x:0},exit:{opacity:0,x:10},transition:{duration:.15},children:t.jsx(le,{x:0,y:-p*40,items:h.submenu,onClose:()=>g(null)})})]},p))})},Xe=n(X.motion.div)`
  position: absolute;
  background: white;
  border-radius: 8px;
...
`,et=n(X.motion.div)`
  ...
  z-index: 1001;
  margin-left: 2px;
`,tt=({columns:e,data:o,onRowDoubleClick:r,contextMenuActions:i=[],onSort:a,sortConfig:c,onRowClick:d,selectedRow:g,fixedHeight:y,hasTotalsRow:w,debtChecker:b,rowStyles:f={},isLoading:k})=>{const[h,p]=x.useState(null),[l,S]=x.useState(null),C=x.useRef(null),P=x.useRef(null),I=500,E=g!==void 0?g:h,T=M=>{!e[M].isSortable||!a||a(M)},Y=b||(M=>{const L=M[8];return typeof L=="string"?parseFloat(L.replace(/[^\d.]/g,""))>0:!1}),A=M=>{g===void 0&&p(M===E?null:M),d&&d(o[M],M)},_=(M,L)=>{r&&r(M,L)},N=(M,L)=>{if(i.length===0)return;M.preventDefault();const u="touches"in M?M.touches[0].clientX:M.clientX,D="touches"in M?M.touches[0].clientY:M.clientY;S({x:u,y:D,rowIndex:L})},O=(M,L)=>{M.preventDefault(),N(M,L)},v=(M,L)=>{i.length!==0&&(P.current&&clearTimeout(P.current),P.current=window.setTimeout(()=>{N(M,L)},I))},s=()=>{P.current&&(clearTimeout(P.current),P.current=null)},$=()=>{P.current&&window.clearTimeout(P.current)},m=()=>{S(null)};x.useEffect(()=>{const M=()=>{l&&m()};return document.addEventListener("click",M),()=>{document.removeEventListener("click",M),P.current&&clearTimeout(P.current)}},[l]);const H=(M,L,u)=>{if(L)return{backgroundColor:"#FFFFFF",color:"#000000",fontWeight:"bold"};const D=f[M]||{};return M===E?{backgroundColor:D.backgroundColor||"#007D88",color:D.color||"#FFFFFF",fontWeight:D.fontWeight||"normal"}:u?{backgroundColor:D.backgroundColor||"#E8D8D8",color:D.color||"inherit",fontWeight:D.fontWeight||"normal"}:o[M][o[M].length-1]===!1?{backgroundColor:D.backgroundColor||"#E8F5E8",color:"#1B5E20",fontWeight:D.fontWeight||"normal"}:{backgroundColor:D.backgroundColor||"#FFFFFF",color:D.color||"inherit",fontWeight:D.fontWeight||"normal"}},V=(M,L,u)=>{if(L)return"#FFFFFF";const D=H(M,L,u);return D.hoverBackgroundColor?D.hoverBackgroundColor:M===E?"#007D88":u?"#E8D8D8CC":o[M][o[M].length-1]===!1?"#51D5B4CC":"#F3F4F6"},U=()=>{if(!l||i.length===0)return null;const M=(typeof i=="function"?i(o[l.rowIndex]):i).filter(L=>typeof L=="object"&&(typeof L.shouldShow!="function"||L.shouldShow(o[l.rowIndex])));return M.length===0?null:t.jsx(st,{initial:{opacity:0,scale:.95},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.95},transition:{duration:.15},style:{position:"fixed",left:l.x,top:l.y,zIndex:1e3},onClick:L=>L.stopPropagation(),children:t.jsx(le,{items:M.map(L=>{const u={label:L.label,color:L.color,disabled:L.disabled};return L.getSubmenu?u.submenu=L.getSubmenu(o[l.rowIndex]):L.action&&(u.action=()=>{L.action(o[l.rowIndex],l.rowIndex),m()}),u}),onClose:m,x:0,y:0})})};return t.jsx(rt,{ref:C,children:k?t.jsx(nt,{children:t.jsx(ot,{})}):t.jsxs(t.Fragment,{children:[t.jsxs(it,{children:[t.jsx(at,{children:t.jsx(ge,{children:e.map((M,L)=>!M.isHidden&&t.jsx(ct,{$isSortable:M.isSortable,$isActive:c?.key===L,onClick:()=>T(L),$align:M.align||"center",$isFirst:L===0,$isLast:L===e.length-1,children:t.jsxs(dt,{$align:M.align||"center",children:[M.name,M.isSortable&&t.jsx(ut,{$direction:c?.key===L?c.direction:"asc",animate:{rotate:c?.key===L&&c.direction==="desc"?180:0,color:c?.key===L?"#007D88":"#6B7280"},transition:{duration:.2},children:t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:t.jsx("path",{d:"M5.77734 2.92383L5.25 3.45117L3.26953 1.47656L3.26367 12H2.51367L2.51953 1.45898L0.527344 3.45117L0 2.92383L2.88867 0.0351562L5.77734 2.92383ZM10.5059 8.54883L11.0391 9.07617L8.15039 11.9648L5.25586 9.07617L5.78906 8.54883L7.76953 10.5293L7.76367 0H8.51367L8.51953 10.5352L10.5059 8.54883Z",fill:"currentColor"})})})]})},L))})}),t.jsx(lt,{$fixedHeight:y,children:t.jsx(X.AnimatePresence,{children:o.map((M,L)=>{const u=!!(w&&L===o.length-1),D=!!(!u&&Y(M)),F=H(L,u,D),j=V(L,u,D);return t.jsx(ge,{initial:{opacity:0,y:-10},animate:{opacity:1,y:0,backgroundColor:F.backgroundColor||"#FFFFFF",color:F.color||"inherit",fontWeight:F.fontWeight||"normal"},exit:{opacity:0,y:10},transition:{duration:.2,ease:"easeOut"},$isLast:L===o.length-1,$isSelected:L===E,$isTotalsRow:u,onClick:()=>!u&&A(L),onDoubleClick:()=>!u&&_(M,L),onContextMenu:B=>!u&&O(B,L),onTouchStart:B=>!u&&v(B,L),onTouchEnd:s,onTouchMove:$,whileHover:u?{}:{backgroundColor:j,transition:{duration:.15}},style:{backgroundColor:F.backgroundColor||"#FFFFFF",color:F.color||"inherit",fontWeight:F.fontWeight||"normal"},children:M.map((B,z)=>!e[z]?.isHidden&&t.jsx(pt,{$align:e[z]?.align||"center",$isFirst:z===0,$isLast:z===M.length-1,$isTotalsCell:u,$isBeforeTotals:u&&z<M.findIndex(W=>W==="Итого:"),children:B},z))},`row-${L}`)})})})]}),t.jsx(X.AnimatePresence,{children:U()})]})})},nt=n.div`
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
...
`,It=({placeholder:e="",customPlaceholder:o,value:r,onChange:i,hasError:a=!1,errorMessage:c,options:d,name:g,disabled:y=!1,required:w=!1,...b})=>{const[f,k]=x.useState(!1),[h,p]=x.useState(!1),l=x.useRef(null),S=!!(o&&!r&&!f),C=R=>{i&&!y&&i({target:{value:R,name:g}}),p(!1),k(!1)},P=R=>{l.current&&!l.current.contains(R.target)&&(p(!1),k(!1))},I=()=>{y||(p(!h),k(!h))};x.useEffect(()=>(document.addEventListener("mousedown",P),()=>{document.removeEventListener("mousedown",P)}),[]);const E=d.find(R=>R.value===r),T=E?E.label:"";return t.jsxs(Pt,{ref:l,...b,children:[t.jsxs(Rt,{children:[t.jsxs(zt,{hasError:a,isOpen:h,disabled:y,onClick:I,onFocus:()=>!y&&k(!0),onBlur:()=>k(!1),tabIndex:y?-1:0,children:[t.jsx(Bt,{children:T||e&&t.jsx(At,{children:e})}),t.jsx(Ft,{isOpen:h,disabled:y,children:t.jsx("svg",{width:"17",height:"9",viewBox:"0 0 17 9",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:t.jsx("path",{d:"M1.5 1L8.5 8L15.5 1",stroke:y?"#CCCCCC":"#50555C",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})})})]}),h&&t.jsx(_t,{children:d.map(R=>t.jsxs(Ot,{$isSelected:R.value===r,onClick:()=>C(R.value),children:[t.jsx(Wt,{$isSelected:R.value===r,children:R.value===r&&t.jsx(Nt,{})}),t.jsx(Ht,{children:R.label})]},R.value))})]}),o&&t.jsx(Yt,{isVisible:S,children:o}),a&&c&&t.jsx(Vt,{children:c}),t.jsx(Ut,{name:g,value:r||"",onChange:()=>{},tabIndex:-1,required:w,children:d.map(R=>t.jsx("option",{value:R.value,children:R.label},R.value))})]})},Pt=n.div`
  position: relative;
...
`,Ut=n.select`
  ...
  width: 0;
  pointer-events: none;
`,Zt=({checked:e=!1,onChange:o,className:r,label:i,disabled:a=!1})=>{const[c,d]=x.useState(!1),g=()=>{a||!o||o(!e)},y=w=>{a||(w.key==="Enter"||w.key===" ")&&(w.preventDefault(),g())};return t.jsxs(qt,{className:r,onClick:g,onKeyPress:y,tabIndex:a?-1:0,disabled:a,children:[t.jsx(Xt,{checked:e,isFocused:c,disabled:a,onMouseEnter:()=>!a&&d(!0),onMouseLeave:()=>!a&&d(!1),onFocus:()=>!a&&d(!0),onBlur:()=>!a&&d(!1),children:e&&t.jsx(Jt,{viewBox:"0 0 8 8",fill:"none",xmlns:"http://www.w3.org/2000/svg",disabled:a,children:t.jsx("path",{d:"M7.375 1.1875L2.65 6.8125L0.625 4.5625",stroke:a?"rgba(173, 179, 188, 1)":"white",strokeLinecap:"round",strokeLinejoin:"round"})})}),i&&t.jsx(Gt,{disabled:a,children:i})]})},qt=n.div`
  display: flex;
  align-items: center;
...
`,wn=n.div`
  ...
  max-width: 425px;
  margin-top: 10px;
`,de=({placeholder:e="",customPlaceholder:o,value:r,inputType:i="text",onChange:a,hasError:c=!1,errorMessage:d,...g})=>{const[y,w]=x.useState(!1),b=!!(o&&!r&&!y),f=p=>{if(!a)return;let l=p.target.value;switch(i){case"number":/^\d*$/.test(l)&&a?.(p);break;case"rubles":{const C=p.target.selectionStart,P=p.target.value;let I=P.replace(/[^\d]/g,"");if(I===""){p.target.value="",a(p);break}const E=parseInt(I,10);if(!isNaN(E)){let T=E.toLocaleString("ru-RU");T+=" ₽";const R=k(P,C||0),Y=h(T,R);p.target.value=T,a(p),setTimeout(()=>{p.target.setSelectionRange(Y,Y)},0)}break}case"percents":{l=l.replace(/[^\d.]/g,"");const C=l.split(".");C.length>2&&(l=C[0]+"."+C.slice(1).join("")),C.length===2&&C[1].length>2&&(l=C[0]+"."+C[1].slice(0,2));const P=parseFloat(l);if(isNaN(P)||(P>100?l="100":P<0&&(l="0")),l&&l!==""){l+=" %";const I=p.target.selectionStart||0,E=l.replace(" %","");p.target.value=l,a(p),setTimeout(()=>{I<E.length&&p.target.setSelectionRange(I,I)},0)}else p.target.value=l,a(p);break}case"fullname":l=l.replace(/[^a-zA-Zа-яА-ЯёЁ'\-\s]/g,""),l=l.replace(/\s{2,}/g," "),l=l.replace(/- /g,"-"),l=l.replace(/ -/g," ");let S=l.split(" ").filter(C=>C.length>0);S=S.slice(0,3),l=S.map(C=>{if(C.startsWith("-")&&(C=C.substring(1)),(C.match(/-/g)||[]).length>1){const I=C.split("-");C=I[0]+"-"+I.slice(1).join("")}return C.includes("-")?C.split("-").map((I,E)=>I.length===0?"":(E>0,I[0].toUpperCase()+I.slice(1).toLowerCase())).join("-"):C.length>0?C[0].toUpperCase()+C.slice(1).toLowerCase():""}).join(" "),l.length>0&&l[l.length-1]!==" "&&p.target.value.length>0&&p.target.value[p.target.value.length-1]===" "&&(l+=" "),l.length>100&&(l=l.slice(0,100)),p.target.value=l,a(p);break;case"doc":l=l.replace(/\D/g,""),l.length>4&&(l=`${l.slice(0,4)} ${l.slice(4,10)}`),l.length>11&&(l=l.slice(0,11)),p.target.value=l,a(p);break;case"date":{l=l.replace(/\D/g,""),l.length>4?l=`${l.slice(0,2)}.${l.slice(2,4)}.${l.slice(4,8)}`:l.length>2&&(l=`${l.slice(0,2)}.${l.slice(2,4)}`),l.length>10&&(l=l.slice(0,10)),r?.length>l.length&&[3,6].includes(l.length)&&(l=l.slice(0,l.length-1)),p.target.value=l,a(p);break}default:a(p);break}},k=(p,l)=>{let S=0;for(let C=0;C<Math.min(l,p.length);C++)/\d/.test(p[C])&&S++;return S},h=(p,l)=>{let S=0;for(let C=0;C<p.length;C++){if(S>=l)return C;/\d/.test(p[C])&&S++}return p.length};return t.jsxs(vn,{children:[t.jsx(yn,{...g,value:r,placeholder:b?"":e,onFocus:()=>w(!0),onBlur:p=>{w(!1),g.onBlur?.(p)},onChange:f,inputMode:i==="number"||i==="doc"||i==="date"||i==="rubles"||i==="percents"?"numeric":"text",maxLength:i==="doc"?11:i==="date"?10:void 0,hasError:c}),o&&t.jsx(kn,{isVisible:b,children:o}),c&&d&&t.jsx(jn,{children:d})]})},vn=n.div`
  position: relative;
  display: inline-block;
  width: 100%;
  margin-right: auto;
...
`,Sn=({placeholder:e="",customPlaceholder:o,value:r,onChange:i,hasError:a=!1,errorMessage:c,rows:d=3,...g})=>{const[y,w]=x.useState(!1),b=!!(o&&!r&&!y);return t.jsxs(Mn,{children:[t.jsx(En,{...g,value:r,placeholder:b?"":e,onFocus:()=>w(!0),onBlur:f=>{w(!1),g.onBlur?.(f)},onChange:i,hasError:a,rows:d}),o&&t.jsx(Dn,{isVisible:b,children:o}),a&&c&&t.jsx(Ln,{children:c})]})},Mn=n.div`
  position: relative;
  display: inline-block;
  width: 100%;
  margin-right: auto;
...
`,Ln=n.span`
  ...
  margin-top: 4px;
  display: block;
`,Re=({title:e,onClose:o,onCancel:r,onSave:i,children:a,isSaveDisabled:c=!1,isSubmitting:d=!1,mode:g="create",hideSaveButton:y=!1,hideCanselButton:w=!1,width:b="560px",saveButtonText:f="Сохранить",customLayout:k})=>{const h=g==="view",p=x.useRef(null);x.useEffect(()=>{const C=I=>{I.key==="Escape"&&o()};document.addEventListener("keydown",C);const P=document.body.style.overflow;return document.body.style.overflow="hidden",setTimeout(()=>p.current?.focus(),0),()=>{document.removeEventListener("keydown",C),document.body.style.overflow=P}},[o]);const l=C=>{C.target===C.currentTarget&&o()},S=C=>{C.preventDefault(),r()};return t.jsx(Tn,{onMouseDown:l,role:"presentation",children:t.jsxs(In,{ref:p,$width:b,role:"dialog","aria-modal":"true","aria-label":e||"Диалог",tabIndex:-1,children:[t.jsxs(ze,{children:[t.jsx(Be,{children:e}),t.jsx(Pn,{type:"button",onClick:o,"aria-label":"Закрыть",children:t.jsx("span",{"aria-hidden":!0,children:"×"})})]}),k?t.jsx(Rn,{children:k}):null,t.jsxs(zn,{onSubmit:i,children:[t.jsx(Bn,{children:a}),t.jsxs(An,{children:[t.jsx(Fn,{children:w?null:t.jsx(On,{isPrimary:!1,onClick:S,children:"Отменить"})}),t.jsx(_n,{children:!h&&!y?t.jsx(Wn,{type:"submit",disabled:c||d,children:d?"Сохранение...":f}):null})]})]})]})})},Tn=n.div`
  position: fixed;
  inset: 0;
...
`,Wn=n(oe)`
  ...
  border-radius: 10px;
  font-size: 16px;
`,Nn=[{id:"Last7Days",label:"За последние 7 дней",value:"Last7Days"},{id:"ThisMonth",label:"За этот месяц",value:"ThisMonth"},{id:"Last31Days",label:"За последние 31 день",value:"Last31Days"},{id:"PreviousMonth",label:"За прошлый месяц",value:"PreviousMonth"},{id:"ThisYear",label:"За этот год",value:"ThisYear"},{id:"PreviousYear",label:"За прошлый год",value:"PreviousYear"}],Hn=({value:e="",placeholder:o="Выберите период",options:r=Nn,showCustomPeriodButton:i=!0,onChange:a,onCustomPeriodClick:c})=>{const[d,g]=x.useState(!1),[y,w]=x.useState(!1),[b,f]=x.useState(""),[k,h]=x.useState(""),[p,l]=x.useState(""),S=x.useRef(null),C=x.useRef(null);x.useEffect(()=>{if(e==="Custom"&&k&&p){const A=R(k),_=R(p);f(`С ${A} по ${_}`)}else{const A=r.find(_=>_.value===e);f(A?A.label:"")}},[e,r,k,p]),x.useEffect(()=>{const A=_=>{S.current&&!S.current.contains(_.target)&&g(!1),y&&C.current&&!C.current.contains(_.target)&&([...document.querySelectorAll(".calendar-container, .arrow-button")].some(v=>v.contains(_.target))||w(!1))};return document.addEventListener("mousedown",A),()=>{document.removeEventListener("mousedown",A)}},[y]);const P=A=>{a?.(A.value),g(!1)},I=()=>{g(!1),c?c():w(!0)},E=()=>{a?.(""),f(""),h(""),l("")},T=()=>{if(k&&p){const A=R(k),_=R(p),N=`С ${A} по ${_}`;a?.("Custom",k,p),f(N),w(!1)}},R=A=>{const _=new Date(A),N=String(_.getDate()).padStart(2,"0"),O=String(_.getMonth()+1).padStart(2,"0"),v=_.getFullYear();return`${N}.${O}.${v}`},Y=()=>t.jsxs(to,{children:[t.jsx(ze,{style:{margin:0},children:t.jsx(Be,{style:{margin:0},children:"Выбор периода"})}),t.jsx(no,{onClick:E,children:"Очистить период"})]});return t.jsxs(t.Fragment,{children:[t.jsxs(Yn,{ref:S,children:[t.jsxs(Vn,{onClick:()=>g(!d),children:[t.jsx(Un,{children:b||o}),t.jsx(Zn,{$isOpen:d,children:"▼"})]}),d&&t.jsxs(qn,{children:[r.map(A=>t.jsxs(Xn,{onClick:()=>P(A),$isSelected:e===A.value,children:[t.jsx(Gn,{$isSelected:e===A.value,children:e===A.value&&t.jsx(Jn,{})}),t.jsx(Kn,{children:A.label})]},A.id)),i&&t.jsx(Qn,{onClick:I,children:"Другой период"})]})]}),y&&t.jsx("div",{ref:C,children:t.jsx(Re,{title:"",onClose:()=>w(!1),onCancel:()=>w(!1),onSave:A=>{A.preventDefault(),T()},saveButtonText:"Выбрать",customLayout:t.jsx(Y,{}),children:t.jsxs(eo,{children:[t.jsx($e,{children:t.jsx(se,{value:k,onChange:A=>h(A)})}),t.jsx($e,{children:t.jsx(se,{value:p,onChange:A=>l(A)})})]})})})]})},Yn=n.div`
  position: relative;
  width: 245px;
`,Vn=n.div`
  display: flex;
...
`,oo=({name:e,value:o,onChange:r,onBlur:i,onKeyPress:a,placeholder:c="8 (999) 500-50-50",customPlaceholder:d,tabIndex:g,disabled:y=!1,hasError:w=!1,errorMessage:b})=>{const[f,k]=x.useState(!1),h=x.useRef(null),p=!!(d&&!o&&!f),l=I=>{const T=I.replace(/\D/g,"").slice(0,11);let R="";return T.length>0&&(R+="8"),T.length>1&&(R+=` (${T.slice(1,4)}`),T.length>4&&(R+=`) ${T.slice(4,7)}`),T.length>7&&(R+=`-${T.slice(7,9)}`),T.length>9&&(R+=`-${T.slice(9,11)}`),R},S=I=>{const E=l(I.target.value),T={...I,target:{...I.target,name:e,value:E}};r(T)},C=I=>{k(!1),i?.(I)},P=I=>{a?.(I)};return t.jsxs(ro,{children:[t.jsx(io,{ref:h,name:e,type:"tel",value:o,onChange:S,onKeyPress:P,placeholder:p?"":c,maxLength:18,tabIndex:g,disabled:y,hasError:w,onFocus:()=>k(!0),onBlur:C,inputMode:"tel"}),d&&t.jsx(so,{isVisible:p,children:d}),w&&b&&t.jsx(ao,{children:b})]})},ro=n.div`
  position: relative;
  display: inline-block;
  width: 100%;
  margin-right: auto;
...
`,fo=n.div`
  margin-top: 20px;
`,go=({mode:e,primaryValue:o,secondaryValue:r,placeholder:i="Выберите значение",onSelect:a,onClear:c,disabled:d=!1,hasError:g=!1,errorMessage:y="",customIcon:w})=>{const f=w||t.jsx("svg",{width:"27",height:"6",viewBox:"0 0 27 6",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:t.jsx("path",{d:"M2.915 0C1.31175 0 0 1.31175 0 2.915C0 4.51825 1.31175 5.83 2.915 5.83C4.51825 5.83 5.83 4.51825 5.83 2.915C5.83 1.31175 4.51825 0 2.915 0ZM23.32 0C21.7167 0 20.405 1.31175 20.405 2.915C20.405 4.51825 21.7167 5.83 23.32 5.83C24.9233 5.83 26.235 4.51825 26.235 2.915C26.235 1.31175 24.9233 0 23.32 0ZM13.1175 0C11.5142 0 10.2025 1.31175 10.2025 2.915C10.2025 4.51825 11.5142 5.83 13.1175 5.83C14.7207 5.83 16.0325 4.51825 16.0325 2.915C16.0325 1.31175 14.7207 0 13.1175 0Z",fill:"#50555C"})});return e==="view"?t.jsxs(vo,{children:[t.jsx(yo,{children:o||"Не указано"}),r&&t.jsx(ko,{children:r})]}):t.jsxs(bo,{children:[t.jsxs(mo,{children:[t.jsx(wo,{type:"text",value:o||"",placeholder:i,readOnly:!0,disabled:d}),o&&!d&&t.jsx(Co,{type:"button",onClick:c,"aria-label":"Очистить",children:"×"})]}),!d&&t.jsx(jo,{type:"button",onClick:a,"aria-label":"Выбрать",children:f}),g&&y&&t.jsx($o,{children:y})]})},bo=n.div`
  display: flex;
  align-items: center;
  width: 100%;
  flex-direction: row;
...
`,Ao=({percentage:e,onChange:o,draggable:r=!1,colors:i={primary:"rgba(0, 125, 136, 1)",secondary:"rgba(37, 203, 161, 1)"}})=>{const a=x.useRef(null),[c,d]=x.useState(!1),g=f=>{!r||!o||(f.preventDefault(),d(!0),b(f))},y=f=>{!c||!o||b(f)},w=()=>{d(!1)},b=f=>{if(!a.current||!o)return;const k=a.current.getBoundingClientRect();let p=(f.clientX-k.left)/k.width*100;p=Math.max(0,Math.min(100,p)),o(Math.round(p))};return x.useEffect(()=>{if(c)return document.addEventListener("mousemove",y),document.addEventListener("mouseup",w),()=>{document.removeEventListener("mousemove",y),document.removeEventListener("mouseup",w)}},[c]),t.jsxs(Fo,{ref:a,$draggable:r,onMouseDown:g,children:[t.jsx(_o,{$secondaryColor:i.secondary}),t.jsx(Oo,{$percentage:e,$primaryColor:i.primary}),r&&t.jsx(Wo,{$percentage:e,$primaryColor:i.primary})]})},Fo=n.div`
  width: 100%;
  height: 10px;
  position: relative;
  border-radius: 5px;
...
`;function ae(e,o="₽"){if(!e||e.trim()==="")return`0${o}`;const r=e.replace(/[^\d-]/g,"");if(!r||r==="-"||r==="")return`0${o}`;const i=parseInt(r,10);if(isNaN(i))return`0${o}`;const a=new Intl.NumberFormat("ru-RU",{style:"decimal",minimumFractionDigits:0,maximumFractionDigits:0}).format(i);return!0?`${a}${o}`:a}function Jo(e){if(!e)return 0;const o=e.replace(/\D/g,"");return parseInt(o,10)}const Ko=({title:e,data:o,maxValue:r,step:i,height:a=300,titleFontSize:c})=>{const[d,g]=x.useState(null),y=[];for(let b=0;b<=r;b+=i)y.push(b);const w=o.length>0?o[0].bars.map(b=>({name:b.name,color:b.color})):[];return t.jsxs(Qo,{children:[t.jsxs(ue,{style:{marginTop:"0"},children:[t.jsx(pe,{style:{fontSize:c},children:e}),t.jsx(er,{children:w.map((b,f)=>t.jsxs(tr,{children:[t.jsx(nr,{color:b.color}),t.jsx(or,{children:b.name})]},f))})]}),t.jsxs(rr,{height:a,children:[t.jsx(ir,{children:y.map((b,f)=>t.jsx(sr,{children:b.toLocaleString()},f))}),t.jsxs(ar,{children:[t.jsxs(lr,{children:[y.map((b,f)=>{const k=b/r*100;return t.jsx(cr,{position:100-k},`line-${f}`)}),o.map((b,f)=>t.jsxs(dr,{onMouseEnter:()=>g(f),onMouseLeave:()=>g(null),children:[b.bars.map((k,h)=>{const p=b.bars.slice(h+1).reduce((l,S)=>l+S.value,0);return t.jsx(ur,{height:k.value/r*100,offset:p/r*100,color:k.color,isHovered:d!==null&&d!==f},h)}),d===f&&t.jsxs(hr,{children:[t.jsxs(fr,{children:[t.jsxs(gr,{children:["Всего: ",ae(b.total.toString())]}),b.bars.map((k,h)=>t.jsxs(br,{children:[k.name,": ",ae(k.value.toString())]},h))]}),t.jsx(mr,{})]})]},f))]}),t.jsx(pr,{children:o.map((b,f)=>t.jsx(xr,{style:{flex:1,textAlign:"center"},children:b.label},f))})]})]})]})},Qo=n.div`
  background-color: white;
  border-radius: 10px;
  border: 1px solid rgba(209, 213, 219, 1);
  padding: 20px;
...
`,vr=({title:e,data:o,xAxisLabel:r,yAxisLabel:i,maxX:a,maxY:c,minY:d,xStep:g,yStep:y,height:w=300,showLegend:b=!0,xAxisCustomLabels:f,showTooltip:k=!0,titleFontSize:h="30px"})=>{const[p,l]=x.useState(null),[S,C]=x.useState({x:0,y:0}),P=x.useRef(null),I=x.useRef(null),E=Math.max(...o.map(v=>v.x),a),T=[];for(let v=0;v<=E;v+=g)T.push(v);const R=[];for(let v=d;v<=c;v+=y)R.push(v);const Y=f||T.map(v=>v.toString()),A=b?Array.from(new Set(o.filter(v=>v.label).map(v=>v.label))).map(v=>{const s=o.find($=>$.label===v);return{name:v,color:s.color}}):[],_={};o.forEach(v=>{const s=v.label||"default";_[s]||(_[s]=[]),_[s].push(v)});const N=v=>v/E*100,O=v=>{const s=c-d;return 100-(v-d)/s*100};return x.useEffect(()=>{if(p&&I.current){const v=I.current.getBoundingClientRect(),s=N(p.x)/100*v.width,$=O(p.y)/100*v.height;C({x:s+v.left,y:$+v.top})}},[p,a,c,d]),t.jsxs(yr,{children:[t.jsxs(ue,{style:{marginTop:"0"},children:[t.jsx(pe,{style:{fontSize:h},children:e}),b&&A.length>0&&t.jsx(kr,{children:A.map((v,s)=>t.jsxs(jr,{children:[t.jsx(Cr,{color:v.color}),t.jsx($r,{children:v.name})]},s))})]}),t.jsxs(Sr,{height:w,children:[t.jsxs(Mr,{children:[R.map((v,s)=>t.jsx(Er,{children:v.toLocaleString()},s)),t.jsx(Se,{children:i})]}),t.jsxs(Dr,{ref:I,children:[R.map((v,s)=>t.jsx(Lr,{position:O(v)},`hline-${s}`)),Object.values(_).map((v,s)=>v.map(($,m)=>{if(m===0)return null;const H=v[m-1],V=N(H.x),U=O(H.y),M=N($.x),L=O($.y);return t.jsx("svg",{style:{position:"absolute",top:0,left:0,width:"100%",height:"100%",pointerEvents:"none",zIndex:1},children:t.jsx("line",{x1:`${V}%`,y1:`${U}%`,x2:`${M}%`,y2:`${L}%`,stroke:$.color,strokeWidth:"1"})},`line-${s}-${m}`)})),o.map((v,s)=>t.jsx(Tr,{x:N(v.x),y:O(v.y),color:v.color,onMouseEnter:()=>l(v),onMouseLeave:()=>l(null),isHovered:p?.label===v.label},s))]})]}),k&&p&&t.jsxs(Rr,{ref:P,style:{left:S.x,top:S.y},children:[t.jsxs(zr,{children:[p.name&&t.jsx(Br,{children:p.name}),t.jsx(Ar,{children:p.y.toLocaleString()})]}),t.jsx(Fr,{})]}),t.jsxs(Ir,{children:[Y.map((v,s)=>{const m=T[s]/E*100;return t.jsx(Pr,{style:{left:`${m}%`,transform:"translateX(-50%)"},children:v},s)}),r&&t.jsx(Se,{children:r})]})]})},yr=n.div`
  background-color: white;
  border-radius: 10px;
  border: 1px solid rgba(209, 213, 219, 1);
  padding: 20px;
...
`,_r=({images:e,initialIndex:o,onClose:r})=>{const[i,a]=x.useState(o),[c,d]=x.useState(0),g=()=>{a(f=>f>0?f-1:e.length-1),d(0)},y=()=>{a(f=>f<e.length-1?f+1:0),d(0)},w=()=>{d(f=>(f+90)%360)},b=f=>{f.key==="Escape"?r():f.key==="ArrowLeft"?g():f.key==="ArrowRight"?y():(f.key==="r"||f.key==="к")&&w()};return t.jsx(Or,{onClick:r,onKeyDown:b,tabIndex:0,children:t.jsxs(Wr,{onClick:f=>f.stopPropagation(),children:[t.jsx(Nr,{onClick:r,children:t.jsxs("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[t.jsx("path",{d:"M18 6L6 18",stroke:"white",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"}),t.jsx("path",{d:"M6 6L18 18",stroke:"white",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})]})}),t.jsx(Hr,{children:t.jsx(Yr,{onClick:w,title:"Повернуть (R)",children:t.jsx("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:t.jsx("path",{d:"M4.077 3C6.88767 5.202 8.48267 7.15733 8.862 8.866C9.24133 10.5753 9.29867 12.202 9.034 13.746H4L12.214 21L20 13.747H15.216C15.192 10.889 14.12 8.46 12 6.46C9.88 4.46 7.239 3.30667 4.077 3Z",stroke:"#50555C",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})})})}),t.jsxs(Vr,{children:[t.jsx(Me,{$position:"left",onClick:g,children:t.jsx("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:t.jsx("path",{d:"M15 18L9 12L15 6",stroke:"white",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})})}),t.jsx(Ur,{src:e[i],alt:`Photo ${i+1}`,$rotation:c}),t.jsx(Me,{$position:"right",onClick:y,children:t.jsx("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:t.jsx("path",{d:"M9 18L15 12L9 6",stroke:"white",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})})})]}),t.jsx(Zr,{children:e.map((f,k)=>t.jsx(qr,{$active:k===i,onClick:()=>{a(k),d(0)}},k))})]})})},Or=n.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,Ae=({isOpen:e,callPhone:o,error:r,onClose:i})=>{const[a,c]=x.useState(!1);if(!e)return null;const d=/iPhone|iPad|iPod|Android/i.test(navigator.userAgent),g=()=>{d?window.location.href=`tel:${o}`:(navigator.clipboard.writeText(o),c(!0),setTimeout(()=>c(!1),2e3))};return t.jsx(Xr,{onClick:i,children:t.jsxs(Gr,{onClick:y=>y.stopPropagation(),children:[t.jsx(Jr,{children:"Подтверждение авторизации"}),t.jsx(Ee,{children:"Для завершения авторизации позвоните на номер:"}),t.jsxs(Kr,{onClick:g,title:d?"Позвонить":"Копировать номер",$clickable:!0,children:[o,!d&&a&&t.jsx(Qr,{children:"Скопировано!"})]}),t.jsx(Ee,{children:"После звонка система автоматически подтвердит вашу авторизацию."}),r&&t.jsx(ei,{children:r})]})})},Xr=n.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,os=n.div`
  ...
  margin-top: 8px;
  text-align: left;
`,rs=({onLoginSuccess:e,userType:o="delivery_operator",title:r="Авторизация",submitLabel:i="Войти",placeholder:a="8 (xxx) xxx-xx-xx",supportPhone:c="8 989 924 24 24",supportLinkUrl:d="https://waypay.one",supportLinkText:g="waypay.one",className:y,style:w,pollingIntervalMs:b=3e3,enableRegistration:f=!1,enableSupport:k=!0})=>{const[h,p]=x.useState(!1),[l,S]=x.useState(""),[C,P]=x.useState(!1),[I,E]=x.useState(""),[T,R]=x.useState(""),[Y,A]=x.useState(!1),[_,N]=x.useState(!1),[O,v]=x.useState(""),[s,$]=x.useState(""),[m,H]=x.useState(null),V=x.useRef(void 0);x.useEffect(()=>()=>{V.current&&clearInterval(V.current)},[]);const U=j=>{const B=j.replace(/\D/g,"");return B?B.startsWith("8")?`+7${B.slice(1)}`:B.startsWith("7")?`+${B}`:`+${B}`:""},M=()=>{P(!1),N(!1),v(""),$(""),H(null),V.current&&window.clearInterval(V.current)},L=async j=>{if(j.preventDefault(),!l){R("Введите номер телефона");return}p(!0),R("");const B=U(l);try{const z=await We(B,o);H({phone:B,checkId:z.check_id,callPhone:z.call_phone}),f&&"name_required"in z&&z.name_required?(N(!0),E(z.call_phone)):!f&&"name_required"in z&&z.name_required?(R("Этот номер не зарегистрирован в системе. Обратитесь в поддержку для регистрации."),H(null)):(E(z.call_phone),P(!0),D(B,z.check_id))}catch(z){console.error("Auth error:",z),z&&z.response&&z.response.data?R(z.response.data):z instanceof Error?R(z.message):R("Произошла ошибка при авторизации")}finally{p(!1)}},u=async j=>{if(!j.trim()){$("Введите ФИО");return}if(m){p(!0),$("");try{v(j),N(!1),P(!0),D(m.phone,m.checkId,j)}catch(B){console.error("Registration error:",B),$("Не удалось завершить регистрацию")}finally{p(!1)}}},D=(j,B,z)=>{V.current&&window.clearInterval(V.current),V.current=window.setInterval(()=>{F(j,B,z)},b)},F=async(j,B,z)=>{if(!Y){A(!0);try{const W=await Ne(j,B,o,z||O);(W.access_token&&W.refresh_token||W.accessToken&&W.refreshToken)&&(V.current&&window.clearInterval(V.current),P(!1),N(!1),v(""),H(null),e(W.access_token??W.accessToken))}catch(W){console.error("Verification error:",W)}finally{A(!1)}}};return t.jsxs(is,{className:y,style:w,children:[t.jsxs(ss,{children:[t.jsxs(as,{onSubmit:L,children:[t.jsx(ls,{children:r}),t.jsx(cs,{children:t.jsx(ds,{children:t.jsx(_e,{value:l,onChange:j=>S(j),placeholder:a})})}),T&&t.jsx(fs,{children:t.jsx("span",{children:T})}),t.jsx(us,{type:"submit",disabled:h,children:h?"Загрузка...":i})]}),k&&t.jsxs(ps,{children:["Хотите получить доступ к нашим продуктам?",t.jsx("br",{}),"Обратитесь по номеру"," ",t.jsx(xs,{href:`tel:${c}`,children:c}),t.jsx("br",{}),"или оставьте заявку на"," ",t.jsx(hs,{href:d,target:"_blank",rel:"noreferrer",children:g})]})]}),t.jsx(Gi,{isOpen:_,onClose:M,onSubmit:u,error:s,isLoading:h}),t.jsx(Ae,{isOpen:C,onClose:M,callPhone:I,error:T})]})},is=n.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
