...
`,bn=({placeholder:e="",customPlaceholder:o,value:s,onChange:i,hasError:r=!1,errorMessage:c,rows:u=3,...m})=>{const[k,b]=w.useState(!1),v=!!(o&&!s&&!k);return t.jsxs(mn,{children:[t.jsx(wn,{...m,value:s,placeholder:v?"":e,onFocus:()=>b(!0),onBlur:f=>{b(!1),m.onBlur?.(f)},onChange:i,hasError:r,rows:u}),o&&t.jsx(vn,{isVisible:v,children:o}),r&&c&&t.jsx(yn,{children:c})]})},mn=n.div`
  position: relative;
  display: inline-block;
  width: 100%;
  margin-right: auto;
...
`,yn=n.span`
  ...
  margin-top: 4px;
  display: block;
`,De=({title:e,onClose:o,onCancel:s,onSave:i,children:r,isSaveDisabled:c=!1,isSubmitting:u=!1,mode:m="create",hideSaveButton:k=!1,hideCanselButton:b=!1,width:v="560px",saveButtonText:f="Сохранить",customLayout:y})=>{const d=m==="view",h=w.useRef(null);w.useEffect(()=>{const j=P=>{P.key==="Escape"&&o()};document.addEventListener("keydown",j);const R=document.body.style.overflow;return document.body.style.overflow="hidden",setTimeout(()=>h.current?.focus(),0),()=>{document.removeEventListener("keydown",j),document.body.style.overflow=R}},[o]);const l=j=>{j.target===j.currentTarget&&o()},T=j=>{j.preventDefault(),s()};return t.jsx(kn,{onMouseDown:l,role:"presentation",children:t.jsxs(jn,{ref:h,$width:v,role:"dialog","aria-modal":"true","aria-label":e||"Диалог",tabIndex:-1,children:[t.jsxs(Te,{children:[t.jsx(Ee,{children:e}),t.jsx(Cn,{type:"button",onClick:o,"aria-label":"Закрыть",children:t.jsx("span",{"aria-hidden":!0,children:"×"})})]}),y?t.jsx($n,{children:y}):null,t.jsxs(Sn,{onSubmit:i,children:[t.jsx(Mn,{children:r}),t.jsxs(Ln,{children:[t.jsx(Dn,{children:b?null:t.jsx(En,{isPrimary:!1,onClick:T,children:"Отменить"})}),t.jsx(Tn,{children:!d&&!k?t.jsx(Pn,{type:"submit",disabled:c||u,children:u?"Сохранение...":f}):null})]})]})]})})},kn=n.div`
  position: fixed;
  inset: 0;
...
`,Xn=({name:e,value:o,onChange:s,onBlur:i,onKeyPress:r,placeholder:c="8 (999) 500-50-50",customPlaceholder:u,tabIndex:m,disabled:k=!1,hasError:b=!1,errorMessage:v})=>{const[f,y]=w.useState(!1),d=w.useRef(null),h=!!(u&&!o&&!f),l=P=>{const A=P.replace(/\D/g,"").slice(0,11);let I="";return A.length>0&&(I+="8"),A.length>1&&(I+=` (${A.slice(1,4)}`),A.length>4&&(I+=`) ${A.slice(4,7)}`),A.length>7&&(I+=`-${A.slice(7,9)}`),A.length>9&&(I+=`-${A.slice(9,11)}`),I},T=P=>{const _=l(P.target.value),A={...P,target:{...P.target,name:e,value:_}};s(A)},j=P=>{y(!1),i?.(P)},R=P=>{r?.(P)};return t.jsxs(qn,{children:[t.jsx(Gn,{ref:d,name:e,type:"tel",value:o,onChange:T,onKeyPress:R,placeholder:h?"":c,maxLength:18,tabIndex:m,disabled:k,hasError:b,onFocus:()=>y(!0),onBlur:j,inputMode:"tel"}),u&&t.jsx(Jn,{isVisible:h,children:u}),b&&v&&t.jsx(Kn,{children:v})]})},qn=n.div`
  position: relative;
  display: inline-block;
  width: 100%;
  margin-right: auto;
...
`,Kn=n.span`
  ...
  margin-top: 4px;
  display: block;
`,Qn=({tabs:e,activeTab:o,onChange:s,addButton:i,fontSize:r=14})=>{const c=e.find(u=>u.id===o)?.content;return t.jsxs(t.Fragment,{children:[t.jsx(eo,{children:t.jsxs(to,{children:[e.map(u=>t.jsxs(no,{$isActive:o===u.id,onClick:()=>s(u.id),$fontSize:r,children:[u.label,o===u.id&&t.jsx(oo,{})]},u.id)),i&&t.jsx(ro,{children:i})]})}),c&&t.jsx(io,{children:c})]})},eo=n.div`
  width: auto;
...
`,io=n.div`
  margin-top: 20px;
`,so=({mode:e,primaryValue:o,secondaryValue:s,placeholder:i="Выберите значение",onSelect:r,onClear:c,disabled:u=!1,hasError:m=!1,errorMessage:k="",customIcon:b})=>{const f=b||t.jsx("svg",{width:"27",height:"6",viewBox:"0 0 27 6",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:t.jsx("path",{d:"M2.915 0C1.31175 0 0 1.31175 0 2.915C0 4.51825 1.31175 5.83 2.915 5.83C4.51825 5.83 5.83 4.51825 5.83 2.915C5.83 1.31175 4.51825 0 2.915 0ZM23.32 0C21.7167 0 20.405 1.31175 20.405 2.915C20.405 4.51825 21.7167 5.83 23.32 5.83C24.9233 5.83 26.235 4.51825 26.235 2.915C26.235 1.31175 24.9233 0 23.32 0ZM13.1175 0C11.5142 0 10.2025 1.31175 10.2025 2.915C10.2025 4.51825 11.5142 5.83 13.1175 5.83C14.7207 5.83 16.0325 4.51825 16.0325 2.915C16.0325 1.31175 14.7207 0 13.1175 0Z",fill:"#50555C"})});return e==="view"?t.jsxs(po,{children:[t.jsx(uo,{children:o||"Не указано"}),s&&t.jsx(ho,{children:s})]}):t.jsxs(ao,{children:[t.jsxs(lo,{children:[t.jsx(co,{type:"text",value:o||"",placeholder:i,readOnly:!0,disabled:u}),o&&!u&&t.jsx(fo,{type:"button",onClick:c,"aria-label":"Очистить",children:"×"})]}),!u&&t.jsx(xo,{type:"button",onClick:r,"aria-label":"Выбрать",children:f}),m&&k&&t.jsx(go,{children:k})]})},ao=n.div`
  display: flex;
  align-items: center;
  width: 100%;
  flex-direction: row;
...
`,ce=n.div`
  ...
  margin-top: 0px;
  align-items: center;
`,bo=({total:e})=>t.jsx("div",{children:t.jsxs(mo,{children:["Всего: ",e]})}),mo=n.p`
  display: flex;
  align-items: center;
  color: black;
  justify-content: center;
...
`,jo=n.input.attrs({type:"checkbox"})`
  opacity: 0;
  width: 0;
  color: black;
  height: 0;
`,Co=({checked:e,onChange:o,disabled:s})=>{const i=()=>{s||o(!e)};return t.jsxs(yo,{children:[t.jsx(jo,{checked:e,onChange:i,disabled:s}),t.jsx(ko,{checked:e,disabled:s})]})},$o=({id:e,name:o,checked:s,onChange:i,children:r})=>t.jsxs(So,{htmlFor:e,children:[t.jsx(Mo,{type:"radio",id:e,name:o,checked:s,onChange:i}),r]}),So=n.label`
  display: flex;
  align-items: center;
  cursor: pointer;
  font-size: 14px;
...
`,Lo=({percentage:e,onChange:o,draggable:s=!1,colors:i={primary:"rgba(0, 125, 136, 1)",secondary:"rgba(37, 203, 161, 1)"}})=>{const r=w.useRef(null),[c,u]=w.useState(!1),m=f=>{!s||!o||(f.preventDefault(),u(!0),v(f))},k=f=>{!c||!o||v(f)},b=()=>{u(!1)},v=f=>{if(!r.current||!o)return;const y=r.current.getBoundingClientRect();let h=(f.clientX-y.left)/y.width*100;h=Math.max(0,Math.min(100,h)),o(Math.round(h))};return w.useEffect(()=>{if(c)return document.addEventListener("mousemove",k),document.addEventListener("mouseup",b),()=>{document.removeEventListener("mousemove",k),document.removeEventListener("mouseup",b)}},[c]),t.jsxs(Do,{ref:r,$draggable:s,onMouseDown:m,children:[t.jsx(To,{$secondaryColor:i.secondary}),t.jsx(Eo,{$percentage:e,$primaryColor:i.primary}),s&&t.jsx(Po,{$percentage:e,$primaryColor:i.primary})]})},Do=n.div`
  width: 100%;
  height: 10px;
  position: relative;
  border-radius: 5px;
...
`,Io=["zoomControl","fullscreenControl"];let oe=null;const Ro=e=>typeof window>"u"?Promise.reject(new Error("Window is not available")):window.ymaps?Promise.resolve(window.ymaps):(oe||(oe=new Promise((o,s)=>{const i=document.createElement("script"),r=e?`&apikey=${e}`:"";i.src=`https://api-maps.yandex.ru/2.1/?lang=ru_RU${r}`,i.async=!0,i.onload=()=>{window.ymaps?window.ymaps.ready(()=>o(window.ymaps)):s(new Error("Yandex Maps failed to load"))},i.onerror=()=>s(new Error("Failed to load Yandex Maps script")),document.head.appendChild(i)})),oe),Bo=({onLocationSelect:e,initialAddress:o="",initialLat:s=55.751244,initialLon:i=37.618423,apiKey:r,zoom:c=12,height:u=400,width:m="100%",inputPlaceholder:k="Введите адрес или название места",searchButtonLabel:b="Найти",draggablePlacemark:v=!0,controls:f=Io,showSearch:y=!0,className:d,style:h,onError:l})=>{const[T,j]=w.useState(null),[R,P]=w.useState(o),[_,A]=w.useState(o),[I,H]=w.useState(!1),B=w.useRef(null);w.useEffect(()=>{let F=!1,g;return(async()=>{try{const S=await Ro(r);if(F||!B.current)return;g=new S.Map(B.current,{center:[s,i],zoom:c,controls:f});const E=new S.Placemark([s,i],{},{draggable:v});g.geoObjects.add(E),g.events.add("click",O=>{const V=O.get("coords");z(V,E,g)}),E.events.add("dragend",()=>{const O=E.geometry.getCoordinates();z(O,E,g)}),j(g),H(!0)}catch(S){l&&S instanceof Error&&l(S)}})(),()=>{F=!0,g&&g.destroy()}},[r,s,i,c,f,v,l]);const z=async(F,g,p)=>{if(window.ymaps)try{const O=(await window.ymaps.geocode(F)).geoObjects.get(0).getAddressLine();g.geometry.setCoordinates(F),p.panTo(F,{flying:!0}),A(O),P(O),e(O,F[0],F[1])}catch(S){l&&S instanceof Error&&l(S)}},N=async()=>{if(!(!R.trim()||!window.ymaps||!T))try{const g=(await window.ymaps.geocode(R)).geoObjects.get(0);if(g){const p=g.geometry.getCoordinates(),S=g.properties.get("boundedBy");T.setBounds(S,{checkZoomRange:!0});const E=new window.ymaps.Placemark(p,{},{draggable:v});T.geoObjects.removeAll(),T.geoObjects.add(E);const O=g.getAddressLine();A(O),e(O,p[0],p[1]),E.events.add("dragend",()=>{const V=E.geometry.getCoordinates();z(V,E,T)})}}catch(F){l&&F instanceof Error&&l(F)}};return t.jsxs(zo,{className:d,style:h,children:[y&&t.jsxs(Ao,{children:[t.jsx(le,{type:"text",value:R,onChange:F=>P(F.target.value),placeholder:k,onKeyPress:F=>F.key==="Enter"&&N(),disabled:!I}),t.jsx(Fo,{onClick:N,disabled:!I,children:b})]}),t.jsxs(Oo,{children:["Выбранный адрес: ",t.jsx("strong",{children:_||"Не выбран"})]}),t.jsx(_o,{ref:B,$height:u,$width:m}),t.jsx(No,{children:"📍 Кликните на карте или найдите адрес через поиск"})]})},zo=n.div`
  display: flex;
  flex-direction: column;
  gap: 12px;
`,Ao=n.div`
...
`,de=n.h1`
  ...
  color: black;
  font-weight: 600;
`;function ie(e,o="₽"){if(!e||e.trim()==="")return`0${o}`;const s=e.replace(/[^\d-]/g,"");if(!s||s==="-"||s==="")return`0${o}`;const i=parseInt(s,10);if(isNaN(i))return`0${o}`;const r=new Intl.NumberFormat("ru-RU",{style:"decimal",minimumFractionDigits:0,maximumFractionDigits:0}).format(i);return!0?`${r}${o}`:r}function Yo(e){if(!e)return 0;const o=e.replace(/\D/g,"");return parseInt(o,10)}const Wo=({title:e,data:o,maxValue:s,step:i,height:r=300,titleFontSize:c})=>{const[u,m]=w.useState(null),k=[];for(let v=0;v<=s;v+=i)k.push(v);const b=o.length>0?o[0].bars.map(v=>({name:v.name,color:v.color})):[];return t.jsxs(Ho,{children:[t.jsxs(ce,{style:{marginTop:"0"},children:[t.jsx(de,{style:{fontSize:c},children:e}),t.jsx(Vo,{children:b.map((v,f)=>t.jsxs(Zo,{children:[t.jsx(Uo,{color:v.color}),t.jsx(Xo,{children:v.name})]},f))})]}),t.jsxs(qo,{height:r,children:[t.jsx(Go,{children:k.map((v,f)=>t.jsx(Jo,{children:v.toLocaleString()},f))}),t.jsxs(Ko,{children:[t.jsxs(Qo,{children:[k.map((v,f)=>{const y=v/s*100;return t.jsx(er,{position:100-y},`line-${f}`)}),o.map((v,f)=>t.jsxs(tr,{onMouseEnter:()=>m(f),onMouseLeave:()=>m(null),children:[v.bars.map((y,d)=>{const h=v.bars.slice(d+1).reduce((l,T)=>l+T.value,0);return t.jsx(nr,{height:y.value/s*100,offset:h/s*100,color:y.color,isHovered:u!==null&&u!==f},d)}),u===f&&t.jsxs(ir,{children:[t.jsxs(sr,{children:[t.jsxs(ar,{children:["Всего: ",ie(v.total.toString())]}),v.bars.map((y,d)=>t.jsxs(lr,{children:[y.name,": ",ie(y.value.toString())]},d))]}),t.jsx(cr,{})]})]},f))]}),t.jsx(or,{children:o.map((v,f)=>t.jsx(rr,{style:{flex:1,textAlign:"center"},children:v.label},f))})]})]})]})},Ho=n.div`
  background-color: white;
  border-radius: 10px;
  border: 1px solid rgba(209, 213, 219, 1);
  padding: 20px;
...
`,Pe=({isOpen:e,callPhone:o,error:s,onClose:i})=>{const[r,c]=w.useState(!1);if(!e)return null;const u=/iPhone|iPad|iPod|Android/i.test(navigator.userAgent),m=()=>{u?window.location.href=`tel:${o}`:(navigator.clipboard.writeText(o),c(!0),setTimeout(()=>c(!1),2e3))};return t.jsx(Or,{onClick:i,children:t.jsxs(Nr,{onClick:k=>k.stopPropagation(),children:[t.jsx(Yr,{children:"Подтверждение авторизации"}),t.jsx(Se,{children:"Для завершения авторизации позвоните на номер:"}),t.jsxs(Wr,{onClick:m,title:u?"Позвонить":"Копировать номер",$clickable:!0,children:[o,!u&&r&&t.jsx(Hr,{children:"Скопировано!"})]}),t.jsx(Se,{children:"После звонка система автоматически подтвердит вашу авторизацию."}),s&&t.jsx(Vr,{children:s})]})})},Or=n.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,gi=e=>{const o=e.replace(/\D/g,""),i=(o.startsWith("8")||o.length===0?o:`8${o}`).slice(0,11);let r="";return i.length>0&&(r+="8"),i.length>1&&(r+=` (${i.slice(1,4)}`),i.length>4&&(r+=`) ${i.slice(4,7)}`),i.length>7&&(r+=`-${i.slice(7,9)}`),i.length>9&&(r+=`-${i.slice(9,11)}`),r},Re=({value:e,onChange:o,placeholder:s="8 (xxx) xxx-xx-xx",tabIndex:i})=>{const r=c=>{const u=gi(c.target.value);o(u)};return t.jsx(bi,{type:"text",value:e,onChange:r,placeholder:s,maxLength:18,tabIndex:i})},bi=n.input`
  width: 100%;
  height: 54px;
  font-size: 16px;
...
`,Be=(e,o)=>G("/auth/call/initiate",{method:"POST",body:{phone:e,user_type:o}}),ze=(e,o,s,i)=>G("/auth/call/confirm",{method:"POST",body:{phone:e,check_id:o,user_type:s,name:i}}),mi=()=>G("/auth/session/info",{method:"GET"}),wi=({isOpen:e,onClose:o,onSubmit:s,error:i,isLoading:r=!1})=>{const[c,u]=w.useState("");if(!e)return null;const m=k=>{k.preventDefault(),s(c)};return t.jsx(vi,{onClick:o,children:t.jsx(yi,{onClick:k=>k.stopPropagation(),children:t.jsxs(ki,{onSubmit:m,children:[t.jsx(ji,{children:"Как вас зовут?"}),t.jsxs(Ci,{children:[t.jsx(le,{type:"text",value:c,onChange:k=>u(k.target.value),placeholder:"Иванов Иван Иванович",disabled:r,autoFocus:!0,style:{flex:1}}),t.jsx($i,{type:"submit",disabled:r||!c.trim(),children:r?"...":"→"})]}),i&&t.jsx(Si,{children:i})]})})})},vi=n.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,Ae=e=>{let o=0;for(let i=0;i<e.length;i++)o=e.charCodeAt(i)+((o<<5)-o);return`hsl(${Math.abs(o%360)}, 60%, 60%)`},_i=e=>!e||!e.trim()?"?":e.split(" ").filter(i=>i.length>0).map(i=>i[0].toUpperCase()).join("").slice(0,2)||"?",Oi=(e,o=100)=>{const s=document.createElement("canvas");s.width=o,s.height=o;const i=s.getContext("2d");if(!i)return"";const r=Ae(e);i.fillStyle=r,i.beginPath(),i.arc(o/2,o/2,o/2,0,Math.PI*2),i.fill(),i.fillStyle="#ffffff";const c=o/2;i.font=`bold ${c}px "Manrope", Arial, sans-serif`,i.textAlign="center",i.textBaseline="middle";const u=c*.1;return i.fillText(e,o/2,o/2+u),s.toDataURL("image/png")},Ni=e=>{if(!e)return"";const o=typeof e=="string"?new Date(e):e;if(isNaN(o.getTime()))return"";const s=o.getDate().toString().padStart(2,"0"),i=(o.getMonth()+1).toString().padStart(2,"0"),r=o.getFullYear();return`${s}-${i}-${r}`};function Yi(e){return new Date(e)}const Fe=e=>{let o;try{if(e instanceof Date)o=e;else if(typeof e=="string"||typeof e=="number")o=new Date(e);else throw new Error("Неподдерживаемый тип данных");if(isNaN(o.getTime()))return"неверная дата";const s=new Date;if(o>s){const v=Math.floor((o.getTime()-s.getTime())/1e3),f=Math.floor(v/60),y=Math.floor(f/60),d=Math.floor(y/24);return v<10?"скоро":v<60?`через ${v} секунд`:f===1?"через минуту":f<60?`через ${f} минут`:y===1?"через час":y<24?`через ${y} часов`:d===1?"завтра":d<7?`через ${d} дней`:"в будущем"}const i=Math.floor((s.getTime()-o.getTime())/1e3),r=Math.floor(i/60),c=Math.floor(r/60),u=Math.floor(c/24),m=Math.floor(u/7),k=Math.floor(u/30),b=Math.floor(u/365);if(i<10)return"только что";if(i<60){const v=Math.max(1,i);return v===1?"секунду назад":v<5?`${v} секунды назад`:`${v} секунд назад`}return r<60?r===1?"минуту назад":r<5?`${r} минуты назад`:`${r} минут назад`:c<24?c===1?"час назад":c<5?`${c} часа назад`:`${c} часов назад`:u<7?u===1?"вчера":u===2?"позавчера":`${u} дня назад`:m<4?m===1?"неделю назад":m<5?`${m} недели назад`:`${m} недель назад`:k<12?k===1?"месяц назад":k<5?`${k} месяца назад`:`${k} месяцев назад`:b===1?"год назад":b<5?`${b} года назад`:`${b} лет назад`}catch(s){return console.error("Ошибка форматирования относительного времени:",s),"ошибка даты"}},_e=e=>{try{return e.toLocaleDateString("ru-RU",{day:"2-digit",month:"2-digit",year:"2-digit",hour:"2-digit",minute:"2-digit"})}catch{return"неверная дата"}},Wi=(e,o={})=>{const{useExactAfterMonths:s=6,includeTime:i=!0}=o,r=new Date(e);return isNaN(r.getTime()),Math.floor((new Date().getTime()-r.getTime())/(1e3*60*60*24*30))>=s?i?_e(r):r.toLocaleDateString("ru-RU",{day:"2-digit",month:"2-digit",year:"2-digit"}):Fe(r)};exports.API_BASE_URL=ae;exports.AddButton=lt;exports.AuthCallModal=Pe;exports.AuthPage=Mi;exports.BackButton=xt;exports.BaseModal=De;exports.Checkbox=Nt;exports.ColumnChart=Wo;exports.ContextMenu=se;exports.CountInfoTitle=bo;exports.CustomCalendar=re;exports.CustomInput=le;exports.CustomPhoneInput=Re;exports.CustomSelect=St;exports.CustomTable=Ge;exports.CustomTextArea=bn;exports.CustomTitle=de;exports.DefaultButton=te;exports.DeleteButton=bt;exports.EditButton=wt;exports.EntitySelectContainer=so;exports.ExportButton=kt;exports.InputTitle=wo;exports.ModalInfoTitle=vo;exports.Pagination=fn;exports.PeriodField=Rn;exports.PhoneModalInput=Xn;exports.PhotoViewerModal=Tr;exports.ProgressBar=Lo;exports.RadioButton=$o;exports.ScatterPlot=pr;exports.SideMenu=Ur;exports.SideMenuContext=Ie;exports.Tabs=Qn;exports.TitleField=ce;exports.ToggleSwitch=Co;exports.YandexMapSelector=Bo;exports.apiRequest=G;exports.authStorage=ut;exports.confirmCallAuth=ze;exports.formatDate=Ni;exports.formatExactDate=_e;exports.formatMoney=ie;exports.formatRelativeTime=Fe;exports.formatRelativeTimeExtended=Wi;exports.generateAvatar=Oi;exports.getInitials=_i;exports.getSessionInfo=mi;exports.initiateCallAuth=Be;exports.parseDateInput=Yi;exports.parseMoney=Yo;exports.stringToColor=Ae;
