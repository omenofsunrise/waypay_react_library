"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const m=require("react"),n=require("styled-components"),X=require("framer-motion");var te={exports:{}},K={};var ue;function We(){if(ue)return K;ue=1;var e=Symbol.for("react.transitional.element"),o=Symbol.for("react.fragment");function i(r,s,l){var h=null;if(l!==void 0&&(h=""+l),s.key!==void 0&&(h=""+s.key),"key"in s){l={};for(var g in s)g!=="key"&&(l[g]=s[g])}else l=s;return s=l.ref,{$$typeof:e,type:r,key:h,ref:s!==void 0?s:null,props:l}}return K.Fragment=o,K.jsx=i,K.jsxs=i,K}var Q={};var he;function Ye(){return he||(he=1,process.env.NODE_ENV!=="production"&&(function(){function e(a){if(a==null)return null;if(typeof a=="function")return a.$$typeof===F?null:a.displayName||a.name||null;if(typeof a=="string")return a;switch(a){case I:return"Fragment";case P:return"Profiler";case k:return"StrictMode";case R:return"Suspense";case H:return"SuspenseList";case W:return"Activity"}if(typeof a=="object")switch(typeof a.tag=="number"&&console.error("Received an unexpected object in getComponentNameFromType(). This is likely a bug in React. Please file an issue."),a.$$typeof){case d:return"Portal";case O:return a.displayName||"Context";case E:return(a._context.displayName||"Context")+".Consumer";case A:var $=a.render;return a=a.displayName,a||(a=$.displayName||$.name||"",a=a!==""?"ForwardRef("+a+")":"ForwardRef"),a;case B:return $=a.displayName||null,$!==null?$:e(a.type)||"Memo";case _:$=a._payload,a=a._init;try{return e(a($))}catch{}}return null}function o(a){return""+a}function i(a){try{o(a);var $=!1}catch{$=!0}if($){$=console;var S=$.error,f=typeof Symbol=="function"&&Symbol.toStringTag&&a[Symbol.toStringTag]||a.constructor.name||"Object";return S.call($,"The provided key is an unsupported type %s. This value must be coerced to a string before using it here.",f),o(a)}}function r(a){if(a===I)return"<>";if(typeof a=="object"&&a!==null&&a.$$typeof===_)return"<...>";try{var $=e(a);return $?"<"+$+">":"<...>"}catch{return"<...>"}}function s(){var a=v.A;return a===null?null:a.getOwner()}function l(){return Error("react-stack-top-frame")}function h(a){if(c.call(a,"key")){var $=Object.getOwnPropertyDescriptor(a,"key").get;if($&&$.isReactWarning)return!1}return a.key!==void 0}function g(a,$){function S(){N||(N=!0,console.error("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://react.dev/link/special-props)",$))}S.isReactWarning=!0,Object.defineProperty(a,"key",{get:S,configurable:!0})}function j(){var a=e(this.type);return V[a]||(V[a]=!0,console.error("Accessing element.ref was removed in React 19. ref is now a regular prop. It will be removed from the JSX Element type in a future release.")),a=this.props.ref,a!==void 0?a:null}function b(a,$,S,f,T,z){var Y=S.ref;return a={$$typeof:p,type:a,key:$,props:S,_owner:f},(Y!==void 0?Y:null)!==null?Object.defineProperty(a,"ref",{enumerable:!1,get:j}):Object.defineProperty(a,"ref",{enumerable:!1,value:null}),a._store={},Object.defineProperty(a._store,"validated",{configurable:!1,enumerable:!1,writable:!0,value:0}),Object.defineProperty(a,"_debugInfo",{configurable:!1,enumerable:!1,writable:!0,value:null}),Object.defineProperty(a,"_debugStack",{configurable:!1,enumerable:!1,writable:!0,value:T}),Object.defineProperty(a,"_debugTask",{configurable:!1,enumerable:!1,writable:!0,value:z}),Object.freeze&&(Object.freeze(a.props),Object.freeze(a)),a}function w(a,$,S,f,T,z){var Y=$.children;if(Y!==void 0)if(f)if(M(Y)){for(f=0;f<Y.length;f++)x(Y[f]);Object.freeze&&Object.freeze(Y)}else console.error("React.jsx: Static children should always be an array. You are likely explicitly calling React.jsxs or React.jsxDEV. Use the Babel transform instead.");else x(Y);if(c.call($,"key")){Y=e(a);var U=Object.keys($).filter(function(J){return J!=="key"});f=0<U.length?"{key: someKey, "+U.join(": ..., ")+": ...}":"{key: someKey}",L[Y+f]||(U=0<U.length?"{"+U.join(": ..., ")+": ...}":"{}",console.error(`A props object containing a "key" prop is being spread into JSX:
  let props = %s;
  <%s {...props} />
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`,f,Y,U,Y),L[Y+f]=!0)}if(Y=null,S!==void 0&&(i(S),Y=""+S),h($)&&(i($.key),Y=""+$.key),"key"in $){S={};for(var G in $)G!=="key"&&(S[G]=$[G])}else S=$;return Y&&g(S,typeof a=="function"?a.displayName||a.name||"Unknown":a),b(a,Y,S,s(),T,z)}function x(a){y(a)?a._store&&(a._store.validated=1):typeof a=="object"&&a!==null&&a.$$typeof===_&&(a._payload.status==="fulfilled"?y(a._payload.value)&&a._payload.value._store&&(a._payload.value._store.validated=1):a._store&&(a._store.validated=1))}function y(a){return typeof a=="object"&&a!==null&&a.$$typeof===p}var u=m,p=Symbol.for("react.transitional.element"),d=Symbol.for("react.portal"),I=Symbol.for("react.fragment"),k=Symbol.for("react.strict_mode"),P=Symbol.for("react.profiler"),E=Symbol.for("react.consumer"),O=Symbol.for("react.context"),A=Symbol.for("react.forward_ref"),R=Symbol.for("react.suspense"),H=Symbol.for("react.suspense_list"),B=Symbol.for("react.memo"),_=Symbol.for("react.lazy"),W=Symbol.for("react.activity"),F=Symbol.for("react.client.reference"),v=u.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,c=Object.prototype.hasOwnProperty,M=Array.isArray,D=console.createTask?console.createTask:function(){return null};u={react_stack_bottom_frame:function(a){return a()}};var N,V={},Z=u.react_stack_bottom_frame.bind(u,l)(),C=D(r(l)),L={};Q.Fragment=I,Q.jsx=function(a,$,S){var f=1e4>v.recentlyCreatedOwnerStacks++;return w(a,$,S,!1,f?Error("react-stack-top-frame"):Z,f?D(r(a)):C)},Q.jsxs=function(a,$,S){var f=1e4>v.recentlyCreatedOwnerStacks++;return w(a,$,S,!0,f?Error("react-stack-top-frame"):Z,f?D(r(a)):C)}})()),Q}var xe;function He(){return xe||(xe=1,process.env.NODE_ENV==="production"?te.exports=We():te.exports=Ye()),te.exports}var t=He();const ae=({x:e,y:o,items:i,onClose:r,...s})=>{const l=m.useRef(null),[h,g]=m.useState(null);m.useEffect(()=>{const u=p=>{l.current&&!l.current.contains(p.target)&&r()};return document.addEventListener("mousedown",u),()=>{document.removeEventListener("mousedown",u)}},[r]);const b=(()=>{if(!l.current)return{x:e,y:o};const u=l.current.offsetWidth,p=l.current.offsetHeight,d=window.innerWidth,I=window.innerHeight;let k=e,P=o;return k+u>d&&(k=e-u),P+p>I&&(P=o-p),{x:k,y:P}})(),w=(u,p)=>{u.submenu?g(h===p?null:p):u.action&&(u.action(),r())},x=u=>{i[u].submenu&&g(u)},y=u=>{const p=u.relatedTarget;l.current?.contains(p)||g(null)};return t.jsx(Ve,{ref:l,initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.8},transition:{duration:.15},style:{position:"absolute",top:b.y,left:b.x},onClick:u=>u.stopPropagation(),onMouseLeave:y,...s,children:i.map((u,p)=>t.jsxs(Ze,{$hasSubmenu:!!u.submenu,$disabled:u.disabled,children:[t.jsx(Ue,{onClick:d=>{d.stopPropagation(),u.disabled||w(u,p)},onMouseEnter:()=>!u.disabled&&x(p),whileHover:u.disabled?{}:{backgroundColor:"#f3f4f6"},initial:{backgroundColor:"#ffffff"},$color:u.color,$disabled:u.disabled,children:t.jsxs(Xe,{children:[u.label,u.submenu&&t.jsx(qe,{children:t.jsx("svg",{width:"8",height:"12",viewBox:"0 0 8 12",fill:"none",children:t.jsx("path",{d:"M1.5 1.5L6 6L1.5 10.5",stroke:"currentColor",strokeWidth:"2"})})})]})}),u.submenu&&h===p&&t.jsx(Ge,{initial:{opacity:0,x:10},animate:{opacity:1,x:0},exit:{opacity:0,x:10},transition:{duration:.15},children:t.jsx(ae,{x:0,y:-p*40,items:u.submenu,onClose:()=>g(null)})})]},p))})},Ve=n(X.motion.div)`
  position: absolute;
  background: white;
  border-radius: 8px;
...
`,le="/api";async function q(e,o={}){const{method:i="GET",body:r,headers:s={},token:l,withCredentials:h=!0}=o,g=async b=>{const w={"Content-Type":"application/json",...s};b&&(w.Authorization=`Bearer ${b}`);const x=e.startsWith("http")?e:`${le}${e}`;return await fetch(x,{method:i,headers:w,body:r?JSON.stringify(r):void 0,credentials:h?"include":"same-origin"})},j=async(b,w=!0)=>{const x=await g(b);if(x.ok){if(x.status===204)return null;const u=await x.text();if(!u)return null;try{return JSON.parse(u)}catch{return u}}if(x.status===401&&w){const u=await ut();if(u)return j(u,!1)}let y=`Request failed with status ${x.status}`;try{const u=await x.text();if(u)try{const p=JSON.parse(u);p&&typeof p.error=="string"?y=p.error:typeof p=="string"?y=p:typeof p?.message=="string"&&(y=p.message)}catch{y=u}}catch{}throw new Error(y)};return j(l)}async function ut(){const e=await fetch(`${le}/auth/refresh`,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"include"});if(!e.ok)return null;const o=await e.json();return o.access_token?o.access_token:null}const ht={async isAuthenticated(){try{return!!(await this.getSessionInfo())?.client?.id}catch{return!1}},async getSessionInfo(){try{return await q("/auth/session/info",{method:"GET"})}catch{return null}},async logout(e){try{await q("/auth/session/revoke",{method:"POST",headers:{"Content-Type":"application/json"},body:e?{token_id:e}:{}})}catch(o){throw console.error("Logout error:",o),o}},async getClientId(){return(await this.getSessionInfo())?.client?.id||null},async hasPin(){return(await this.getSessionInfo())?.has_pin||!1}},xt=n.button`
  display: inline-flex;
  align-items: center;
  gap: 8px;
  padding: 8px 12px;
...
`,ft=({children:e,onClick:o,disabled:i,...r})=>t.jsxs(xt,{onClick:o,disabled:i,...r,children:[t.jsx("svg",{width:"21",height:"13",viewBox:"0 0 21 13",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:t.jsx("path",{d:"M6.17798 0.978109L0.65625 6.4998L6.17798 12.0215L7.10604 11.0934L3.16862 7.156L20.3124 7.156V5.84351L3.16874 5.84351L7.10604 1.90621L6.17798 0.978109Z",fill:"currentColor"})}),e]}),ne=({children:e="Подтвердить",icon:o,disabled:i=!1,bg:r,hoverBg:s,disabledBg:l,textColor:h,fullWidth:g=!1,minWidth:j,width:b,isPrimary:w=!0,...x})=>{const u=r?{bg:r,hoverBg:s||r,disabledBg:l||r,textColor:h||(w?"white":"black")}:w?{bg:"rgba(0, 125, 136, 1)",hoverBg:"rgba(0, 150, 163, 1)",disabledBg:"rgba(102, 177, 184, 1)",textColor:"white"}:{bg:"rgba(209, 213, 219, 1)",hoverBg:"rgba(209, 233, 239, 1)",disabledBg:"rgba(209, 213, 219, 0.7)",textColor:"black"};return t.jsxs(gt,{disabled:i,$bg:u.bg,$hoverBg:u.hoverBg,$disabledBg:u.disabledBg,$textColor:u.textColor,$fullWidth:g,$minWidth:j,$width:b,...x,children:[o&&t.jsx(bt,{children:o}),t.jsx("span",{children:e})]})},gt=n.button`
  display: inline-flex;
  align-items: center;
  justify-content: center;
  gap: 8px;
...
`,Mt=({placeholder:e="",customPlaceholder:o,value:i,onChange:r,hasError:s=!1,errorMessage:l,options:h,name:g,disabled:j=!1,required:b=!1,...w})=>{const[x,y]=m.useState(!1),[u,p]=m.useState(!1),d=m.useRef(null),I=!!(o&&!i&&!x),k=R=>{r&&!j&&r({target:{value:R,name:g}}),p(!1),y(!1)},P=R=>{d.current&&!d.current.contains(R.target)&&(p(!1),y(!1))},E=()=>{j||(p(!u),y(!u))};m.useEffect(()=>(document.addEventListener("mousedown",P),()=>{document.removeEventListener("mousedown",P)}),[]);const O=h.find(R=>R.value===i),A=O?O.label:"";return t.jsxs(Lt,{ref:d,...w,children:[t.jsxs(Dt,{children:[t.jsxs(Tt,{hasError:s,isOpen:u,disabled:j,onClick:E,onFocus:()=>!j&&y(!0),onBlur:()=>y(!1),tabIndex:j?-1:0,children:[t.jsx(Et,{children:A||e&&t.jsx(It,{children:e})}),t.jsx(Pt,{isOpen:u,disabled:j,children:t.jsx("svg",{width:"17",height:"9",viewBox:"0 0 17 9",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:t.jsx("path",{d:"M1.5 1L8.5 8L15.5 1",stroke:j?"#CCCCCC":"#50555C",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})})})]}),u&&t.jsx(Rt,{children:h.map(R=>t.jsxs(Bt,{$isSelected:R.value===i,onClick:()=>k(R.value),children:[t.jsx(zt,{$isSelected:R.value===i,children:R.value===i&&t.jsx(At,{})}),t.jsx(Ft,{children:R.label})]},R.value))})]}),o&&t.jsx(_t,{isVisible:I,children:o}),s&&l&&t.jsx(Ot,{children:l}),t.jsx(Nt,{name:g,value:i||"",onChange:()=>{},tabIndex:-1,required:b,children:h.map(R=>t.jsx("option",{value:R.value,children:R.label},R.value))})]})},Lt=n.div`
  position: relative;
...
`,Nt=n.select`
  ...
  width: 0;
  pointer-events: none;
`,Wt=({checked:e=!1,onChange:o,className:i,label:r,disabled:s=!1})=>{const[l,h]=m.useState(!1),g=()=>{s||!o||o(!e)},j=b=>{s||(b.key==="Enter"||b.key===" ")&&(b.preventDefault(),g())};return t.jsxs(Yt,{className:i,onClick:g,onKeyPress:j,tabIndex:s?-1:0,disabled:s,children:[t.jsx(Ht,{checked:e,isFocused:l,disabled:s,onMouseEnter:()=>!s&&h(!0),onMouseLeave:()=>!s&&h(!1),onFocus:()=>!s&&h(!0),onBlur:()=>!s&&h(!1),children:e&&t.jsx(Zt,{viewBox:"0 0 8 8",fill:"none",xmlns:"http://www.w3.org/2000/svg",disabled:s,children:t.jsx("path",{d:"M7.375 1.1875L2.65 6.8125L0.625 4.5625",stroke:s?"rgba(173, 179, 188, 1)":"white",strokeLinecap:"round",strokeLinejoin:"round"})})}),r&&t.jsx(Vt,{disabled:s,children:r})]})},Yt=n.div`
  display: flex;
  align-items: center;
...
`,xn=n.div`
  ...
  max-width: 425px;
  margin-top: 10px;
`,ce=({placeholder:e="",customPlaceholder:o,value:i,inputType:r="text",onChange:s,hasError:l=!1,errorMessage:h,...g})=>{const[j,b]=m.useState(!1),w=!!(o&&!i&&!j),x=p=>{if(!s)return;let d=p.target.value;switch(r){case"number":/^\d*$/.test(d)&&s?.(p);break;case"rubles":{const k=p.target.selectionStart,P=p.target.value;let E=P.replace(/[^\d]/g,"");if(E===""){p.target.value="",s(p);break}const O=parseInt(E,10);if(!isNaN(O)){let A=O.toLocaleString("ru-RU");A+=" ₽";const R=y(P,k||0),H=u(A,R);p.target.value=A,s(p),setTimeout(()=>{p.target.setSelectionRange(H,H)},0)}break}case"percents":{d=d.replace(/[^\d.]/g,"");const k=d.split(".");k.length>2&&(d=k[0]+"."+k.slice(1).join("")),k.length===2&&k[1].length>2&&(d=k[0]+"."+k[1].slice(0,2));const P=parseFloat(d);if(isNaN(P)||(P>100?d="100":P<0&&(d="0")),d&&d!==""){d+=" %";const E=p.target.selectionStart||0,O=d.replace(" %","");p.target.value=d,s(p),setTimeout(()=>{E<O.length&&p.target.setSelectionRange(E,E)},0)}else p.target.value=d,s(p);break}case"fullname":d=d.replace(/[^a-zA-Zа-яА-ЯёЁ'\-\s]/g,""),d=d.replace(/\s{2,}/g," "),d=d.replace(/- /g,"-"),d=d.replace(/ -/g," ");let I=d.split(" ").filter(k=>k.length>0);I=I.slice(0,3),d=I.map(k=>{if(k.startsWith("-")&&(k=k.substring(1)),(k.match(/-/g)||[]).length>1){const E=k.split("-");k=E[0]+"-"+E.slice(1).join("")}return k.includes("-")?k.split("-").map((E,O)=>E.length===0?"":(O>0,E[0].toUpperCase()+E.slice(1).toLowerCase())).join("-"):k.length>0?k[0].toUpperCase()+k.slice(1).toLowerCase():""}).join(" "),d.length>0&&d[d.length-1]!==" "&&p.target.value.length>0&&p.target.value[p.target.value.length-1]===" "&&(d+=" "),d.length>100&&(d=d.slice(0,100)),p.target.value=d,s(p);break;case"doc":d=d.replace(/\D/g,""),d.length>4&&(d=`${d.slice(0,4)} ${d.slice(4,10)}`),d.length>11&&(d=d.slice(0,11)),p.target.value=d,s(p);break;case"date":{d=d.replace(/\D/g,""),d.length>4?d=`${d.slice(0,2)}.${d.slice(2,4)}.${d.slice(4,8)}`:d.length>2&&(d=`${d.slice(0,2)}.${d.slice(2,4)}`),d.length>10&&(d=d.slice(0,10)),i?.length>d.length&&[3,6].includes(d.length)&&(d=d.slice(0,d.length-1)),p.target.value=d,s(p);break}default:s(p);break}},y=(p,d)=>{let I=0;for(let k=0;k<Math.min(d,p.length);k++)/\d/.test(p[k])&&I++;return I},u=(p,d)=>{let I=0;for(let k=0;k<p.length;k++){if(I>=d)return k;/\d/.test(p[k])&&I++}return p.length};return t.jsxs(fn,{children:[t.jsx(gn,{...g,value:i,placeholder:w?"":e,onFocus:()=>b(!0),onBlur:p=>{b(!1),g.onBlur?.(p)},onChange:x,inputMode:r==="number"||r==="doc"||r==="date"||r==="rubles"||r==="percents"?"numeric":"text",maxLength:r==="doc"?11:r==="date"?10:void 0,hasError:l}),o&&t.jsx(bn,{isVisible:w,children:o}),l&&h&&t.jsx(mn,{children:h})]})},fn=n.div`
  position: relative;
  display: inline-block;
  width: 100%;
  margin-right: auto;
...
`,yn=({placeholder:e="",customPlaceholder:o,value:i,onChange:r,hasError:s=!1,errorMessage:l,rows:h=3,...g})=>{const[j,b]=m.useState(!1),w=!!(o&&!i&&!j);return t.jsxs(kn,{children:[t.jsx(jn,{...g,value:i,placeholder:w?"":e,onFocus:()=>b(!0),onBlur:x=>{b(!1),g.onBlur?.(x)},onChange:r,hasError:s,rows:h}),o&&t.jsx(Cn,{isVisible:w,children:o}),s&&l&&t.jsx($n,{children:l})]})},kn=n.div`
  position: relative;
  display: inline-block;
  width: 100%;
  margin-right: auto;
...
`,$n=n.span`
  ...
  margin-top: 4px;
  display: block;
`,Ee=({title:e,onClose:o,onCancel:i,onSave:r,children:s,isSaveDisabled:l=!1,isSubmitting:h=!1,mode:g="create",hideSaveButton:j=!1,hideCanselButton:b=!1,width:w="560px",saveButtonText:x="Сохранить",customLayout:y})=>{const u=g==="view",p=m.useRef(null);m.useEffect(()=>{const k=E=>{E.key==="Escape"&&o()};document.addEventListener("keydown",k);const P=document.body.style.overflow;return document.body.style.overflow="hidden",setTimeout(()=>p.current?.focus(),0),()=>{document.removeEventListener("keydown",k),document.body.style.overflow=P}},[o]);const d=k=>{k.target===k.currentTarget&&o()},I=k=>{k.preventDefault(),i()};return t.jsx(Sn,{onMouseDown:d,role:"presentation",children:t.jsxs(Mn,{ref:p,$width:w,role:"dialog","aria-modal":"true","aria-label":e||"Диалог",tabIndex:-1,children:[t.jsxs(Ie,{children:[t.jsx(Pe,{children:e}),t.jsx(Ln,{type:"button",onClick:o,"aria-label":"Закрыть",children:t.jsx("span",{"aria-hidden":!0,children:"×"})})]}),y?t.jsx(Dn,{children:y}):null,t.jsxs(Tn,{onSubmit:r,children:[t.jsx(En,{children:s}),t.jsxs(In,{children:[t.jsx(Pn,{children:b?null:t.jsx(Bn,{isPrimary:!1,onClick:I,children:"Отменить"})}),t.jsx(Rn,{children:!u&&!j?t.jsx(zn,{type:"submit",disabled:l||h,children:h?"Сохранение...":x}):null})]})]})]})})},Sn=n.div`
  position: fixed;
  inset: 0;
...
`,Kn=({name:e,value:o,onChange:i,onBlur:r,onKeyPress:s,placeholder:l="8 (999) 500-50-50",customPlaceholder:h,tabIndex:g,disabled:j=!1,hasError:b=!1,errorMessage:w})=>{const[x,y]=m.useState(!1),u=m.useRef(null),p=!!(h&&!o&&!x),d=E=>{const A=E.replace(/\D/g,"").slice(0,11);let R="";return A.length>0&&(R+="8"),A.length>1&&(R+=` (${A.slice(1,4)}`),A.length>4&&(R+=`) ${A.slice(4,7)}`),A.length>7&&(R+=`-${A.slice(7,9)}`),A.length>9&&(R+=`-${A.slice(9,11)}`),R},I=E=>{const O=d(E.target.value),A={...E,target:{...E.target,name:e,value:O}};i(A)},k=E=>{y(!1),r?.(E)},P=E=>{s?.(E)};return t.jsxs(Qn,{children:[t.jsx(eo,{ref:u,name:e,type:"tel",value:o,onChange:I,onKeyPress:P,placeholder:p?"":l,maxLength:18,tabIndex:g,disabled:j,hasError:b,onFocus:()=>y(!0),onBlur:k,inputMode:"tel"}),h&&t.jsx(to,{isVisible:p,children:h}),b&&w&&t.jsx(no,{children:w})]})},Qn=n.div`
  position: relative;
  display: inline-block;
  width: 100%;
  margin-right: auto;
...
`,no=n.span`
  ...
  margin-top: 4px;
  display: block;
`,oo=({tabs:e,activeTab:o,onChange:i,addButton:r,fontSize:s=14})=>{const l=e.find(h=>h.id===o)?.content;return t.jsxs(t.Fragment,{children:[t.jsx(ro,{children:t.jsxs(io,{children:[e.map(h=>t.jsxs(so,{$isActive:o===h.id,onClick:()=>i(h.id),$fontSize:s,children:[h.label,o===h.id&&t.jsx(ao,{})]},h.id)),r&&t.jsx(lo,{children:r})]})}),l&&t.jsx(co,{children:l})]})},ro=n.div`
  width: auto;
...
`,Io=({percentage:e,onChange:o,draggable:i=!1,colors:r={primary:"rgba(0, 125, 136, 1)",secondary:"rgba(37, 203, 161, 1)"}})=>{const s=m.useRef(null),[l,h]=m.useState(!1),g=x=>{!i||!o||(x.preventDefault(),h(!0),w(x))},j=x=>{!l||!o||w(x)},b=()=>{h(!1)},w=x=>{if(!s.current||!o)return;const y=s.current.getBoundingClientRect();let p=(x.clientX-y.left)/y.width*100;p=Math.max(0,Math.min(100,p)),o(Math.round(p))};return m.useEffect(()=>{if(l)return document.addEventListener("mousemove",j),document.addEventListener("mouseup",b),()=>{document.removeEventListener("mousemove",j),document.removeEventListener("mouseup",b)}},[l]),t.jsxs(Po,{ref:s,$draggable:i,onMouseDown:g,children:[t.jsx(Ro,{$secondaryColor:r.secondary}),t.jsx(Bo,{$percentage:e,$primaryColor:r.primary}),i&&t.jsx(zo,{$percentage:e,$primaryColor:r.primary})]})},Po=n.div`
  width: 100%;
  height: 10px;
  position: relative;
  border-radius: 5px;
...
`,Re=({isOpen:e,callPhone:o,error:i,onClose:r})=>{const[s,l]=m.useState(!1);if(!e)return null;const h=/iPhone|iPad|iPod|Android/i.test(navigator.userAgent),g=()=>{h?window.location.href=`tel:${o}`:(navigator.clipboard.writeText(o),l(!0),setTimeout(()=>l(!1),2e3))};return t.jsx(Hr,{onClick:r,children:t.jsxs(Vr,{onClick:j=>j.stopPropagation(),children:[t.jsx(Zr,{children:"Подтверждение авторизации"}),t.jsx(Me,{children:"Для завершения авторизации позвоните на номер:"}),t.jsxs(Ur,{onClick:g,title:h?"Позвонить":"Копировать номер",$clickable:!0,children:[o,!h&&s&&t.jsx(Xr,{children:"Скопировано!"})]}),t.jsx(Me,{children:"После звонка система автоматически подтвердит вашу авторизацию."}),i&&t.jsx(qr,{children:i})]})})},Hr=n.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,Ae=(e,o)=>q("/auth/call/initiate",{method:"POST",body:{phone:e,user_type:o}}),Fe=(e,o,i,r)=>q("/auth/call/confirm",{method:"POST",body:{phone:e,check_id:o,user_type:i,name:r}}),vi=()=>q("/auth/session/info",{method:"GET"}),yi=({isOpen:e,onClose:o,onSubmit:i,error:r,isLoading:s=!1})=>{const[l,h]=m.useState("");if(!e)return null;const g=j=>{j.preventDefault(),i(l)};return t.jsx(ki,{onClick:o,children:t.jsx(ji,{onClick:j=>j.stopPropagation(),children:t.jsxs(Ci,{onSubmit:g,children:[t.jsx($i,{children:"Как вас зовут?"}),t.jsxs(Si,{children:[t.jsx(ce,{type:"text",value:l,onChange:j=>h(j.target.value),placeholder:"Иванов Иван Иванович",disabled:s,autoFocus:!0,style:{flex:1}}),t.jsx(Mi,{type:"submit",disabled:s||!l.trim(),children:s?"...":"→"})]}),r&&t.jsx(Li,{children:r})]})})})},ki=n.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,Li=n.div`
  ...
  margin-top: 8px;
  text-align: left;
`,Di=({onLoginSuccess:e,userType:o="delivery_operator",title:i="Авторизация",submitLabel:r="Войти",placeholder:s="8 (xxx) xxx-xx-xx",supportPhone:l="8 989 924 24 24",supportLinkUrl:h="https://waypay.one",supportLinkText:g="waypay.one",className:j,style:b,pollingIntervalMs:w=3e3,enableRegistration:x=!1})=>{const[y,u]=m.useState(!1),[p,d]=m.useState(""),[I,k]=m.useState(!1),[P,E]=m.useState(""),[O,A]=m.useState(""),[R,H]=m.useState(!1),[B,_]=m.useState(!1),[W,F]=m.useState(""),[v,c]=m.useState(""),[M,D]=m.useState(null),N=m.useRef(void 0);m.useEffect(()=>()=>{N.current&&clearInterval(N.current)},[]);const V=S=>{const f=S.replace(/\D/g,"");return f?f.startsWith("8")?`+7${f.slice(1)}`:f.startsWith("7")?`+${f}`:`+${f}`:""},Z=()=>{k(!1),_(!1),F(""),c(""),D(null),N.current&&window.clearInterval(N.current)},C=async S=>{if(S.preventDefault(),!p){A("Введите номер телефона");return}u(!0),A("");const f=V(p);try{const T=await Ae(f,o);D({phone:f,checkId:T.check_id,callPhone:T.call_phone}),x&&"name_required"in T&&T.name_required?(_(!0),E(T.call_phone)):!x&&"name_required"in T&&T.name_required?(A("Этот номер не зарегистрирован в системе. Обратитесь в поддержку для регистрации."),D(null)):(E(T.call_phone),k(!0),a(f,T.check_id))}catch(T){console.error("Auth error:",T),A("Не удалось инициировать авторизацию. Проверьте номер.")}finally{u(!1)}},L=async S=>{if(!S.trim()){c("Введите ФИО");return}if(M){u(!0),c("");try{F(S),_(!1),k(!0),a(M.phone,M.checkId,S)}catch(f){console.error("Registration error:",f),c("Не удалось завершить регистрацию")}finally{u(!1)}}},a=(S,f,T)=>{N.current&&window.clearInterval(N.current),N.current=window.setInterval(()=>{$(S,f,T)},w)},$=async(S,f,T)=>{if(!R){H(!0);try{const z=await Fe(S,f,o,T||W);z.access_token&&z.refresh_token&&(N.current&&window.clearInterval(N.current),k(!1),_(!1),F(""),D(null),e(z.access_token))}catch(z){console.error("Verification error:",z)}finally{H(!1)}}};return t.jsxs(Ti,{className:j,style:b,children:[t.jsxs(Ei,{children:[t.jsxs(Ii,{onSubmit:C,children:[t.jsx(Pi,{children:i}),t.jsx(Ri,{children:t.jsx(Bi,{children:t.jsx(ze,{value:p,onChange:S=>d(S),placeholder:s})})}),O&&t.jsx(Oi,{children:t.jsx("span",{children:O})}),t.jsx(zi,{type:"submit",disabled:y,children:y?"Загрузка...":r})]}),t.jsxs(Ai,{children:["Хотите получить доступ к нашим продуктам?",t.jsx("br",{}),"Обратитесь по номеру"," ",t.jsx(Fi,{href:`tel:${l}`,children:l}),t.jsx("br",{}),"или оставьте заявку на"," ",t.jsx(_i,{href:h,target:"_blank",rel:"noreferrer",children:g})]})]}),t.jsx(yi,{isOpen:B,onClose:Z,onSubmit:L,error:v,isLoading:y}),t.jsx(Re,{isOpen:I,onClose:Z,callPhone:P,error:O})]})},Ti=n.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
